...
bool sys_FileSystem_isDirectory(String r0) {
	...
	r6 = hl_alloc_dynamic(&t$_i32);
	r6->v.i = r5;
	if( r4 != r6 && (!r4 || !r6 || (r4->v.i != r6->v.i)) ) goto label$71a15a3_6_11;
	r5 = r0->length;
	r7 = 3;
	if( r7 < r5 ) goto label$71a15a3_6_11;
	r3 = haxe_io_Path_addTrailingSlash(r0);
	goto label$71a15a3_6_16;
	label$71a15a3_6_11:
	r8 = (String)s$6666cd7;
	if( r0 != r8 && (!r0 || !r8 || String___compare(r0,(vdynamic*)r8) != 0) ) goto label$71a15a3_6_15;
	r3 = (String)s$6666cd7;
	goto label$71a15a3_6_16;
	label$71a15a3_6_15:
	r3 = haxe_io_Path_removeTrailingSlashes(r0);
...
void sys_FileSystem_createDirectory(String r0) {
	...
	label$71a15a3_7_6:
	r8 = true;
	if( !r8 ) goto label$71a15a3_7_17;
	r9 = haxe_io_Path_directory(r1);
	r3 = r9;
	if( r1 != r3 && (!r1 || !r3 || String___compare(r1,(vdynamic*)r3) != 0) ) goto label$71a15a3_7_13;
	goto label$71a15a3_7_17;
	label$71a15a3_7_13:
	if( r4 == NULL ) hl_null_access();
	hl_types_ArrayObj_unshift(r4,((vdynamic*)r1));
	r1 = r3;
	goto label$71a15a3_7_6;
	label$71a15a3_7_17:
	r7 = 0;
	label$71a15a3_7_18:
	if( r4 == NULL ) hl_null_access();
	r12 = r4->length;
	if( r7 >= r12 ) goto label$71a15a3_7_51;
	r12 = r4->length;
	if( ((unsigned)r7) < ((unsigned)r12) ) goto label$71a15a3_7_26;
	r9 = NULL;
	goto label$71a15a3_7_29;
	label$71a15a3_7_26:
	r5 = r4->array;
	...
	r15->v.i = r11;
	if( r14 == r15 || (r14 && r15 && (r14->v.i == r15->v.i)) ) goto label$71a15a3_7_50;
	r8 = sys_FileSystem_exists(r9);
	if( r8 ) goto label$71a15a3_7_50;
	r16 = Sys_getPath(r9);
	r11 = 493;
...
hl__types__ArrayObj sys_FileSystem_readDirectory(String r0) {
	...
	label$71a15a3_9_14:
	r12 = r1->size;
	if( r10 >= r12 ) goto label$71a15a3_9_23;
	r2 = ((vbyte**)(r1 + 1))[r10];
	++r10;
	if( r8 == NULL ) hl_null_access();
	r3 = Sys_makePath(r2);
	r11 = hl_types_ArrayObj_push(r8,((vdynamic*)r3));
	goto label$71a15a3_9_14;
	label$71a15a3_9_23:
	return r8;
}

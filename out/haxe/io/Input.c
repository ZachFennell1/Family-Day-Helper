...
int haxe_io_Input_readInt16(haxe__io__Input r0) {
	...
	r4 = r0->bigEndian;
	if( !r4 ) goto label$03d8419_11_8;
	r6 = 8;
	r5 = r1 << r6;
	r3 = r2 | r5;
	goto label$03d8419_11_11;
	label$03d8419_11_8:
	r6 = 8;
	r5 = r2 << r6;
	r3 = r1 | r5;
	...
	r5 = r3 & r6;
	r6 = 0;
	if( r5 == r6 ) goto label$03d8419_11_18;
	r6 = 65536;
	r5 = r3 - r6;
	return r5;
	label$03d8419_11_18:
...
int haxe_io_Input_readUInt24(haxe__io__Input r0) {
	...
	r4 = r0->bigEndian;
	if( !r4 ) goto label$03d8419_13_12;
	r7 = 8;
	r6 = r2 << r7;
	r5 = r3 | r6;
	r7 = 16;
...
int haxe_io_Input_readInt32(haxe__io__Input r0) {
	...
	r5 = r0->bigEndian;
	if( !r5 ) goto label$03d8419_14_16;
	r8 = 8;
	r7 = r3 << r8;
	r6 = r4 | r7;
	r8 = 16;

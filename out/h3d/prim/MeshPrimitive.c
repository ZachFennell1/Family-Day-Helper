...
bool h3d_prim_MeshPrimitive_hasBuffer(h3d__prim__MeshPrimitive r0,String r1) {
	...
	r3 = haxe_ds_IntMap_exists(r2,r4);
	return r3;
}
...
void h3d_prim_MeshPrimitive_addBuffer(h3d__prim__MeshPrimitive r0,String r1,h3d__Buffer r2,int* r3) {
	...
	vdynamic *r8;
	int r4, r7;
	if( r3 ) goto label$bc4e908_3_3;
	r4 = 0;
	goto label$bc4e908_3_4;
	label$bc4e908_3_3:
	r4 = *r3;
	label$bc4e908_3_4:
	r6 = r0->bufferCache;
	if( r6 ) goto label$bc4e908_3_9;
...
h3d__BufferOffset h3d_prim_MeshPrimitive_getBuffers(h3d__prim__MeshPrimitive r0,h3d__Engine r1) {
	...
	r4 = ((h3d__impl__InputNames (*)(h3d__impl__Driver))r5->$type->vobj_proto[17])(r5);
	r3 = r0->layouts;
	...
	r12 = r10->length;
	if( r7 >= r12 ) goto label$bc4e908_5_68;
	r12 = r10->length;
	if( ((unsigned)r7) < ((unsigned)r12) ) goto label$bc4e908_5_33;
	r13 = NULL;
	goto label$bc4e908_5_36;
	label$bc4e908_5_33:
	r14 = r10->array;
	...
	if( r16 ) goto label$bc4e908_5_55;
	r17 = h3d_prim_MeshPrimitive_allocBuffer(r0,r1,r13);
	r16 = r17;
	if( r17 ) goto label$bc4e908_5_52;
	...
	if( r9 ) goto label$bc4e908_5_64;
	r9 = r17;
	r8 = r17;
	goto label$bc4e908_5_67;
	label$bc4e908_5_64:
	if( r9 == NULL ) hl_null_access();
	r9->next = r17;
	r9 = r17;
	label$bc4e908_5_67:
	goto label$bc4e908_5_25;
	label$bc4e908_5_68:
	r3 = r0->layouts;
	if( r3 == NULL ) hl_null_access();
	if( r4 == NULL ) hl_null_access();
...
void h3d_prim_MeshPrimitive_render(h3d__prim__MeshPrimitive r0,h3d__Engine r1) {
	...
	h3d__Indexes r3;
	r3 = r0->indexes;
	if( !r3 ) goto label$bc4e908_6_6;
	r3 = r0->indexes;
	if( r3 == NULL ) hl_null_access();
	r4 = h3d_Indexes_isDisposed(r3);
	if( !r4 ) goto label$bc4e908_6_7;
	label$bc4e908_6_6:

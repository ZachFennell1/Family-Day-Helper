...
void h3d_prim_Plane2D_alloc(h3d__prim__Plane2D r0,h3d__Engine r1) {
	...
	r6 = 0;
	if( r6 >= r2 ) goto label$18e592e_4_18;
	r6 = r4->length;
	if( r6 >= r2 ) goto label$18e592e_4_18;
	r6 = 1;
	r5 = r2 - r6;
	...
	r8 = (float)r7;
	r6 = r4->length;
	if( ((unsigned)r5) < ((unsigned)r6) ) goto label$18e592e_4_14;
...
void h3d_prim_Plane2D_render(h3d__prim__Plane2D r0,h3d__Engine r1) {
	...
	r3 = r0->buffer;
	if( !r3 ) goto label$18e592e_5_14;
	r3 = r0->buffer;
	if( r3 == NULL ) hl_null_access();
	r5 = r3->buffer;
	if( !r5 ) goto label$18e592e_5_12;
	r5 = r3->buffer;
	if( r5 == NULL ) hl_null_access();
	r6 = r5->vbuf;
	if( !r6 ) goto label$18e592e_5_12;
	r4 = false;
	goto label$18e592e_5_13;
	label$18e592e_5_12:
	r4 = true;
	label$18e592e_5_13:
	goto label$18e592e_5_15;
	label$18e592e_5_14:
	r4 = true;
	label$18e592e_5_15:
	if( !r4 ) goto label$18e592e_5_17;

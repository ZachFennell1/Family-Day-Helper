...
bool h3d_scene_fwd_LightSystem_get_additiveLighting(h3d__scene__fwd__LightSystem r0) {
	bool r1;
...
bool h3d_scene_fwd_LightSystem_set_additiveLighting(h3d__scene__fwd__LightSystem r0,bool r1) {
	...
	if( !r5 ) goto label$3b7f60a_2_6;
	r4 = (h3d__shader__AmbientLight)r2;
	goto label$3b7f60a_2_7;
	label$3b7f60a_2_6:
	r4 = NULL;
	label$3b7f60a_2_7:
	if( r4 == NULL ) hl_null_access();
...
void h3d_scene_fwd_LightSystem_initLights(h3d__scene__fwd__LightSystem r0,h3d__scene__RenderContext r1) {
	...
	if( r4 < r3 ) goto label$3b7f60a_3_97;
	if( r1 == NULL ) hl_null_access();
	r5 = r1->lights;
	r6 = hl_alloc_closure_ptr(&t$fun_255f612,h3d_scene_fwd_LightSystem_sortLight,r0);
	if( r5 ) goto label$3b7f60a_3_11;
	r8 = NULL;
	r7 = r8;
	goto label$3b7f60a_3_95;
	label$3b7f60a_3_11:
	r3 = 1;
	r4 = 0;
	r9 = 0;
	label$3b7f60a_3_14:
	r10 = true;
	if( !r10 ) goto label$3b7f60a_3_94;
	r8 = r5;
	r11 = NULL;
	r5 = r11;
	r12 = NULL;
	...
	r16 = r3;
	label$3b7f60a_3_32:
	if( r14 >= r16 ) goto label$3b7f60a_3_42;
	++r14;
	++r4;
	if( r12 == NULL ) hl_null_access();
	r15 = r12->next;
	r12 = r15;
	if( r15 ) goto label$3b7f60a_3_41;
	goto label$3b7f60a_3_42;
	label$3b7f60a_3_41:
	goto label$3b7f60a_3_32;
	label$3b7f60a_3_42:
	r9 = r3;
	label$3b7f60a_3_43:
	r16 = 0;
	if( r16 < r4 ) goto label$3b7f60a_3_49;
	r16 = 0;
	if( r16 >= r9 ) goto label$3b7f60a_3_82;
	if( !r12 ) goto label$3b7f60a_3_82;
	label$3b7f60a_3_49:
	r16 = 0;
	if( r4 != r16 ) goto label$3b7f60a_3_57;
	r15 = r12;
	if( r12 == NULL ) hl_null_access();
	r17 = r12->next;
	r12 = r17;
	--r9;
	goto label$3b7f60a_3_75;
	label$3b7f60a_3_57:
	r16 = 0;
	if( r9 == r16 ) goto label$3b7f60a_3_64;
	if( !r12 ) goto label$3b7f60a_3_64;
	...
	r16 = 0;
	if( r16 < r14 ) goto label$3b7f60a_3_70;
	label$3b7f60a_3_64:
	r15 = r8;
	...
	--r9;
	label$3b7f60a_3_75:
	if( !r11 ) goto label$3b7f60a_3_79;
	if( r11 == NULL ) hl_null_access();
	r11->next = r15;
	goto label$3b7f60a_3_80;
	label$3b7f60a_3_79:
	r5 = r15;
	label$3b7f60a_3_80:
	r11 = r15;
	goto label$3b7f60a_3_43;
	label$3b7f60a_3_82:
	r8 = r12;
	goto label$3b7f60a_3_24;
	label$3b7f60a_3_84:
	if( r11 == NULL ) hl_null_access();
	r18 = NULL;
	r11->next = r18;
	r16 = 1;
	if( r16 < r13 ) goto label$3b7f60a_3_90;
	goto label$3b7f60a_3_94;
	label$3b7f60a_3_90:
	r16 = 2;
	r14 = r3 * r16;
	r3 = r14;
	goto label$3b7f60a_3_14;
	label$3b7f60a_3_94:
	r7 = r5;
	label$3b7f60a_3_95:
	if( r1 == NULL ) hl_null_access();
...
hxsl__ShaderList h3d_scene_fwd_LightSystem_computeLight(h3d__scene__fwd__LightSystem r0,h3d__scene__Object r1,hxsl__ShaderList r2) {
	...
	if( r5 >= r4 ) goto label$3b7f60a_6_182;
	r7 = r0->ctx;
	if( r7 == NULL ) hl_null_access();
	r6 = r7->lights;
	label$3b7f60a_6_7:
	if( !r6 ) goto label$3b7f60a_6_87;
	if( r1 == NULL ) hl_null_access();
	r4 = r1->flags;
	r5 = 16;
	r4 = r4 & r5;
	r5 = 0;
	if( r4 == r5 ) goto label$3b7f60a_6_56;
	if( r6 == NULL ) hl_null_access();
	r10 = r6->absPos;
	...
	if( r8 ) goto label$3b7f60a_6_95;
	r19 = NULL;
	r18 = r19;
	goto label$3b7f60a_6_179;
	label$3b7f60a_6_95:
	r4 = 1;
	r5 = 0;
	r20 = 0;
	label$3b7f60a_6_98:
	r21 = true;
	if( !r21 ) goto label$3b7f60a_6_178;
	r19 = r8;
	r22 = NULL;
	r8 = r22;
	r23 = NULL;
	...
	r24 = r25;
	label$3b7f60a_6_108:
	if( !r19 ) goto label$3b7f60a_6_168;
	++r24;
	r23 = r19;
	r25 = 0;
	r5 = r25;
	...
	r27 = r4;
	label$3b7f60a_6_116:
	if( r25 >= r27 ) goto label$3b7f60a_6_126;
	++r25;
	++r5;
	if( r23 == NULL ) hl_null_access();
	r26 = r23->next;
	r23 = r26;
	if( r26 ) goto label$3b7f60a_6_125;
	goto label$3b7f60a_6_126;
	label$3b7f60a_6_125:
	goto label$3b7f60a_6_116;
	label$3b7f60a_6_126:
	r20 = r4;
	label$3b7f60a_6_127:
	r27 = 0;
	if( r27 < r5 ) goto label$3b7f60a_6_133;
	r27 = 0;
	if( r27 >= r20 ) goto label$3b7f60a_6_166;
	if( !r23 ) goto label$3b7f60a_6_166;
	label$3b7f60a_6_133:
	r27 = 0;
	if( r5 != r27 ) goto label$3b7f60a_6_141;
	r26 = r23;
	if( r23 == NULL ) hl_null_access();
	r28 = r23->next;
	r23 = r28;
	--r20;
	goto label$3b7f60a_6_159;
	label$3b7f60a_6_141:
	r27 = 0;
	if( r20 == r27 ) goto label$3b7f60a_6_148;
	if( !r23 ) goto label$3b7f60a_6_148;
	...
	r27 = 0;
	if( r27 < r25 ) goto label$3b7f60a_6_154;
	label$3b7f60a_6_148:
	r26 = r19;
	...
	--r20;
	label$3b7f60a_6_159:
	if( !r22 ) goto label$3b7f60a_6_163;
	if( r22 == NULL ) hl_null_access();
	r22->next = r26;
	goto label$3b7f60a_6_164;
	label$3b7f60a_6_163:
	r8 = r26;
	label$3b7f60a_6_164:
	r22 = r26;
	...
	label$3b7f60a_6_166:
	r19 = r23;
	goto label$3b7f60a_6_108;
	label$3b7f60a_6_168:
	if( r22 == NULL ) hl_null_access();
	r29 = NULL;
	r22->next = r29;
	r27 = 1;
	if( r27 < r24 ) goto label$3b7f60a_6_174;
	goto label$3b7f60a_6_178;
	label$3b7f60a_6_174:
	r27 = 2;
	r25 = r4 * r27;
	r4 = r25;
	goto label$3b7f60a_6_98;
	label$3b7f60a_6_178:
	r18 = r8;
	label$3b7f60a_6_179:
	r7 = r0->ctx;
	...
	r4 = 0;
	label$3b7f60a_6_192:
	if( !r6 ) goto label$3b7f60a_6_209;
	r5 = r4;
	++r4;
	r20 = r0->maxLightsPerObject;
	if( r5 != r20 ) goto label$3b7f60a_6_199;
	goto label$3b7f60a_6_209;
	label$3b7f60a_6_199:
	if( r3 == NULL ) hl_null_access();
	r7 = r3->ctx;
	if( r7 == NULL ) hl_null_access();

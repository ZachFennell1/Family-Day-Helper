...
void h3d_scene_RenderContext_emit(h3d__scene__RenderContext r0,h3d__mat__Material r1,h3d__scene__Object r2,int* r3) {
	...
	int r4;
	if( r3 ) goto label$d2e361e_2_3;
	r4 = 0;
	goto label$d2e361e_2_4;
	label$d2e361e_2_3:
	r4 = *r3;
	label$d2e361e_2_4:
...
vdynamic* h3d_scene_RenderContext_getGlobal(h3d__scene__RenderContext r0,String r1) {
	...
	r6 = r4->length;
	if( r3 >= r6 ) goto label$d2e361e_5_21;
	r6 = r4->length;
	if( ((unsigned)r3) < ((unsigned)r6) ) goto label$d2e361e_5_11;
	r7 = NULL;
	goto label$d2e361e_5_14;
	label$d2e361e_5_11:
	r9 = r4->array;
	r8 = ((vdynamic**)(r9 + 1))[r3];
	...
	r5 = r7->gid;
	if( r5 != r2 ) goto label$d2e361e_5_20;
	r8 = r7->value;
	return r8;
	label$d2e361e_5_20:
	goto label$d2e361e_5_3;
	label$d2e361e_5_21:
	r8 = NULL;
	return r8;
}
...
void h3d_scene_RenderContext_setGlobal(h3d__scene__RenderContext r0,String r1,vdynamic* r2) {
	...
	h3d_scene_RenderContext_setGlobalID(r0,r4,r2);
	return;
}
...
void h3d_scene_RenderContext_setGlobalID(h3d__scene__RenderContext r0,int r1,vdynamic* r2) {
	...
	if( r5 == NULL ) hl_null_access();
	r7 = r5->length;
	if( r3 >= r7 ) goto label$d2e361e_7_20;
	r7 = r5->length;
	if( ((unsigned)r3) < ((unsigned)r7) ) goto label$d2e361e_7_10;
	r8 = NULL;
	goto label$d2e361e_7_13;
	label$d2e361e_7_10:
	r10 = r5->array;
	...
	if( r8 == NULL ) hl_null_access();
	r6 = r8->gid;
	if( r6 != r1 ) goto label$d2e361e_7_19;
	r8->value = r2;
	return;
	label$d2e361e_7_19:
	goto label$d2e361e_7_2;
	label$d2e361e_7_20:
	r5 = r0->sharedGlobals;
	if( r5 == NULL ) hl_null_access();
...
hxsl__ShaderList h3d_scene_RenderContext_allocShaderList(h3d__scene__RenderContext r0,hxsl__Shader r1,hxsl__ShaderList r2) {
	...
	r0->cachedPos = r4;
	r4 = r3->length;
	if( ((unsigned)r5) < ((unsigned)r4) ) goto label$d2e361e_9_10;
	r6 = NULL;
	goto label$d2e361e_9_13;
	label$d2e361e_9_10:
	r8 = r3->array;
	r7 = ((vdynamic**)(r8 + 1))[r5];
	r6 = (hxsl__ShaderList)r7;
	label$d2e361e_9_13:
	if( r6 ) goto label$d2e361e_9_29;
	...
	r4 = r4 - r5;
	r5 = r3->length;
	if( ((unsigned)r4) < ((unsigned)r5) ) goto label$d2e361e_9_27;
...
void h3d_scene_RenderContext_done(h3d__scene__RenderContext r0) {
	...
	r1 = r0->allocFirst;
	label$d2e361e_12_3:
	if( !r1 ) goto label$d2e361e_12_25;
	r4 = r0->allocPool;
	if( r1 == r4 ) goto label$d2e361e_12_25;
	if( r1 == NULL ) hl_null_access();
	r5 = NULL;
	r1->obj = r5;
	r6 = NULL;
	...
	r3 = r1->nextAlloc;
	r1 = r3;
	goto label$d2e361e_12_3;
	label$d2e361e_12_25:
	r3 = r0->allocPool;
	if( !r3 ) goto label$d2e361e_12_31;
	r3 = r0->allocFirst;
	if( r3 == NULL ) hl_null_access();
	r3 = r3->nextAlloc;
	r0->allocFirst = r3;
	...
	r11 = r10->length;
	if( r9 >= r11 ) goto label$d2e361e_12_53;
	r11 = r10->length;
	if( ((unsigned)r9) < ((unsigned)r11) ) goto label$d2e361e_12_43;
	r8 = NULL;
	goto label$d2e361e_12_46;
	label$d2e361e_12_43:
	r13 = r10->array;

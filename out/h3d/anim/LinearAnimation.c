...
h3d__anim__Animation h3d_anim_LinearAnimation_clone(h3d__anim__LinearAnimation r0,h3d__anim__Animation r1) {
	...
	int r6;
	if( r1 ) goto label$8608c30_8_7;
	r4 = (h3d__anim__LinearAnimation)hl_alloc_obj(&t$h3d_anim_LinearAnimation);
	r5 = r0->name;
	r6 = r0->frameCount;
	r7 = r0->sampling;
...
void h3d_anim_LinearAnimation_initInstance(h3d__anim__LinearAnimation r0) {
	...
	r5 = r2->length;
	if( r3 >= r5 ) goto label$8608c30_10_60;
	r5 = r2->length;
	if( ((unsigned)r3) < ((unsigned)r5) ) goto label$8608c30_10_11;
	r6 = NULL;
	goto label$8608c30_10_14;
	label$8608c30_10_11:
	r8 = r2->array;
	r7 = ((vdynamic**)(r8 + 1))[r3];
	r6 = (h3d__anim__LinearObject)r7;
	...
	if( r6 == NULL ) hl_null_access();
	r9 = r6->propValues;
	if( !r9 ) goto label$8608c30_10_31;
	r9 = r6->propValues;
	if( r9 == NULL ) hl_null_access();
	r4 = 0;
	r5 = r9->length;
	if( ((unsigned)r4) < ((unsigned)r5) ) goto label$8608c30_10_25;
	r10 = 0.;
	goto label$8608c30_10_29;
	label$8608c30_10_25:
	r11 = r9->bytes;
	r5 = 3;
	r5 = r4 << r5;
	...
	goto label$8608c30_10_3;
	label$8608c30_10_31:
	r9 = r6->alphas;
	if( !r9 ) goto label$8608c30_10_48;
	r12 = r6->targetObject;
	if( !r12 ) goto label$8608c30_10_43;
	r12 = r6->targetObject;
	r13 = (h3d__scene__$Mesh)g$_h3d_scene_Mesh;
	r15 = hl_BaseType_check(((hl__BaseType)r13),((vdynamic*)r12));
	if( !r15 ) goto label$8608c30_10_41;
	r14 = (h3d__scene__Mesh)r12;
	goto label$8608c30_10_42;
	label$8608c30_10_41:
	r14 = NULL;
	label$8608c30_10_42:
	if( r14 ) goto label$8608c30_10_48;
	label$8608c30_10_43:
	r16 = r6->objectName;
	r17 = (String)s$9720cdd;
	r16 = String___add__(r16,r17);
	r7 = haxe_Exception_thrown(((vdynamic*)r16));
	hl_throw((vdynamic*)r7);
	label$8608c30_10_48:
	r9 = r6->uvs;
	if( r9 ) goto label$8608c30_10_52;
	r9 = r6->alphas;
	if( !r9 ) goto label$8608c30_10_53;
	label$8608c30_10_52:
	goto label$8608c30_10_3;
	label$8608c30_10_53:
	r18 = (h3d__Matrix)hl_alloc_obj(&t$h3d_Matrix);
	h3d_Matrix_new(r18);
	r6->matrix = r18;
	r18 = r6->matrix;
	...
	goto label$8608c30_10_3;
	label$8608c30_10_60:
	r19 = hl_alloc_closure_ptr(&t$fun_daee26a,h3d_anim_LinearAnimation_sortByFrameCountDesc,r0);
	if( r19 ) goto label$8608c30_10_64;
	r20 = NULL;
	goto label$8608c30_10_65;
	label$8608c30_10_64:
	r20 = hl_alloc_closure_ptr(&t$fun_b73ceee,wrapt$fun_b73ceee,r19);
	label$8608c30_10_65:
...
int h3d_anim_LinearAnimation_sortByFrameCountDesc(h3d__anim__LinearAnimation r0,h3d__anim__LinearObject r1,h3d__anim__LinearObject r2) {
	...
	if( r2 == NULL ) hl_null_access();
	r4 = r2->frames;
	if( r4 ) goto label$8608c30_11_5;
	r3 = 10;
	goto label$8608c30_11_8;
	label$8608c30_11_5:
	r4 = r2->frames;
	if( r4 == NULL ) hl_null_access();
	r3 = r4->length;
	...
	r4 = r1->frames;
	if( r4 ) goto label$8608c30_11_13;
	r5 = 10;
	goto label$8608c30_11_16;
	label$8608c30_11_13:
	r4 = r1->frames;
	if( r4 == NULL ) hl_null_access();
	r5 = r4->length;
...
double h3d_anim_LinearAnimation_uvLerp(h3d__anim__LinearAnimation r0,double r1,double r2,double r3) {
	...
	r6 = 0.5;
	r5 = r2 - r6;
	if( !(r1 < r5) ) goto label$8608c30_12_12;
	r4 = 1.;
	r1 = r1 + r4;
	goto label$8608c30_12_17;
	label$8608c30_12_12:
	r6 = 0.5;
	r5 = r2 + r6;
	if( !(r5 < r1) ) goto label$8608c30_12_17;
	r4 = 1.;
	r1 = r1 - r4;
	label$8608c30_12_17:
	r5 = 1.;
...
void h3d_anim_LinearAnimation_sync(h3d__anim__LinearAnimation r0,bool* r1) {
	...
	if( r1 ) goto label$8608c30_13_3;
	r2 = false;
	goto label$8608c30_13_4;
	label$8608c30_13_3:
	r2 = *r1;
	label$8608c30_13_4:
	r4 = r0->frame;
	r5 = r0->syncFrame;
	if( r4 != r5 ) goto label$8608c30_13_9;
	if( r2 ) goto label$8608c30_13_9;
	return;
	label$8608c30_13_9:
	r4 = r0->frame;
	r8 = (int)r4;
	r9 = h3d_anim_LinearAnimation_endFrame(r0);
	if( r8 != r9 ) goto label$8608c30_13_14;
	--r8;
	label$8608c30_13_14:
	r10 = r8;
	r12 = 1;
	...
	r13 = r13 - r5;
	r15 = 0;
	if( r8 >= r15 ) goto label$8608c30_13_30;
	r12 = 0;
	r11 = r12;
	r10 = r12;
	goto label$8608c30_13_48;
	label$8608c30_13_30:
	r14 = r0->frame;
	r12 = r0->frameCount;
	r16 = (double)r12;
	if( !(r14 >= r16) ) goto label$8608c30_13_40;
	r12 = r0->frameCount;
	r15 = 1;
	r12 = r12 - r15;
	r11 = r12;
	...
	label$8608c30_13_40:
	r6 = r0->loop;
	if( r6 ) goto label$8608c30_13_48;
	r15 = 0;
	if( r11 != r15 ) goto label$8608c30_13_48;
	r12 = r0->frameCount;
	r15 = 1;
	r12 = r12 - r15;
	r11 = r12;
	...
	r14 = r0->frame;
	r0->syncFrame = r14;
	if( !r2 ) goto label$8608c30_13_53;
	r6 = false;
	r0->isSync = r6;
	label$8608c30_13_53:
	r12 = 0;
	...
	r18 = r17->length;
	if( r12 >= r18 ) goto label$8608c30_13_590;
	r18 = r17->length;
	if( ((unsigned)r12) < ((unsigned)r18) ) goto label$8608c30_13_63;
	r20 = NULL;
	goto label$8608c30_13_66;
	label$8608c30_13_63:
	r21 = r17->array;
	...
	if( r22 ) goto label$8608c30_13_73;
	r23 = r20->targetSkin;
	if( r23 ) goto label$8608c30_13_73;
	goto label$8608c30_13_55;
	label$8608c30_13_73:
	r24 = r20->alphas;
	if( !r24 ) goto label$8608c30_13_115;
	r22 = r20->targetObject;
	...
	if( r27 != r28 ) goto label$8608c30_13_86;
	...
	r18 = r24->length;
	if( ((unsigned)r10) < ((unsigned)r18) ) goto label$8608c30_13_96;
	r14 = 0.;
	goto label$8608c30_13_100;
	label$8608c30_13_96:
	r31 = r24->bytes;
	r18 = 3;
	r18 = r10 << r18;
	r14 = *(double*)(r31 + r18);
	label$8608c30_13_100:
	r14 = r14 * r13;
	r24 = r20->alphas;
	if( r24 == NULL ) hl_null_access();
	r18 = r24->length;
	if( ((unsigned)r11) < ((unsigned)r18) ) goto label$8608c30_13_107;
	r16 = 0.;
	goto label$8608c30_13_111;
	label$8608c30_13_107:
	r31 = r24->bytes;
	r18 = 3;
	r18 = r11 << r18;
	r16 = *(double*)(r31 + r18);
	label$8608c30_13_111:
	r16 = r16 * r5;
	r14 = r14 + r16;
	r29->w = r14;
	goto label$8608c30_13_55;
	label$8608c30_13_115:
	r24 = r20->uvs;
	if( !r24 ) goto label$8608c30_13_248;
	r22 = r20->targetObject;
	if( r22 == NULL ) hl_null_access();
	r26 = h3d_scene_Object_toMesh(r22);
	if( r26 == NULL ) hl_null_access();
	...
	if( r36 ) goto label$8608c30_13_144;
	r34 = r25->passes;
	if( r34 == NULL ) hl_null_access();
	...
	label$8608c30_13_144:
	r24 = r20->uvs;
	if( r24 == NULL ) hl_null_access();
	r18 = 1;
	r15 = r10 << r18;
	r18 = r24->length;
	if( ((unsigned)r15) < ((unsigned)r18) ) goto label$8608c30_13_152;
	r14 = 0.;
	goto label$8608c30_13_156;
	label$8608c30_13_152:
	r31 = r24->bytes;
	r18 = 3;
	r18 = r15 << r18;
	r14 = *(double*)(r31 + r18);
	label$8608c30_13_156:
	r24 = r20->uvs;
	if( r24 == NULL ) hl_null_access();
	r18 = 1;
	r15 = r11 << r18;
	r18 = r24->length;
	if( ((unsigned)r15) < ((unsigned)r18) ) goto label$8608c30_13_164;
	r16 = 0.;
	goto label$8608c30_13_168;
	label$8608c30_13_164:
	r31 = r24->bytes;
	r18 = 3;
	r18 = r15 << r18;
	r16 = *(double*)(r31 + r18);
	label$8608c30_13_168:
	r44 = 1.;
	r32 = fmod(r14,r44);
	r14 = r32;
	r44 = 1.;
	...
	r45 = 0.5;
	r44 = r16 - r45;
	if( !(r14 < r44) ) goto label$8608c30_13_180;
	r32 = 1.;
	r14 = r14 + r32;
	goto label$8608c30_13_185;
	label$8608c30_13_180:
	r45 = 0.5;
	r44 = r16 + r45;
	if( !(r44 < r14) ) goto label$8608c30_13_185;
	r32 = 1.;
	r14 = r14 - r32;
	label$8608c30_13_185:
	...
	r15 = r15 | r18;
	r18 = r24->length;
	if( ((unsigned)r15) < ((unsigned)r18) ) goto label$8608c30_13_204;
	r32 = 0.;
	goto label$8608c30_13_208;
	label$8608c30_13_204:
	r31 = r24->bytes;
	r18 = 3;
	r18 = r15 << r18;
	r32 = *(double*)(r31 + r18);
	label$8608c30_13_208:
	r24 = r20->uvs;
	if( r24 == NULL ) hl_null_access();
	r18 = 1;
	r15 = r11 << r18;
	...
	r15 = r15 | r18;
	r18 = r24->length;
	if( ((unsigned)r15) < ((unsigned)r18) ) goto label$8608c30_13_218;
	r44 = 0.;
	goto label$8608c30_13_222;
	label$8608c30_13_218:
	r31 = r24->bytes;
	r18 = 3;
	r18 = r15 << r18;
	r44 = *(double*)(r31 + r18);
	label$8608c30_13_222:
	r46 = 1.;
	r45 = fmod(r32,r46);
	r32 = r45;
	r46 = 1.;
	...
	r47 = 0.5;
	r46 = r44 - r47;
	if( !(r32 < r46) ) goto label$8608c30_13_234;
	r45 = 1.;
	r32 = r32 + r45;
	goto label$8608c30_13_239;
	label$8608c30_13_234:
	r47 = 0.5;
	r46 = r44 + r47;
	if( !(r46 < r32) ) goto label$8608c30_13_239;
	r45 = 1.;
	r32 = r32 - r45;
	label$8608c30_13_239:
	r29 = r36->uvDelta__;
	if( r29 == NULL ) hl_null_access();
	r46 = 1.;
	r46 = r46 - r5;
	...
	r29->y = r45;
	goto label$8608c30_13_55;
	label$8608c30_13_248:
	r24 = r20->propValues;
	if( !r24 ) goto label$8608c30_13_275;
	r24 = r20->propValues;
	if( r24 == NULL ) hl_null_access();
	r18 = r24->length;
	if( ((unsigned)r10) < ((unsigned)r18) ) goto label$8608c30_13_256;
	r14 = 0.;
	goto label$8608c30_13_260;
	label$8608c30_13_256:
	r31 = r24->bytes;
	r18 = 3;
	r18 = r10 << r18;
	r14 = *(double*)(r31 + r18);
	label$8608c30_13_260:
	r14 = r14 * r13;
	r24 = r20->propValues;
	if( r24 == NULL ) hl_null_access();
	r18 = r24->length;
	if( ((unsigned)r11) < ((unsigned)r18) ) goto label$8608c30_13_267;
	r16 = 0.;
	goto label$8608c30_13_271;
	label$8608c30_13_267:
	r31 = r24->bytes;
	r18 = 3;
	r18 = r11 << r18;
	r16 = *(double*)(r31 + r18);
	label$8608c30_13_271:
	r16 = r16 * r5;
	r14 = r14 + r16;
	r20->propCurrentValue = r14;
	goto label$8608c30_13_55;
	label$8608c30_13_275:
	r15 = r10;
	r18 = r11;
	r19 = r20->frames;
	...
	r48 = r19->length;
	r49 = 1;
	if( r48 != r49 ) goto label$8608c30_13_288;
	r6 = r0->isSync;
	if( !r6 ) goto label$8608c30_13_285;
	goto label$8608c30_13_590;
	label$8608c30_13_285:
	r48 = 0;
	r18 = r48;
	r15 = r48;
	label$8608c30_13_288:
	r19 = r20->frames;
	if( r19 == NULL ) hl_null_access();
	r49 = r19->length;
	if( ((unsigned)r15) < ((unsigned)r49) ) goto label$8608c30_13_294;
	r50 = NULL;
	goto label$8608c30_13_297;
	label$8608c30_13_294:
	r21 = r19->array;
	r7 = ((vdynamic**)(r21 + 1))[r15];
	r50 = (h3d__anim__LinearFrame)r7;
	label$8608c30_13_297:
	r19 = r20->frames;
	if( r19 == NULL ) hl_null_access();
	r49 = r19->length;
	if( ((unsigned)r18) < ((unsigned)r49) ) goto label$8608c30_13_303;
	r51 = NULL;
	goto label$8608c30_13_306;
	label$8608c30_13_303:
	r21 = r19->array;
	r7 = ((vdynamic**)(r21 + 1))[r18];
	r51 = (h3d__anim__LinearFrame)r7;
	label$8608c30_13_306:
	r52 = r20->matrix;
	...
	r52->_43 = r14;
	r6 = r20->hasRotation;
	if( !r6 ) goto label$8608c30_13_517;
	r14 = r50->qx;
	r16 = r51->qx;
	r14 = r14 * r16;
	r16 = r50->qy;
	...
	r14 = r14 + r16;
	r32 = 0.;
	if( !(r14 < r32) ) goto label$8608c30_13_349;
	r16 = -r5;
	goto label$8608c30_13_350;
	label$8608c30_13_349:
	r16 = r5;
	label$8608c30_13_350:
	r32 = r50->qx;
	r32 = r32 * r13;
	r44 = r51->qx;
	r44 = r44 * r16;
	...
	r54 = r46 * r47;
	r46 = r54;
	if( !r2 ) goto label$8608c30_13_421;
	r52->_12 = r32;
	r52->_13 = r44;
	r52->_21 = r45;
	r52->_23 = r46;
	r6 = r20->hasScale;
	if( !r6 ) goto label$8608c30_13_414;
	r54 = r50->sx;
	r54 = r54 * r13;
	r55 = r51->sx;
	r55 = r55 * r5;
	...
	r54 = r54 + r55;
	r52->_33 = r54;
	goto label$8608c30_13_420;
	label$8608c30_13_414:
	r54 = 1.;
	r52->_11 = r54;
	r54 = 1.;
	r52->_22 = r54;
	r54 = 1.;
	r52->_33 = r54;
	label$8608c30_13_420:
	goto label$8608c30_13_516;
	label$8608c30_13_421:
	r54 = r32 * r32;
	r55 = r32 * r44;
	r56 = r32 * r45;
	r57 = r32 * r46;
	...
	r52->_33 = r63;
	r6 = r20->hasScale;
	if( !r6 ) goto label$8608c30_13_516;
	r63 = r50->sx;
	r63 = r63 * r13;
	r64 = r51->sx;
	r64 = r64 * r5;
	...
	r66 = r66 * r65;
	r52->_33 = r66;
	label$8608c30_13_516:
	goto label$8608c30_13_555;
	label$8608c30_13_517:
	r14 = 0.;
	r52->_12 = r14;
	r14 = 0.;
	r52->_13 = r14;
	r14 = 0.;
	r52->_21 = r14;
	if( !r2 ) goto label$8608c30_13_526;
	r14 = 1.;
	goto label$8608c30_13_527;
	label$8608c30_13_526:
	r14 = 0.;
	label$8608c30_13_527:
	r52->_23 = r14;
	r6 = r20->hasScale;
	if( !r6 ) goto label$8608c30_13_549;
	r14 = r50->sx;
	r14 = r14 * r13;
	r16 = r51->sx;
	r16 = r16 * r5;
	...
	r14 = 1.;
	r52->_33 = r14;
	label$8608c30_13_555:
	r23 = r20->targetSkin;
	if( !r23 ) goto label$8608c30_13_573;
	r23 = r20->targetSkin;
	...
	r53 = r20->matrix;
	r49 = r19->length;
	if( ((unsigned)r48) < ((unsigned)r49) ) goto label$8608c30_13_566;
	hl_types_ArrayObj___expand(r19,r48);
	label$8608c30_13_566:
	r21 = r19->array;
	...
	goto label$8608c30_13_589;
	label$8608c30_13_573:
	r22 = r20->targetObject;
	r53 = r20->matrix;
	if( r22 == NULL ) hl_null_access();
	...
	r48 = 1;
	r6 = true;
	if( !r6 ) goto label$8608c30_13_584;
	r49 = r22->flags;
	r49 = r49 | r48;
	r22->flags = r49;
	goto label$8608c30_13_589;
	label$8608c30_13_584:
	r49 = r22->flags;
	r68 = -1;
	r67 = r48 ^ r68;
	r49 = r49 & r67;
	r22->flags = r49;
	label$8608c30_13_589:
	goto label$8608c30_13_55;
	label$8608c30_13_590:
	if( r2 ) goto label$8608c30_13_593;
	r6 = true;
	r0->isSync = r6;
	label$8608c30_13_593:
	return;
}

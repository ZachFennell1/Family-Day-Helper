...
void h3d_Buffer_uploadBytes(h3d__Buffer r0,haxe__io__Bytes r1,int r2,int r3) {
	...
	int *r14;
	vdynamic *r9;
	h3d__impl__ManagedBuffer r11;
	int r6, r7, r12, r13, r15;
	r4 = r0;
	label$e040f64_6_1:
	r7 = 0;
	if( r7 >= r3 ) goto label$e040f64_6_33;
	if( r4 ) goto label$e040f64_6_8;
	r10 = (String)s$Too_many_vertices;
	r9 = haxe_Exception_thrown(((vdynamic*)r10));
	hl_throw((vdynamic*)r9);
	label$e040f64_6_8:
	if( r4 == NULL ) hl_null_access();
	r7 = r4->vertices;
	if( r7 >= r3 ) goto label$e040f64_6_13;
	r6 = r4->vertices;
	goto label$e040f64_6_14;
	label$e040f64_6_13:
	r6 = r3;
	label$e040f64_6_14:
	r11 = r4->buffer;
	...
	r13 = r2;
	r14 = &r13;
	h3d_impl_ManagedBuffer_uploadVertexBytes(r11,r7,r6,r1,r14);
	r11 = r0->buffer;
	if( r11 == NULL ) hl_null_access();
	r15 = r11->stride;
	r12 = r6 * r15;
...
void h3d_Buffer_readBytes(h3d__Buffer r0,haxe__io__Bytes r1,int r2,int r3,int* r4) {
	...
	h3d__impl__ManagedBuffer r13;
	int r5, r9, r10, r14, r15, r16;
	if( r4 ) goto label$e040f64_7_3;
	r5 = 0;
	goto label$e040f64_7_4;
	label$e040f64_7_3:
	r5 = *r4;
	label$e040f64_7_4:
	r6 = r0;
	label$e040f64_7_5:
	if( !r6 ) goto label$e040f64_7_16;
	if( r6 == NULL ) hl_null_access();
	r10 = r6->vertices;
	if( r5 < r10 ) goto label$e040f64_7_16;
	r10 = r6->vertices;
	r9 = r5 - r10;
	r5 = r9;
	r8 = r6->next;
	r6 = r8;
	goto label$e040f64_7_5;
	label$e040f64_7_16:
	r10 = 0;
	if( r10 >= r3 ) goto label$e040f64_7_53;
	if( r6 ) goto label$e040f64_7_23;
	r12 = (String)s$Too_many_vertices;
	r11 = haxe_Exception_thrown(((vdynamic*)r12));
	hl_throw((vdynamic*)r11);
	label$e040f64_7_23:
	...
	if( r6 == NULL ) hl_null_access();
	r10 = r6->vertices;
	if( r10 >= r9 ) goto label$e040f64_7_30;
	r9 = r6->vertices;
	r9 = r9 - r5;
	goto label$e040f64_7_31;
	label$e040f64_7_30:
	r9 = r3;
	label$e040f64_7_31:
	r13 = r6->buffer;
	...
	r15 = r2;
	r4 = &r15;
	h3d_impl_ManagedBuffer_readVertexBytes(r13,r10,r9,r1,r4);
	r10 = 0;
	r5 = r10;
	r13 = r0->buffer;
	if( r13 == NULL ) hl_null_access();

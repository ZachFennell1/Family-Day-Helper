...
int h3d_shader_DirShadow_get_pcfQuality(h3d__shader__DirShadow r0) {
	int r1;
	r1 = r0->pcfQuality__;
	return r1;
}
...
h3d__Vector h3d_shader_DirShadow_get_shadowRes(h3d__shader__DirShadow r0) {
	h3d__Vector r1;
	r1 = r0->shadowRes__;
	return r1;
}
...
hl__types__ArrayObj h3d_shader_DirShadow_get_poissonDiskLow(h3d__shader__DirShadow r0) {
	hl__types__ArrayObj r1;
	r1 = r0->poissonDiskLow__;
	return r1;
}

hl__types__ArrayObj h3d_shader_DirShadow_get_poissonDiskHigh(h3d__shader__DirShadow r0) {
	hl__types__ArrayObj r1;
	r1 = r0->poissonDiskHigh__;
	return r1;
}

hl__types__ArrayObj h3d_shader_DirShadow_get_poissonDiskVeryHigh(h3d__shader__DirShadow r0) {
	hl__types__ArrayObj r1;
	r1 = r0->poissonDiskVeryHigh__;
	return r1;
}
...
h3d__Vector h3d_shader_DirShadow_set_shadowRes(h3d__shader__DirShadow r0,h3d__Vector r1) {
	r0->shadowRes__ = r1;
	return r1;
}
...
hl__types__ArrayObj h3d_shader_DirShadow_set_poissonDiskLow(h3d__shader__DirShadow r0,hl__types__ArrayObj r1) {
	r0->poissonDiskLow__ = r1;
	return r1;
}

hl__types__ArrayObj h3d_shader_DirShadow_set_poissonDiskHigh(h3d__shader__DirShadow r0,hl__types__ArrayObj r1) {
	r0->poissonDiskHigh__ = r1;
	return r1;
}

hl__types__ArrayObj h3d_shader_DirShadow_set_poissonDiskVeryHigh(h3d__shader__DirShadow r0,hl__types__ArrayObj r1) {
	r0->poissonDiskVeryHigh__ = r1;
	return r1;
}
...
void h3d_shader_DirShadow_updateConstants(h3d__shader__DirShadow r0,hxsl__Globals r1) {
	...
	label$0f39027_30_8:
	r4 = r0->USE_ESM__;
	if( !r4 ) goto label$0f39027_30_14;
	r2 = r0->constBits;
	r5 = 2;
	r2 = r2 | r5;
	r0->constBits = r2;
	label$0f39027_30_14:
	r4 = r0->USE_PCF__;
	if( !r4 ) goto label$0f39027_30_20;
	r2 = r0->constBits;
	r5 = 4;
	r2 = r2 | r5;
	r0->constBits = r2;
	...
	r5 = ((unsigned)r2) >> r6;
	r6 = 0;
	if( r5 == r6 ) goto label$0f39027_30_42;
...
hxsl__Shader h3d_shader_DirShadow_clone(h3d__shader__DirShadow r0) {
	...
	r2 = (h3d__shader__$DirShadow)g$_h3d_shader_DirShadow;
	r1 = Type_createEmptyInstance(((hl__Class)r2));
	r3 = (h3d__shader__DirShadow)hl_dyn_castp(&r1,&t$_dyn,&t$h3d_shader_DirShadow);
	...
	r6 = r0->shadowBias__;
	r3->shadowBias__ = r6;
	r11 = r0->poissonDiskLow__;
	r3->poissonDiskLow__ = r11;
	r11 = r0->poissonDiskHigh__;
	r3->poissonDiskHigh__ = r11;
	r11 = r0->poissonDiskVeryHigh__;
	r3->poissonDiskVeryHigh__ = r11;

...
hxsl__Shader h3d_shader_BaseMesh_clone(h3d__shader__BaseMesh r0) {
	...
	double r6;
	vdynamic *r1;
	r2 = (h3d__shader__$BaseMesh)g$_h3d_shader_BaseMesh;
	r1 = Type_createEmptyInstance(((hl__Class)r2));
	r3 = (h3d__shader__BaseMesh)hl_dyn_castp(&r1,&t$_dyn,&t$h3d_shader_BaseMesh);

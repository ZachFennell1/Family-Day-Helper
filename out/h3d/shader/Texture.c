...
void h3d_shader_Texture_updateConstants(h3d__shader__Texture r0,hxsl__Globals r1) {
	...
	label$8d17021_12_8:
	r4 = r0->killAlpha__;
	if( !r4 ) goto label$8d17021_12_14;
	r2 = r0->constBits;
	r5 = 2;
	r2 = r2 | r5;
	r0->constBits = r2;
	...
	if( !r4 ) goto label$8d17021_12_20;
	r2 = r0->constBits;
	r5 = 4;
	r2 = r2 | r5;
	r0->constBits = r2;
...
double h3d_shader_Texture_getParamFloatValue(h3d__shader__Texture r0,int r1) {
	...
	int r2;
	r2 = 3;
	if( r1 != r2 ) goto label$8d17021_14_4;
...
hxsl__Shader h3d_shader_Texture_clone(h3d__shader__Texture r0) {
	...
	r2 = (h3d__shader__$Texture)g$_h3d_shader_Texture;
	r1 = Type_createEmptyInstance(((hl__Class)r2));
	r3 = (h3d__shader__Texture)hl_dyn_castp(&r1,&t$_dyn,&t$h3d_shader_Texture);

...
void h3d_impl_ManagedBuffer_uploadVertexBuffer(h3d__impl__ManagedBuffer r0,int r1,int r2,hl__types__ArrayBytes_hl_F32 r3,int* r4) {
	...
	r9 = r0->vbuf;
	((void (*)(h3d__impl__Driver,vvirtual*,int,int,hl__types__ArrayBytes_hl_F32,int))r7->$type->vobj_proto[41])(r7,r9,r1,r2,r3,r5);
	return;
}
...
void h3d_impl_ManagedBuffer_uploadVertexBytes(h3d__impl__ManagedBuffer r0,int r1,int r2,haxe__io__Bytes r3,int* r4) {
	...
	h3d__impl__Driver r7;
	int r5;
	if( r4 ) goto label$27efc4d_3_3;
	r5 = 0;
	goto label$27efc4d_3_4;
	label$27efc4d_3_3:
	r5 = *r4;
	label$27efc4d_3_4:
	r8 = r0->mem;
...
void h3d_impl_ManagedBuffer_readVertexBytes(h3d__impl__ManagedBuffer r0,int r1,int r2,haxe__io__Bytes r3,int* r4) {
	...
	h3d__impl__Driver r7;
	int r5;
	if( r4 ) goto label$27efc4d_4_3;
	r5 = 0;
	goto label$27efc4d_4_4;
	label$27efc4d_4_3:
	r5 = *r4;
	label$27efc4d_4_4:
	r8 = r0->mem;
	...
	if( r7 == NULL ) hl_null_access();
	r9 = r0->vbuf;
	h3d_impl_Driver_readVertexBytes(r7,r9,r1,r2,r3,r5);
	return;
}
...
h3d__Buffer h3d_impl_ManagedBuffer_alloc(h3d__impl__ManagedBuffer r0,int r1,int r2) {
	...
	r5 = 0;
	if( r3 >= r5 ) goto label$27efc4d_5_5;
	r6 = NULL;
	return r6;
	label$27efc4d_5_5:
	...
	r11 = (venum*)g$h3d_BufferFlag_NoAlloc;
	r10 = 0;
	((venum**)(r8 + 1))[r10] = r11;
	r7 = hl_types_ArrayObj_alloc(r8);
	h3d_Buffer_new(r6,r1,r5,r7);
	r6->position = r3;
	r6->buffer = r0;
	return r6;
}
...
int h3d_impl_ManagedBuffer_allocPosition(h3d__impl__ManagedBuffer r0,int r1,int r2) {
	...
	r3 = r0->freeList;
	label$27efc4d_7_1:
	if( !r3 ) goto label$27efc4d_7_31;
	if( r3 == NULL ) hl_null_access();
	r6 = r3->count;
	if( r6 < r1 ) goto label$27efc4d_7_28;
	r7 = r3->pos;
	r7 = r2 == 0 ? 0 : r7 % r2;
	r6 = r2 - r7;
	r6 = r2 == 0 ? 0 : r6 % r2;
	r8 = 0;
	if( r6 != r8 ) goto label$27efc4d_7_13;
	goto label$27efc4d_7_31;
	label$27efc4d_7_13:
	r7 = r3->count;
	r8 = r1 + r6;
	if( r7 < r8 ) goto label$27efc4d_7_28;
	...
	r5 = r3->next;
	r3 = r5;
	goto label$27efc4d_7_1;
	label$27efc4d_7_31:
	if( r3 ) goto label$27efc4d_7_34;
	r6 = -1;
	return r6;
	label$27efc4d_7_34:
	if( r3 == NULL ) hl_null_access();
...
bool h3d_impl_ManagedBuffer_allocBuffer(h3d__impl__ManagedBuffer r0,h3d__Buffer r1) {
	...
	r2 = r2 & r3;
	r3 = 0;
	if( r2 == r3 ) goto label$27efc4d_8_8;
	r2 = 4;
	goto label$27efc4d_8_16;
	label$27efc4d_8_8:
	r2 = r1->flags;
	r3 = 2;
	r2 = r2 & r3;
	r3 = 0;
	if( r2 == r3 ) goto label$27efc4d_8_15;
	r2 = 3;
	goto label$27efc4d_8_16;
	label$27efc4d_8_15:
	r2 = 1;
	...
	r4 = 0;
	if( r3 >= r4 ) goto label$27efc4d_8_22;
	r5 = false;
	return r5;
	label$27efc4d_8_22:
	r1->position = r3;
...
void h3d_impl_ManagedBuffer_freeBuffer(h3d__impl__ManagedBuffer r0,h3d__Buffer r1) {
	...
	r6 = r6 + r5;
	label$27efc4d_9_6:
	if( !r4 ) goto label$27efc4d_9_63;
	if( r4 == NULL ) hl_null_access();
	r7 = r4->pos;
	if( r7 != r6 ) goto label$27efc4d_9_33;
	r7 = r4->pos;
	r7 = r7 - r5;
	r4->pos = r7;
	r7 = r4->count;
	r7 = r7 + r5;
	r4->count = r7;
	if( !r2 ) goto label$27efc4d_9_30;
	if( r2 == NULL ) hl_null_access();
	r7 = r2->pos;
	r9 = r2->count;
	r7 = r7 + r9;
	r9 = r4->pos;
	if( r7 != r9 ) goto label$27efc4d_9_30;
	r7 = r2->count;
	r9 = r4->count;
	r7 = r7 + r9;
	r2->count = r7;
	...
	r7 = 0;
	r5 = r7;
	goto label$27efc4d_9_63;
	label$27efc4d_9_33:
	r7 = r4->pos;
	if( r6 >= r7 ) goto label$27efc4d_9_59;
	if( !r2 ) goto label$27efc4d_9_47;
	if( r2 == NULL ) hl_null_access();
	r7 = r2->pos;
	r9 = r2->count;
	r7 = r7 + r9;
	if( r1 == NULL ) hl_null_access();
	r9 = r1->position;
	if( r7 != r9 ) goto label$27efc4d_9_47;
	r7 = r2->count;
	r7 = r7 + r5;
	r2->count = r7;
	goto label$27efc4d_9_56;
	label$27efc4d_9_47:
	...
	r8 = r4->next;
	r4 = r8;
	goto label$27efc4d_9_6;
	label$27efc4d_9_63:
	r9 = 0;
	if( r5 == r9 ) goto label$27efc4d_9_68;
	r12 = (String)s$assert;
	...
	r7 = r8->count;
	r9 = r0->size;
	if( r7 != r9 ) goto label$27efc4d_9_79;
	r7 = r0->flags;
	r9 = 8;
	r7 = r7 & r9;
	r9 = 0;
...
bool h3d_impl_ManagedBuffer_isDisposed(h3d__impl__ManagedBuffer r0) {
	...
	r2 = r0->vbuf;
	r3 = NULL;
	if( r2 == r3 || (r2 && r3 && r2->value && r3->value && r2->value == r3->value) ) goto label$27efc4d_11_5;
	r1 = false;
	goto label$27efc4d_11_6;
	label$27efc4d_11_5:
	r1 = true;
	label$27efc4d_11_6:
	return r1;

...
extern hl_type t$vrt_3f55de1;
extern hl_type t$_i32;
extern hl_type t$vrt_f8fce57;
...
void h3d_impl_MemoryManager_allocManaged(h3d__impl__MemoryManager r0,h3d__impl__ManagedBuffer r1) {
	...
	r3 = ((vvirtual* (*)(h3d__impl__Driver,h3d__impl__ManagedBuffer))r10->$type->vobj_proto[33])(r10,r1);
	r1->vbuf = r3;
...
void h3d_impl_MemoryManager_freeManaged(h3d__impl__MemoryManager r0,h3d__impl__ManagedBuffer r1) {
	...
	if( r6 == NULL ) hl_null_access();
	r3 = r1->vbuf;
	((void (*)(h3d__impl__Driver,vvirtual*))r6->$type->vobj_proto[37])(r6,r3);
	r3 = NULL;
	r1->vbuf = r3;
	r7 = r0->usedMemory;
	r8 = r1->size;
...
void h3d_impl_MemoryManager_deleteIndexes(h3d__impl__MemoryManager r0,h3d__Indexes r1) {
	...
	if( r1 == NULL ) hl_null_access();
	r6 = r1->ibuf;
	((void (*)(h3d__impl__Driver,vvirtual*))r5->$type->vobj_proto[36])(r5,r6);
	r6 = NULL;
	r1->ibuf = r6;
	r7 = r0->usedMemory;
	r8 = r1->count;
...
void h3d_impl_MemoryManager_allocIndexes(h3d__impl__MemoryManager r0,h3d__Indexes r1) {
	...
	r4 = r1->count;
	r5 = r1->is32;
	r2 = ((vvirtual* (*)(h3d__impl__Driver,int,bool))r3->$type->vobj_proto[32])(r3,r4,r5);
	r1->ibuf = r2;
	r6 = r0->indexes;
	if( r6 == NULL ) hl_null_access();
...
void h3d_impl_MemoryManager_deleteTexture(h3d__impl__MemoryManager r0,h3d__mat__Texture r1) {
	...
	r5 = r0->driver;
	if( r5 == NULL ) hl_null_access();
	((void (*)(h3d__impl__Driver,h3d__mat__Texture))r5->$type->vobj_proto[35])(r5,r1);
	r6 = r0->texMemory;
	if( r1 == NULL ) hl_null_access();
	r7 = r1->width;
	r8 = r1->height;
...
void h3d_impl_MemoryManager_allocTexture(h3d__impl__MemoryManager r0,h3d__mat__Texture r1) {
	...
	r6 = r0->driver;
	if( r6 == NULL ) hl_null_access();
	r5 = ((vvirtual* (*)(h3d__impl__Driver,h3d__mat__Texture))r6->$type->vobj_proto[31])(r6,r1);
	r1->_t = r5;
	r5 = r1->_t;
...
void h3d_impl_MemoryManager_allocDepth(h3d__impl__MemoryManager r0,h3d__mat__DepthBuffer r1) {
	...
	r6 = r0->driver;
	if( r6 == NULL ) hl_null_access();
	r5 = ((vvirtual* (*)(h3d__impl__Driver,h3d__mat__DepthBuffer))r6->$type->vobj_proto[25])(r6,r1);
	r1->b = r5;
	r5 = r1->b;
...
void h3d_impl_MemoryManager_deleteDepth(h3d__impl__MemoryManager r0,h3d__mat__DepthBuffer r1) {
	...
	r5 = r0->driver;
	if( r5 == NULL ) hl_null_access();
	((void (*)(h3d__impl__Driver,h3d__mat__DepthBuffer))r5->$type->vobj_proto[26])(r5,r1);
	r6 = r0->texMemory;
	if( r1 == NULL ) hl_null_access();
	r7 = r1->width;
	r8 = r1->height;
...
vvirtual* h3d_impl_MemoryManager_stats(h3d__impl__MemoryManager r0) {
	...
	h3d__impl___ManagedBuffer__FreeCell r14, r15;
	double r17, r18;
	vdynamic *r9;
	varray *r10;
	h3d__impl__ManagedBuffer r8, r11, r12;
	int r1, r2, r3, r4, r6, r7, r13;
	r1 = 0;
	r2 = 0;
	r3 = 0;
	r4 = 0;
	...
	if( r5 == NULL ) hl_null_access();
	r7 = r5->length;
	if( r4 >= r7 ) goto label$88467e8_21_49;
	r7 = r5->length;
	if( ((unsigned)r4) < ((unsigned)r7) ) goto label$88467e8_21_13;
	r8 = NULL;
	goto label$88467e8_21_16;
	label$88467e8_21_13:
	r10 = r5->array;
	...
	r11 = r8;
	label$88467e8_21_18:
	if( !r11 ) goto label$88467e8_21_48;
	if( r11 == NULL ) hl_null_access();
	r7 = r11->stride;
	r13 = r11->size;
	r7 = r7 * r13;
	...
	r14 = r11->freeList;
	label$88467e8_21_29:
	if( !r14 ) goto label$88467e8_21_43;
	if( r14 == NULL ) hl_null_access();
	r7 = r14->count;
	if( r11 == NULL ) hl_null_access();
	r13 = r11->stride;
	...
	r15 = r14->next;
	r14 = r15;
	goto label$88467e8_21_29;
	label$88467e8_21_43:
	++r3;
	if( r11 == NULL ) hl_null_access();
	r12 = r11->next;
	r11 = r12;
	goto label$88467e8_21_18;
	label$88467e8_21_48:
	goto label$88467e8_21_5;
	label$88467e8_21_49:
	r16 = hl_alloc_virtual(&t$vrt_3f55de1);
	r4 = r0->bufferCount;
	if( hl_vfields(r16)[0] ) *(int*)(hl_vfields(r16)[0]) = (int)r4; else hl_dyn_seti(r16->value,-407971921/*bufferCount*/,&t$_i32,r4);
	if( hl_vfields(r16)[1] ) *(int*)(hl_vfields(r16)[1]) = (int)r2; else hl_dyn_seti(r16->value,506895363/*freeManagedMemory*/,&t$_i32,r2);
	if( hl_vfields(r16)[2] ) *(int*)(hl_vfields(r16)[2]) = (int)r1; else hl_dyn_seti(r16->value,-536452549/*managedMemory*/,&t$_i32,r1);
	r17 = r0->usedMemory;
	r18 = r0->texMemory;
	r17 = r17 + r18;
	if( hl_vfields(r16)[5] ) *(double*)(hl_vfields(r16)[5]) = (double)r17; else hl_dyn_setd(r16->value,-352993952/*totalMemory*/,r17);
	r5 = r0->textures;
	if( r5 == NULL ) hl_null_access();
	r4 = r5->length;
	if( hl_vfields(r16)[3] ) *(int*)(hl_vfields(r16)[3]) = (int)r4; else hl_dyn_seti(r16->value,50524926/*textureCount*/,&t$_i32,r4);
	r17 = r0->texMemory;
	if( hl_vfields(r16)[4] ) *(double*)(hl_vfields(r16)[4]) = (double)r17; else hl_dyn_setd(r16->value,-136864595/*textureMemory*/,r17);
	return r16;
}

...
#ifndef INC_h3d__pass__ArrayCopy
#define INC_h3d__pass__ArrayCopy
typedef struct _h3d__pass__$ArrayCopy *h3d__pass__$ArrayCopy;
typedef struct _h3d__pass__ArrayCopy *h3d__pass__ArrayCopy;
#include <hl/Class.h>

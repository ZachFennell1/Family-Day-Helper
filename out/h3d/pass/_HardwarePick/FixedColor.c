...
hxsl__Shader h3d_pass__HardwarePick_FixedColor_clone(h3d__pass___HardwarePick__FixedColor r0) {
	...
	h3d__Vector r5;
	vdynamic *r1;
	r2 = (h3d__pass___HardwarePick__$FixedColor)g$d6bc8a1;
	r1 = Type_createEmptyInstance(((hl__Class)r2));
	r3 = (h3d__pass___HardwarePick__FixedColor)hl_dyn_castp(&r1,&t$_dyn,&t$h3d_pass__HardwarePick_FixedColor);

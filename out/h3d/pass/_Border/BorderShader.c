...
double h3d_pass__Border_BorderShader_getParamFloatValue(h3d__pass___Border__BorderShader r0,int r1) {
	...
	int r2;
	r2 = 0;
	if( r1 != r2 ) goto label$92f9745_6_4;
	r3 = r0->flipY__;
	return r3;
	label$92f9745_6_4:
	r3 = 0.;
...
hxsl__Shader h3d_pass__Border_BorderShader_clone(h3d__pass___Border__BorderShader r0) {
	...
	r2 = (h3d__pass___Border__$BorderShader)g$_h3d_pass__Border_BorderShader;
	r1 = Type_createEmptyInstance(((hl__Class)r2));
	r3 = (h3d__pass___Border__BorderShader)hl_dyn_castp(&r1,&t$_dyn,&t$h3d_pass__Border_BorderShader);

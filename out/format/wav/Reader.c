...
vvirtual* format_wav_Reader_read(format__wav__Reader r0) {
	...
	r6 = (String)s$RIFF;
	if( r2 == r6 || (r2 && r6 && String___compare(r2,(vdynamic*)r6) == 0) ) goto label$abad83d_3_10;
	...
	r6 = (String)s$WAVE;
	if( r2 == r6 || (r2 && r6 && String___compare(r2,(vdynamic*)r6) == 0) ) goto label$abad83d_3_23;
	...
	label$abad83d_3_28:
	r9 = (String)s$fmt_;
	if( r2 == r9 || (r2 && r9 && String___compare(r2,(vdynamic*)r9) == 0) ) goto label$abad83d_3_76;
	if( !r2 ) goto label$abad83d_3_40;
	r8 = r2->length;
	r10 = 4;
	if( r8 != r10 ) goto label$abad83d_3_40;
	r11 = r2->bytes;
	r12 = (vbyte*)USTR("JUNK");
	r8 = hl_string_compare(r11,r12,r8);
	r10 = 0;
	if( r8 == r10 ) goto label$abad83d_3_50;
	label$abad83d_3_40:
	if( !r2 ) goto label$abad83d_3_49;
	r8 = r2->length;
	r10 = 4;
	if( r8 != r10 ) goto label$abad83d_3_49;
	r11 = r2->bytes;
	r12 = (vbyte*)USTR("bext");
	r8 = hl_string_compare(r11,r12,r8);
	r10 = 0;
	if( r8 == r10 ) goto label$abad83d_3_63;
	label$abad83d_3_49:
	goto label$abad83d_3_76;
	label$abad83d_3_50:
	r3 = r0->i;
	if( r3 == NULL ) hl_null_access();
	...
	r2 = r6;
	label$abad83d_3_75:
	goto label$abad83d_3_28;
	label$abad83d_3_76:
	r9 = (String)s$fmt_;
	if( r2 == r9 || (r2 && r9 && String___compare(r2,(vdynamic*)r9) == 0) ) goto label$abad83d_3_82;
	...
	r21 = 16;
	if( r21 >= r8 ) goto label$abad83d_3_116;
	r3 = r0->i;
	if( r3 == NULL ) hl_null_access();
	r21 = 16;
	r20 = r8 - r21;
	...
	label$abad83d_3_121:
	r22 = (String)s$data;
	if( r6 == r22 || (r6 && r22 && String___compare(r6,(vdynamic*)r22) == 0) ) goto label$abad83d_3_137;
	r3 = r0->i;
	if( r3 == NULL ) hl_null_access();
	r23 = r0->i;
	...
	r6 = r9;
	goto label$abad83d_3_121;
	label$abad83d_3_137:
	r22 = (String)s$data;
	if( r6 == r22 || (r6 && r22 && String___compare(r6,(vdynamic*)r22) == 0) ) goto label$abad83d_3_142;
	...
	hl_trap(trap$0,r7,label$abad83d_3_152);
	r3 = r0->i;
	if( r3 == NULL ) hl_null_access();
	r24 = haxe_io_Input_read(r3,r20);
	r13 = r24;
	hl_endtrap(trap$0);
	goto label$abad83d_3_163;
	label$abad83d_3_152:
	r25 = NULL;
	...
	if( !r26 ) goto label$abad83d_3_162;
	...
	hl_trap(trap$0,r25,label$abad83d_3_223);
	label$abad83d_3_166:
	r26 = true;
	if( !r26 ) goto label$abad83d_3_221;
	r3 = r0->i;
	if( r3 == NULL ) hl_null_access();
	r21 = 4;
	r5 = NULL;
	...
	r30 = (String)s$cue_;
	if( r9 != r30 && (!r9 || !r30 || String___compare(r9,(vdynamic*)r30) != 0) ) goto label$abad83d_3_214;
	r3 = r0->i;
	if( r3 == NULL ) hl_null_access();
	...
	r32 = r21;
	label$abad83d_3_184:
	if( r31 >= r32 ) goto label$abad83d_3_213;
	++r31;
	r3 = r0->i;
	if( r3 == NULL ) hl_null_access();
	...
	goto label$abad83d_3_184;
	label$abad83d_3_213:
	goto label$abad83d_3_220;
	label$abad83d_3_214:
	r3 = r0->i;
	if( r3 == NULL ) hl_null_access();
	r23 = r0->i;
	...
	label$abad83d_3_220:
	goto label$abad83d_3_166;
	label$abad83d_3_221:
	hl_endtrap(trap$0);
	goto label$abad83d_3_231;
	label$abad83d_3_223:
	r37 = NULL;
	...
	if( r26 ) goto label$abad83d_3_231;

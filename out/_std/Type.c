...
venum* Type_typeof(vdynamic* r0) {
	...
	switch(r3) {
		...
		case 6:
			...
			if( r5 != r6 ) goto label$9fea9d9_18_15;
			r4 = (venum*)g$ValueType_TInt;
			return r4;
			label$9fea9d9_18_15:
		...
		case 11:
			...
			if( r7 == ((hl__Class)r8) ) goto label$9fea9d9_18_25;
			if( r7 ) goto label$9fea9d9_18_27;
			label$9fea9d9_18_25:
		...
		case 15:
			r2 = hl_get_virtual_value(r0);
			if( r2 ) goto label$9fea9d9_18_34;
			r4 = (venum*)g$ValueType_TObject;
			return r4;
			label$9fea9d9_18_34:
			r4 = Type_typeof(r2);
...
String Type_enumConstructor(vdynamic* r0) {
	...
	r6 = r4->length;
	if( ((unsigned)r5) < ((unsigned)r6) ) goto label$9fea9d9_19_10;
	r7 = NULL;
	goto label$9fea9d9_19_13;
	label$9fea9d9_19_10:
	r8 = r4->array;
	r2 = ((vdynamic**)(r8 + 1))[r5];
	r7 = (String)r2;
...
hl__types__ArrayDyn Type_allEnums(hl__BaseType r0) {
	...
	r9 = r3->size;
	label$9fea9d9_22_12:
	if( r5 >= r9 ) goto label$9fea9d9_22_23;
	r11 = r5;
	++r5;
	if( r1 == NULL ) hl_null_access();
	r10 = r1->__evalues__;
	r13 = ((vdynamic**)(r10 + 1))[r11];
	if( !r13 ) goto label$9fea9d9_22_22;
	if( r2 == NULL ) hl_null_access();
	r12 = hl_types_ArrayDyn_push(r2,r13);
	label$9fea9d9_22_22:
	goto label$9fea9d9_22_12;
	label$9fea9d9_22_23:
	return r2;
}

...
hl__types__ArrayObj EReg_split(EReg r0,String r1) {
	...
	r15 = 0;
	if( r11 != r15 ) goto label$6d09180_6_24;
	if( r7 ) goto label$6d09180_6_24;
	r15 = r1->length;
	if( r12 != r15 ) goto label$6d09180_6_23;
	goto label$6d09180_6_41;
	label$6d09180_6_23:
	++r12;
	label$6d09180_6_24:
	...
	r7 = r8;
	r8 = r0->global;
	if( r8 ) goto label$6d09180_6_40;
	goto label$6d09180_6_41;
	label$6d09180_6_40:
	goto label$6d09180_6_6;
	label$6d09180_6_41:
	if( r6 == NULL ) hl_null_access();
	r16 = hl_alloc_dynamic(&t$_i32);
	r16->v.i = r4;
...
String EReg_replace(EReg r0,String r1,String r2) {
	...
	if( !r11 ) goto label$6d09180_7_144;
	r14 = 0;
	r12 = r0->r;
	r16 = &r14;
	r15 = 0;
	...
	r20 = 0;
	if( r14 != r20 ) goto label$6d09180_7_27;
	if( r10 ) goto label$6d09180_7_27;
	r20 = r1->length;
	if( r15 != r20 ) goto label$6d09180_7_26;
	goto label$6d09180_7_144;
	label$6d09180_7_26:
	++r15;
	label$6d09180_7_27:
	if( r3 == NULL ) hl_null_access();
	...
	r19 = r8->length;
	r20 = 0;
	if( r20 >= r19 ) goto label$6d09180_7_44;
	r19 = 0;
	r20 = r8->length;
	if( ((unsigned)r19) < ((unsigned)r20) ) goto label$6d09180_7_40;
	r7 = NULL;
	goto label$6d09180_7_43;
	label$6d09180_7_40:
	r24 = r8->array;
	...
	if( r8 == NULL ) hl_null_access();
	r21 = r8->length;
	if( r19 >= r21 ) goto label$6d09180_7_132;
	r21 = r8->length;
	if( ((unsigned)r19) < ((unsigned)r21) ) goto label$6d09180_7_53;
	r7 = NULL;
	goto label$6d09180_7_56;
	label$6d09180_7_53:
	r24 = r8->array;
	r23 = ((vdynamic**)(r24 + 1))[r19];
	r7 = (String)r23;
	...
	r25 = 49;
	if( r20 < r25 ) goto label$6d09180_7_106;
	r25 = 57;
	if( r25 < r20 ) goto label$6d09180_7_106;
	r21 = 0;
	hl_trap(trap$0,r23,label$6d09180_7_75);
	r17 = r0->r;
	r25 = (int)r20;
	r26 = 48;
	r25 = r25 - r26;
	...
	if( !r11 ) goto label$6d09180_7_85;
	r25 = -1;
	r26 = r25;
	goto label$6d09180_7_86;
	label$6d09180_7_85:
	...
	label$6d09180_7_86:
	r27 = 0;
	if( r26 >= r27 ) goto label$6d09180_7_93;
	if( r3 == NULL ) hl_null_access();
	r9 = (String)s$c3e97dd;
	StringBuf_add(r3,((vdynamic*)r9));
	StringBuf_add(r3,((vdynamic*)r7));
	goto label$6d09180_7_105;
	label$6d09180_7_93:
	r27 = 0;
	if( r26 < r27 ) goto label$6d09180_7_98;
	if( r3 == NULL ) hl_null_access();
	r22 = hl_alloc_dynamic(&t$_i32);
	r22->v.i = r21;
	...
	label$6d09180_7_105:
	goto label$6d09180_7_130;
	label$6d09180_7_106:
	r26 = 0;
	if( r20 != r26 ) goto label$6d09180_7_126;
	if( r3 == NULL ) hl_null_access();
	r9 = (String)s$c3e97dd;
	StringBuf_add(r3,((vdynamic*)r9));
	++r19;
	r26 = r8->length;
	if( ((unsigned)r19) < ((unsigned)r26) ) goto label$6d09180_7_116;
	r9 = NULL;
	goto label$6d09180_7_119;
	label$6d09180_7_116:
	r24 = r8->array;
	r23 = ((vdynamic**)(r24 + 1))[r19];
	r9 = (String)r23;
	label$6d09180_7_119:
	if( !r9 ) goto label$6d09180_7_125;
	if( r9 == NULL ) hl_null_access();
	r25 = r9->length;
	r26 = 0;
	if( r26 >= r25 ) goto label$6d09180_7_125;
	StringBuf_add(r3,((vdynamic*)r9));
	label$6d09180_7_125:
	goto label$6d09180_7_130;
	label$6d09180_7_126:
	...
	r10 = r11;
	r11 = r0->global;
	if( r11 ) goto label$6d09180_7_143;
	goto label$6d09180_7_144;
	label$6d09180_7_143:
	goto label$6d09180_7_9;
	label$6d09180_7_144:
	if( r3 == NULL ) hl_null_access();
	r22 = hl_alloc_dynamic(&t$_i32);
	r22->v.i = r6;

...
h3d__Vector hxd__Pixels_PixelsFloat_Impl__getPixelF(hxd__Pixels r0,int r1,int r2,h3d__Vector r3) {
	haxe__io__Bytes r14;
	h3d__Vector r5;
	double r13;
	double *r6, *r7, *r8, *r9;
	int r10, r11, r12;
	if( r3 ) goto label$85ac789_1_8;
...
hxd__Pixels hxd__Pixels_PixelsFloat_Impl__fromPixels(hxd__Pixels r0) {
	...
	r3 = (venum*)g$hxd_PixelFormat_R32F;

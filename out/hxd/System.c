...
bool hxd_System_mainLoop() {
	...
	r7 = r8->CURRENT;
	if( !r7 ) goto label$7609c18_3_25;
	if( r7 == NULL ) hl_null_access();
	r1 = r7->ready;
	if( !r1 ) goto label$7609c18_3_25;
	r9 = r7->driver;
	if( r9 == NULL ) hl_null_access();
	((void (*)(h3d__impl__Driver))r9->$type->vobj_proto[28])(r9);
	label$7609c18_3_25:
	r1 = true;
	return r1;
}
...
void hxd_System_start(vclosure* r0) {
	...
	r11 = 0;
	r12 = r8->length;
	if( ((unsigned)r11) < ((unsigned)r12) ) goto label$7609c18_4_20;
	r7 = NULL;
	goto label$7609c18_4_23;
	label$7609c18_4_20:
	r14 = r8->array;
	...
	r11 = 1;
	r12 = r8->length;
	if( ((unsigned)r11) < ((unsigned)r12) ) goto label$7609c18_4_31;
	r7 = NULL;
	goto label$7609c18_4_34;
	label$7609c18_4_31:
	r14 = r8->array;
	r13 = ((vdynamic**)(r14 + 1))[r11];
	r7 = (String)r13;
...
void hxd_System_runMainLoop__$1(vdynamic* r0) {
	...
	if( !r5 ) goto label$7609c18_5_8;
	r4 = r0;
	goto label$7609c18_5_13;
	label$7609c18_5_8:
...
void hxd_System_runMainLoop() {
	...
	label$7609c18_6_1:
	r2 = true;
	if( !r2 ) goto label$7609c18_6_26;
	hl_trap(trap$0,r3,label$7609c18_6_17);
	...
	if( r2 ) goto label$7609c18_6_15;
	hl_endtrap(trap$0);
	goto label$7609c18_6_26;
	label$7609c18_6_15:
	hl_endtrap(trap$0);
	goto label$7609c18_6_25;
	label$7609c18_6_17:
	r9 = NULL;
...
void hxd_System_reportError(vdynamic* r0) {
	...
	if( !r4 ) goto label$7609c18_10_5;
	r3 = (haxe__Exception)r0;
	goto label$7609c18_10_6;
	label$7609c18_10_5:
	r3 = NULL;
	label$7609c18_10_6:
	if( !r3 ) goto label$7609c18_10_10;
	if( r3 == NULL ) hl_null_access();
	r7 = haxe_Exception_get_stack(r3);
	goto label$7609c18_10_12;
	label$7609c18_10_10:
	r8 = NULL;
	r7 = haxe__CallStack_CallStack_Impl__exceptionStack(r8);
	label$7609c18_10_12:
	r6 = haxe__CallStack_CallStack_Impl__toString(r7);
	hl_trap(trap$0,r1,label$7609c18_10_18);
	r10 = Std_string(r0);
	r9 = r10;
	hl_endtrap(trap$0);
	goto label$7609c18_10_21;
	label$7609c18_10_18:
	r11 = NULL;
	...
	if( r10 == r13 || (r10 && r13 && String___compare(r10,(vdynamic*)r13) == 0) ) goto label$7609c18_10_32;
	return;
	label$7609c18_10_32:
	r15 = (hxd__$System)g$_hxd_System;
	r4 = r15->dismissErrors;
	if( !r4 ) goto label$7609c18_10_36;
	return;
	label$7609c18_10_36:
	...
	r17 = ui_ui_loop(r4);
	r18 = 2;
	if( r17 == r18 ) goto label$7609c18_10_68;
	hxd_System_timeoutTick();
...
void hxd_System_setNativeCursor(venum* r0) {
	...
	if( r0 != r3 ) goto label$7609c18_11_18;
	r2 = false;
	r4 = (hxd__$System)g$_hxd_System;
	r4->cursorVisible = r2;
	r2 = false;
	...
	switch(r7) {
		...
		case 5:
			...
			if( r6 == NULL ) hl_null_access();
			r11 = r6->alloc;
			if( r11 ) goto label$7609c18_11_100;
			...
			r13 = r11->length;
			if( r7 >= r13 ) goto label$7609c18_11_100;
			r13 = r11->length;
			if( ((unsigned)r7) < ((unsigned)r13) ) goto label$7609c18_11_58;
			r15 = NULL;
			goto label$7609c18_11_61;
			label$7609c18_11_58:
			r16 = r11->array;
			...
			r12 = r6->offsetX;
			r13 = 0;
			if( r12 < r13 ) goto label$7609c18_11_80;
			r12 = r6->offsetX;
			r13 = r17->width;
			if( r12 >= r13 ) goto label$7609c18_11_80;
			r12 = r6->offsetY;
			...
			r12 = r6->offsetY;
			r13 = r17->height;
			if( r12 < r13 ) goto label$7609c18_11_83;
			label$7609c18_11_80:
			...
			goto label$7609c18_11_50;
			label$7609c18_11_100:
			if( r6 == NULL ) hl_null_access();
			r11 = r6->frames;
			if( r11 == NULL ) hl_null_access();
			r7 = r11->length;
			r12 = 1;
			if( r12 >= r7 ) goto label$7609c18_11_109;
			r4 = (hxd__$System)g$_hxd_System;
			r4->currentCustomCursor = r6;
			hxd_CustomCursor_reset(r6);
			label$7609c18_11_109:
			r11 = r6->alloc;
			if( r11 == NULL ) hl_null_access();
			r7 = r6->frameIndex;
			r12 = r11->length;
			if( ((unsigned)r7) < ((unsigned)r12) ) goto label$7609c18_11_116;
			r9 = NULL;
			goto label$7609c18_11_119;
			label$7609c18_11_116:
			r16 = r11->array;
			r5 = ((vdynamic**)(r16 + 1))[r7];
			r9 = (sdl_cursor*)hl_dyn_castp(&r5,&t$_dyn,&t$sdl_cursor);
			label$7609c18_11_119:
			r8 = r9;
			goto label$7609c18_11_125;
		case 6:
	...
	label$7609c18_11_125:
	sdl__Cursor_Cursor_Impl__set(r8);
	r4 = (hxd__$System)g$_hxd_System;
	r2 = r4->cursorVisible;
	if( r2 ) goto label$7609c18_11_134;
	r2 = true;
	r4 = (hxd__$System)g$_hxd_System;
	r4->cursorVisible = r2;
	r2 = true;
	sdl_show_cursor(r2);
	label$7609c18_11_134:
	return;
}
...
void hxd_System_updateCursor() {
	...
	if( !r1 ) goto label$7609c18_12_24;
	r2 = (hxd__$System)g$_hxd_System;
	r1 = r2->currentCustomCursor;
	...
	r6 = -1;
	if( r3 == r6 ) goto label$7609c18_12_24;
	r2 = (hxd__$System)g$_hxd_System;
	r1 = r2->currentCustomCursor;
	if( r1 == NULL ) hl_null_access();
	r7 = r1->alloc;
	if( r7 == NULL ) hl_null_access();
	r6 = r7->length;
	if( ((unsigned)r3) < ((unsigned)r6) ) goto label$7609c18_12_20;
	r8 = NULL;
	goto label$7609c18_12_23;
	label$7609c18_12_20:
	r10 = r7->array;
...
String hxd_System_getDeviceName() {
	...
	int r2, r3;
	r0 = (String)s$PC_;
	r1 = sdl_Sdl_getDevices();
	if( r1 == NULL ) hl_null_access();
	r2 = 0;
	r3 = r1->length;
	if( ((unsigned)r2) < ((unsigned)r3) ) goto label$7609c18_13_8;
	r4 = NULL;
	goto label$7609c18_13_11;
	label$7609c18_13_8:
	r6 = r1->array;
	r5 = ((vdynamic**)(r6 + 1))[r2];
	r4 = (String)r5;
	label$7609c18_13_11:
	r0 = String___add__(r0,r4);
	return r0;
}
...
bool hxd_System_getValue(venum* r0) {
	...
	switch(r1) {
		default:
			goto label$7609c18_15_35;
		case 0:
			r2 = hxd_System_get_platform();
			r3 = (venum*)g$hxd_Platform_IOS;
			if( r2 == r3 ) goto label$7609c18_15_14;
			r2 = hxd_System_get_platform();
			r3 = (venum*)g$hxd_Platform_Android;
			if( r2 == r3 ) goto label$7609c18_15_12;
			r4 = false;
			goto label$7609c18_15_13;
			label$7609c18_15_12:
			r4 = true;
			label$7609c18_15_13:
			return r4;
		...
		case 1:
			...
			if( r2 == r3 ) goto label$7609c18_15_21;
			r4 = false;
			goto label$7609c18_15_22;
			label$7609c18_15_21:
			r4 = true;
			label$7609c18_15_22:
			return r4;
		case 2:
			r2 = hxd_System_get_platform();
			r3 = (venum*)g$hxd_Platform_IOS;
			if( r2 == r3 ) goto label$7609c18_15_33;
			r2 = hxd_System_get_platform();
			r3 = (venum*)g$hxd_Platform_Android;
			if( r2 == r3 ) goto label$7609c18_15_31;
			r4 = false;
			goto label$7609c18_15_32;
			label$7609c18_15_31:
			r4 = true;
			label$7609c18_15_32:
			return r4;
...
void hxd_System_exit() {
	...
	int r2;
	hl_trap_ctx trap$0;
	hl_trap(trap$0,r0,label$7609c18_16_5);
	r2 = 0;
	hl_sys_exit(r2);
	hl_endtrap(trap$0);
	goto label$7609c18_16_7;
	label$7609c18_16_5:
	r3 = NULL;
	hxd_System_exit();
	label$7609c18_16_7:
...
void hxd_System_openURL(String r0) {
	...
	int r3, r4;
	r2 = Sys_systemName();
	if( !r2 ) goto label$7609c18_17_10;
	r3 = r2->length;
	r4 = 5;
	if( r3 != r4 ) goto label$7609c18_17_10;
	r5 = r2->bytes;
	r6 = (vbyte*)USTR("Linux");
	r3 = hl_string_compare(r5,r6,r3);
	r4 = 0;
	if( r3 == r4 ) goto label$7609c18_17_56;
	label$7609c18_17_10:
	if( !r2 ) goto label$7609c18_17_19;
	r3 = r2->length;
	r4 = 3;
	if( r3 != r4 ) goto label$7609c18_17_19;
	r5 = r2->bytes;
	r6 = (vbyte*)USTR("Mac");
	r3 = hl_string_compare(r5,r6,r3);
	r4 = 0;
	if( r3 == r4 ) goto label$7609c18_17_61;
	label$7609c18_17_19:
	if( !r2 ) goto label$7609c18_17_28;
	r3 = r2->length;
	r4 = 7;
	if( r3 != r4 ) goto label$7609c18_17_28;
	r5 = r2->bytes;
	r6 = (vbyte*)USTR("Windows");
	r3 = hl_string_compare(r5,r6,r3);
	r4 = 0;
	if( r3 == r4 ) goto label$7609c18_17_66;
	label$7609c18_17_28:
	if( !r2 ) goto label$7609c18_17_37;
	r3 = r2->length;
	r4 = 7;
	if( r3 != r4 ) goto label$7609c18_17_37;
	r5 = r2->bytes;
	r6 = (vbyte*)USTR("Android");
	r3 = hl_string_compare(r5,r6,r3);
	r4 = 0;
	if( r3 == r4 ) goto label$7609c18_17_71;
	label$7609c18_17_37:
	if( !r2 ) goto label$7609c18_17_46;
	r3 = r2->length;
	r4 = 3;
	if( r3 != r4 ) goto label$7609c18_17_46;
	r5 = r2->bytes;
	r6 = (vbyte*)USTR("iOS");
	r3 = hl_string_compare(r5,r6,r3);
	r4 = 0;
	if( r3 == r4 ) goto label$7609c18_17_71;
	label$7609c18_17_46:
	if( !r2 ) goto label$7609c18_17_55;
	r3 = r2->length;
	r4 = 4;
	if( r3 != r4 ) goto label$7609c18_17_55;
	r5 = r2->bytes;
	r6 = (vbyte*)USTR("tvOS");
	r3 = hl_string_compare(r5,r6,r3);
	r4 = 0;
...
String hxd_System_get_lang() {
	...
	r1 = (hxd__$System)g$_hxd_System;
	r0 = r1->_lang;
	if( r0 ) goto label$7609c18_18_12;
	r0 = hxd_System_getLocale();
	if( r0 == NULL ) hl_null_access();
	r5 = (String)s$336d5eb;
	r3 = String_split(r0,r5);
	if( r3 == NULL ) hl_null_access();
...
String hxd_System_getLocale() {
	...
	r2 = (hxd__$System)g$_hxd_System;
	r1 = r2->_loc;
	if( r1 ) goto label$7609c18_19_24;
	r3 = hl_sys_locale();
	r1 = Sys_makePath(r3);
	if( r1 ) goto label$7609c18_19_8;
	r4 = (String)s$en;
	r1 = r4;
	label$7609c18_19_8:
	...
	r8 = 0;
	r9 = r5->length;
	if( ((unsigned)r8) < ((unsigned)r9) ) goto label$7609c18_19_19;
	r4 = NULL;
	goto label$7609c18_19_22;
	label$7609c18_19_19:
	r11 = r5->array;
...
int hxd_System_get_width() {
	int r0;
	r0 = sdl_get_screen_width();
	return r0;
}

int hxd_System_get_height() {
	int r0;
	r0 = sdl_get_screen_height();
	return r0;
}
...
venum* hxd_System_get_platform() {
	...
	r1 = (hxd__$System)g$_hxd_System;
	r0 = r1->platform;
	if( r0 ) goto label$7609c18_22_67;
	r2 = Sys_systemName();
	if( !r2 ) goto label$7609c18_22_13;
	r3 = r2->length;
	r4 = 7;
	if( r3 != r4 ) goto label$7609c18_22_13;
	r5 = r2->bytes;
	r6 = (vbyte*)USTR("Android");
	r3 = hl_string_compare(r5,r6,r3);
	r4 = 0;
	if( r3 == r4 ) goto label$7609c18_22_60;
	label$7609c18_22_13:
	if( !r2 ) goto label$7609c18_22_22;
	r3 = r2->length;
	r4 = 5;
	if( r3 != r4 ) goto label$7609c18_22_22;
	r5 = r2->bytes;
	r6 = (vbyte*)USTR("Linux");
	r3 = hl_string_compare(r5,r6,r3);
	r4 = 0;
	if( r3 == r4 ) goto label$7609c18_22_62;
	label$7609c18_22_22:
	if( !r2 ) goto label$7609c18_22_31;
	r3 = r2->length;
	r4 = 3;
	if( r3 != r4 ) goto label$7609c18_22_31;
	r5 = r2->bytes;
	r6 = (vbyte*)USTR("Mac");
	r3 = hl_string_compare(r5,r6,r3);
	r4 = 0;
	if( r3 == r4 ) goto label$7609c18_22_62;
	label$7609c18_22_31:
	if( !r2 ) goto label$7609c18_22_40;
	r3 = r2->length;
	r4 = 7;
	if( r3 != r4 ) goto label$7609c18_22_40;
	r5 = r2->bytes;
	r6 = (vbyte*)USTR("Windows");
	r3 = hl_string_compare(r5,r6,r3);
	r4 = 0;
	if( r3 == r4 ) goto label$7609c18_22_62;
	label$7609c18_22_40:
	if( !r2 ) goto label$7609c18_22_49;
	r3 = r2->length;
	r4 = 3;
	if( r3 != r4 ) goto label$7609c18_22_49;
	r5 = r2->bytes;
	r6 = (vbyte*)USTR("iOS");
	r3 = hl_string_compare(r5,r6,r3);
	r4 = 0;
	if( r3 == r4 ) goto label$7609c18_22_64;
	label$7609c18_22_49:
	if( !r2 ) goto label$7609c18_22_58;
	r3 = r2->length;
	r4 = 4;
	if( r3 != r4 ) goto label$7609c18_22_58;
	r5 = r2->bytes;
	r6 = (vbyte*)USTR("tvOS");
	r3 = hl_string_compare(r5,r6,r3);
	r4 = 0;

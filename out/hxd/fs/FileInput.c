...
void hxd_fs_FileInput_skip(hxd__fs__FileInput r0,int r1) {
	...
	((void (*)(hxd__fs__FileEntry,int))r3->$type->vobj_proto[3])(r3,r1);
	return;
}
...
int hxd_fs_FileInput_readByte(hxd__fs__FileInput r0) {
	...
	r1 = ((int (*)(hxd__fs__FileEntry))r2->$type->vobj_proto[4])(r2);
	return r1;
}
...
int hxd_fs_FileInput_readBytes(hxd__fs__FileInput r0,haxe__io__Bytes r1,int r2,int r3) {
	...
	((void (*)(hxd__fs__FileEntry,haxe__io__Bytes,int,int))r5->$type->vobj_proto[5])(r5,r1,r2,r3);
	return r3;
}
...
void hxd_fs_FileInput_close(hxd__fs__FileInput r0) {
	...
	r2 = r0->f;
	if( r2 == NULL ) hl_null_access();
	((void (*)(hxd__fs__FileEntry))r2->$type->vobj_proto[6])(r2);
	return;
}

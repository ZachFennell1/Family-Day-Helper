...
extern String s$LayerElementTangent;
extern String s$Tangents;
extern String s$LayerElementBinormal;
extern String s$Binormals;
...
hl__types__ArrayBytes_Float hxd_fmt_fbx_Geometry_getTangents(hxd__fmt__fbx__Geometry r0,bool* r1) {
	...
	if( r1 ) goto label$8345228_10_3;
	r2 = false;
	goto label$8345228_10_4;
	label$8345228_10_3:
	r2 = *r1;
	label$8345228_10_4:
	r4 = (String)s$LayerElementTangent;
	r5 = (String)s$Tangents;
	r6 = r2;
	r1 = &r6;
...
hl__types__ArrayBytes_Float hxd_fmt_fbx_Geometry_getBinormals(hxd__fmt__fbx__Geometry r0,bool* r1) {
	...
	bool r2, r6;
	hl__types__ArrayBytes_Float r3;
	if( r1 ) goto label$8345228_11_3;
	r2 = false;
	goto label$8345228_11_4;
	label$8345228_11_3:
	r2 = *r1;
	label$8345228_11_4:
	r4 = (String)s$LayerElementBinormal;
	r5 = (String)s$Binormals;
	r6 = r2;
	r1 = &r6;
	r3 = hxd_fmt_fbx_Geometry_processVectors(r0,r4,r5,r1);
	return r3;
...
hl__types__ArrayBytes_Float hxd_fmt_fbx_Geometry_processVectors(hxd__fmt__fbx__Geometry r0,String r1,String r2,bool* r3) {
	...
	if( r3 ) goto label$8345228_12_3;
	r4 = false;
	goto label$8345228_12_4;
	label$8345228_12_3:
	r4 = *r3;
	label$8345228_12_4:
	r5 = r0->root;
	...
	if( r5 ) goto label$8345228_12_14;
	r10 = NULL;
	return r10;
	label$8345228_12_14:
	...
	r13 = 0;
	r14 = r12->length;
	if( ((unsigned)r13) < ((unsigned)r14) ) goto label$8345228_12_28;
	r15 = NULL;
	goto label$8345228_12_31;
	label$8345228_12_28:
	r16 = r12->array;
	...
	if( r6 != r7 && (!r6 || !r7 || String___compare(r6,(vdynamic*)r7) != 0) ) goto label$8345228_12_102;
	r13 = 0;
	...
	if( r19 == NULL ) hl_null_access();
	r20 = r19->length;
	if( r13 >= r20 ) goto label$8345228_12_101;
	r20 = r19->length;
	if( ((unsigned)r13) < ((unsigned)r20) ) goto label$8345228_12_49;
	r14 = 0;
	goto label$8345228_12_53;
	label$8345228_12_49:
	r18 = r19->bytes;
	r20 = 2;
	r20 = r13 << r20;
	...
	r20 = r14;
	r22 = 0;
	if( r14 >= r22 ) goto label$8345228_12_61;
	r21 = -r14;
	r22 = 1;
	r21 = r21 - r22;
	r20 = r21;
	...
	r21 = r20 * r22;
	r22 = r10->length;
	if( ((unsigned)r21) < ((unsigned)r22) ) goto label$8345228_12_69;
	r23 = 0.;
	goto label$8345228_12_73;
	label$8345228_12_69:
	r18 = r10->bytes;
	r22 = 3;
	r22 = r21 << r22;
	...
	r21 = r21 + r22;
	r22 = r10->length;
	if( ((unsigned)r21) < ((unsigned)r22) ) goto label$8345228_12_82;
	r23 = 0.;
	goto label$8345228_12_86;
	label$8345228_12_82:
	r18 = r10->bytes;
	r22 = 3;
	r22 = r21 << r22;
	...
	r21 = r21 + r22;
	r22 = r10->length;
	if( ((unsigned)r21) < ((unsigned)r22) ) goto label$8345228_12_95;
	r23 = 0.;
	goto label$8345228_12_99;
	label$8345228_12_95:
	r18 = r10->bytes;
	r22 = 3;
	r22 = r21 << r22;
	...
	label$8345228_12_99:
	r21 = hl_types_ArrayBytes_Float_push(r17,r23);
	goto label$8345228_12_41;
	label$8345228_12_101:
	r10 = r17;
	label$8345228_12_102:
	return r10;
}
...
vvirtual* hxd_fmt_fbx_Geometry_getColors(hxd__fmt__fbx__Geometry r0) {
	...
	r4 = &r7;
	r5 = hxd_fmt_fbx_FbxTools_get(r1,r2,r4);
	if( r5 ) goto label$8345228_13_15;
	r6 = NULL;
	return r6;
	label$8345228_13_15:
...
hl__types__ArrayObj hxd_fmt_fbx_Geometry_getUVs(hxd__fmt__fbx__Geometry r0) {
	...
	if( r5 == NULL ) hl_null_access();
	r9 = r5->length;
	if( r4 >= r9 ) goto label$8345228_14_68;
	r9 = r5->length;
	if( ((unsigned)r4) < ((unsigned)r9) ) goto label$8345228_14_16;
	r6 = NULL;
	goto label$8345228_14_19;
	label$8345228_14_16:
	r2 = r5->array;
	...
	if( r11 ) goto label$8345228_14_61;
	r8 = 0;
	...
	if( r18 == NULL ) hl_null_access();
	r19 = r18->length;
	if( r8 >= r19 ) goto label$8345228_14_60;
	r19 = r18->length;
	if( ((unsigned)r8) < ((unsigned)r19) ) goto label$8345228_14_44;
	r9 = 0;
	goto label$8345228_14_48;
	label$8345228_14_44:
	r17 = r18->bytes;
	r19 = 2;
	r19 = r8 << r19;
	...
	++r8;
	r20 = 0;
	if( r9 >= r20 ) goto label$8345228_14_57;
	if( r16 == NULL ) hl_null_access();
	r19 = -r9;
	r20 = 1;
	r19 = r19 - r20;
	r19 = hl_types_ArrayBytes_Int_push(r16,r19);
	goto label$8345228_14_59;
	label$8345228_14_57:
	if( r16 == NULL ) hl_null_access();
	r19 = hl_types_ArrayBytes_Int_push(r16,r9);
	label$8345228_14_59:
	goto label$8345228_14_36;
	label$8345228_14_60:
	goto label$8345228_14_62;
	label$8345228_14_61:
...
h3d__Matrix hxd_fmt_fbx_Geometry_getGeomMatrix(hxd__fmt__fbx__Geometry r0) {
	...
	if( r5 == NULL ) hl_null_access();
	r11 = r5->length;
	if( r4 >= r11 ) goto label$8345228_15_155;
	r11 = r5->length;
	if( ((unsigned)r4) < ((unsigned)r11) ) goto label$8345228_15_19;
	r6 = NULL;
	goto label$8345228_15_22;
	label$8345228_15_19:
	r14 = r5->array;
	...
	r10 = 0;
	r11 = r12->length;
	if( ((unsigned)r10) < ((unsigned)r11) ) goto label$8345228_15_31;
	r15 = NULL;
	goto label$8345228_15_34;
	label$8345228_15_31:
	r14 = r12->array;
	...
	if( !r8 ) goto label$8345228_15_44;
	r10 = r8->length;
	r11 = 17;
	if( r10 != r11 ) goto label$8345228_15_44;
	r16 = r8->bytes;
	r17 = (vbyte*)USTR("GeometricRotation");
	r10 = hl_string_compare(r16,r17,r10);
	r11 = 0;
	if( r10 == r11 ) goto label$8345228_15_54;
	label$8345228_15_44:
	if( !r8 ) goto label$8345228_15_53;
	r10 = r8->length;
	r11 = 20;
	if( r10 != r11 ) goto label$8345228_15_53;
	r16 = r8->bytes;
	r17 = (vbyte*)USTR("GeometricTranslation");
	r10 = hl_string_compare(r16,r17,r10);
	r11 = 0;
	if( r10 == r11 ) goto label$8345228_15_106;
	label$8345228_15_53:
	goto label$8345228_15_154;
	label$8345228_15_54:
	...
	r10 = 4;
	r11 = r12->length;
	if( ((unsigned)r10) < ((unsigned)r11) ) goto label$8345228_15_62;
	r15 = NULL;
	goto label$8345228_15_65;
	label$8345228_15_62:
	r14 = r12->array;
	r13 = ((vdynamic**)(r14 + 1))[r10];
	r15 = (venum*)r13;
	...
	r10 = 5;
	r11 = r12->length;
	if( ((unsigned)r10) < ((unsigned)r11) ) goto label$8345228_15_78;
	r15 = NULL;
	goto label$8345228_15_81;
	label$8345228_15_78:
	r14 = r12->array;
	r13 = ((vdynamic**)(r14 + 1))[r10];
	r15 = (venum*)r13;
	...
	r10 = 6;
	r11 = r12->length;
	if( ((unsigned)r10) < ((unsigned)r11) ) goto label$8345228_15_94;
	r15 = NULL;
	goto label$8345228_15_97;
	label$8345228_15_94:
	r14 = r12->array;
	r13 = ((vdynamic**)(r14 + 1))[r10];
	r15 = (venum*)r13;
	...
	r1 = r18;
	goto label$8345228_15_154;
	label$8345228_15_106:
	r18 = (h3d__col__Point)hl_alloc_obj(&t$h3d_col_Point);
	r12 = hl_vfields(r6)[2] ? (*(hl__types__ArrayObj*)(hl_vfields(r6)[2])) : (hl__types__ArrayObj)hl_dyn_getp(r6->value,-393222421/*props*/,&t$hl_types_ArrayObj);
	if( r12 == NULL ) hl_null_access();
	r10 = 4;
	r11 = r12->length;
	if( ((unsigned)r10) < ((unsigned)r11) ) goto label$8345228_15_114;
	r15 = NULL;
	goto label$8345228_15_117;
	label$8345228_15_114:
	r14 = r12->array;
	r13 = ((vdynamic**)(r14 + 1))[r10];
	r15 = (venum*)r13;
	label$8345228_15_117:
	r24 = hxd_fmt_fbx_FbxTools_toFloat(r15);
	r7 = r0->lib;
	if( r7 == NULL ) hl_null_access();
	r26 = r7->leftHand;
	if( !r26 ) goto label$8345228_15_124;
	r10 = -1;
	goto label$8345228_15_125;
	label$8345228_15_124:
	r10 = 1;
	label$8345228_15_125:
	r27 = (double)r10;
	r24 = r24 * r27;
	r21 = &r24;
	r12 = hl_vfields(r6)[2] ? (*(hl__types__ArrayObj*)(hl_vfields(r6)[2])) : (hl__types__ArrayObj)hl_dyn_getp(r6->value,-393222421/*props*/,&t$hl_types_ArrayObj);
	...
	r10 = 5;
	r11 = r12->length;
	if( ((unsigned)r10) < ((unsigned)r11) ) goto label$8345228_15_135;
	r15 = NULL;
	goto label$8345228_15_138;
	label$8345228_15_135:
	r14 = r12->array;
	r13 = ((vdynamic**)(r14 + 1))[r10];
	r15 = (venum*)r13;
	label$8345228_15_138:
	...
	r10 = 6;
	r11 = r12->length;
	if( ((unsigned)r10) < ((unsigned)r11) ) goto label$8345228_15_147;
	r15 = NULL;
	goto label$8345228_15_150;
	label$8345228_15_147:
	r14 = r12->array;
	r13 = ((vdynamic**)(r14 + 1))[r10];
	r15 = (venum*)r13;
	label$8345228_15_150:
	r28 = hxd_fmt_fbx_FbxTools_toFloat(r15);
	r25 = &r28;
	h3d_col_Point_new(r18,r21,r23,r25);
	r3 = r18;
	label$8345228_15_154:
	goto label$8345228_15_11;
	label$8345228_15_155:
	if( r1 ) goto label$8345228_15_159;
	if( r3 ) goto label$8345228_15_159;
	r29 = NULL;
	return r29;
	label$8345228_15_159:
	r29 = (h3d__Matrix)hl_alloc_obj(&t$h3d_Matrix);
	h3d_Matrix_new(r29);
	if( r1 ) goto label$8345228_15_164;
	h3d_Matrix_identity(r29);
	goto label$8345228_15_169;
	label$8345228_15_164:
	if( r1 == NULL ) hl_null_access();
	r30 = r1->x;
	r31 = r1->y;
	r32 = r1->z;
	h3d_Matrix_initRotation(r29,r30,r31,r32);
	label$8345228_15_169:
	if( !r3 ) goto label$8345228_15_183;
	r30 = r29->_41;
	if( r3 == NULL ) hl_null_access();
	r31 = r3->x;
	r30 = r30 + r31;

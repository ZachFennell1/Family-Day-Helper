...
void hxd_fmt_hmd_Writer_writeFloat(hxd__fmt__hmd__Writer r0,double r1) {
	...
	if( r3 == NULL ) hl_null_access();
	r5 = 0.;
	if( r1 != r5 ) goto label$29ff4bb_5_6;
	r4 = 0.;
	goto label$29ff4bb_5_7;
	label$29ff4bb_5_6:
	r4 = r1;
	label$29ff4bb_5_7:
...
void hxd_fmt_hmd_Writer_writePosition(hxd__fmt__hmd__Writer r0,hxd__fmt__hmd__Position r1,bool* r2) {
	...
	haxe__io__Output r6;
	double r4, r7, r8;
	if( r2 ) goto label$29ff4bb_6_3;
	r3 = true;
	goto label$29ff4bb_6_4;
	label$29ff4bb_6_3:
	r3 = *r2;
	label$29ff4bb_6_4:
	if( r1 == NULL ) hl_null_access();
	...
	if( r6 == NULL ) hl_null_access();
	r8 = 0.;
	if( r4 != r8 ) goto label$29ff4bb_6_12;
	r7 = 0.;
	goto label$29ff4bb_6_13;
	label$29ff4bb_6_12:
	r7 = r4;
	label$29ff4bb_6_13:
	...
	if( r6 == NULL ) hl_null_access();
	r8 = 0.;
	if( r4 != r8 ) goto label$29ff4bb_6_21;
	r7 = 0.;
	goto label$29ff4bb_6_22;
	label$29ff4bb_6_21:
	r7 = r4;
	label$29ff4bb_6_22:
	haxe_io_Output_writeFloat(r6,r7);
	...
	if( r6 == NULL ) hl_null_access();
	r8 = 0.;
	if( r4 != r8 ) goto label$29ff4bb_6_30;
	r7 = 0.;
	goto label$29ff4bb_6_31;
	label$29ff4bb_6_30:
	r7 = r4;
	label$29ff4bb_6_31:
	haxe_io_Output_writeFloat(r6,r7);
	...
	if( r6 == NULL ) hl_null_access();
	r8 = 0.;
	if( r4 != r8 ) goto label$29ff4bb_6_39;
	r7 = 0.;
	goto label$29ff4bb_6_40;
	label$29ff4bb_6_39:
	r7 = r4;
	label$29ff4bb_6_40:
	haxe_io_Output_writeFloat(r6,r7);
	...
	if( r6 == NULL ) hl_null_access();
	r8 = 0.;
	if( r4 != r8 ) goto label$29ff4bb_6_48;
	r7 = 0.;
	goto label$29ff4bb_6_49;
	label$29ff4bb_6_48:
	r7 = r4;
	label$29ff4bb_6_49:
	haxe_io_Output_writeFloat(r6,r7);
	...
	if( r6 == NULL ) hl_null_access();
	r8 = 0.;
	if( r4 != r8 ) goto label$29ff4bb_6_57;
	r7 = 0.;
	goto label$29ff4bb_6_58;
	label$29ff4bb_6_57:
	r7 = r4;
	label$29ff4bb_6_58:
	haxe_io_Output_writeFloat(r6,r7);
	if( !r3 ) goto label$29ff4bb_6_87;
	r4 = r1->sx;
	r6 = r0->out;
	if( r6 == NULL ) hl_null_access();
	r8 = 0.;
	if( r4 != r8 ) goto label$29ff4bb_6_67;
	r7 = 0.;
	goto label$29ff4bb_6_68;
	label$29ff4bb_6_67:
	r7 = r4;
	label$29ff4bb_6_68:
	haxe_io_Output_writeFloat(r6,r7);
	...
	if( r6 == NULL ) hl_null_access();
	r8 = 0.;
	if( r4 != r8 ) goto label$29ff4bb_6_76;
	r7 = 0.;
	goto label$29ff4bb_6_77;
	label$29ff4bb_6_76:
	r7 = r4;
	label$29ff4bb_6_77:
	haxe_io_Output_writeFloat(r6,r7);
	...
	if( r6 == NULL ) hl_null_access();
	r8 = 0.;
	if( r4 != r8 ) goto label$29ff4bb_6_85;
	r7 = 0.;
	goto label$29ff4bb_6_86;
	label$29ff4bb_6_85:
	r7 = r4;
	label$29ff4bb_6_86:
	haxe_io_Output_writeFloat(r6,r7);
...
void hxd_fmt_hmd_Writer_writeBounds(hxd__fmt__hmd__Writer r0,h3d__col__Bounds r1) {
	...
	r6 = 0.;
	if( r2 != r6 ) goto label$29ff4bb_7_8;
	r5 = 0.;
	goto label$29ff4bb_7_9;
	label$29ff4bb_7_8:
	r5 = r2;
	label$29ff4bb_7_9:
	...
	if( r4 == NULL ) hl_null_access();
	r6 = 0.;
	if( r2 != r6 ) goto label$29ff4bb_7_17;
	r5 = 0.;
	goto label$29ff4bb_7_18;
	label$29ff4bb_7_17:
	r5 = r2;
	label$29ff4bb_7_18:
	haxe_io_Output_writeFloat(r4,r5);
	...
	if( r4 == NULL ) hl_null_access();
	r6 = 0.;
	if( r2 != r6 ) goto label$29ff4bb_7_26;
	r5 = 0.;
	goto label$29ff4bb_7_27;
	label$29ff4bb_7_26:
	r5 = r2;
	label$29ff4bb_7_27:
	haxe_io_Output_writeFloat(r4,r5);
	...
	if( r4 == NULL ) hl_null_access();
	r6 = 0.;
	if( r2 != r6 ) goto label$29ff4bb_7_35;
	r5 = 0.;
	goto label$29ff4bb_7_36;
	label$29ff4bb_7_35:
	r5 = r2;
	label$29ff4bb_7_36:
	haxe_io_Output_writeFloat(r4,r5);
	...
	if( r4 == NULL ) hl_null_access();
	r6 = 0.;
	if( r2 != r6 ) goto label$29ff4bb_7_44;
	r5 = 0.;
	goto label$29ff4bb_7_45;
	label$29ff4bb_7_44:
	r5 = r2;
	label$29ff4bb_7_45:
	haxe_io_Output_writeFloat(r4,r5);
	...
	if( r4 == NULL ) hl_null_access();
	r6 = 0.;
	if( r2 != r6 ) goto label$29ff4bb_7_53;
	r5 = 0.;
	goto label$29ff4bb_7_54;
	label$29ff4bb_7_53:
	r5 = r2;
	label$29ff4bb_7_54:
	haxe_io_Output_writeFloat(r4,r5);
...
void hxd_fmt_hmd_Writer_writeSkin(hxd__fmt__hmd__Writer r0,hxd__fmt__hmd__Skin r1) {
	...
	if( r1 == NULL ) hl_null_access();
	r3 = r1->name;
	if( r3 ) goto label$29ff4bb_8_5;
	r3 = (String)s$;
	goto label$29ff4bb_8_6;
	label$29ff4bb_8_5:
	r3 = r1->name;
	label$29ff4bb_8_6:
	...
	if( r4 == NULL ) hl_null_access();
	r8 = r4->length;
	if( r6 >= r8 ) goto label$29ff4bb_8_98;
	r8 = r4->length;
	if( ((unsigned)r6) < ((unsigned)r8) ) goto label$29ff4bb_8_25;
	r10 = NULL;
	...
	r14 = r15->sx;
	r16 = 1.;
	if( r14 != r16 ) goto label$29ff4bb_8_68;
	r15 = r10->position;
	if( r15 == NULL ) hl_null_access();
	r14 = r15->sy;
	r16 = 1.;
	...
	if( r14 != r16 ) goto label$29ff4bb_8_68;
	r15 = r10->transpos;
	if( !r15 ) goto label$29ff4bb_8_66;
	r15 = r10->transpos;
	if( r15 == NULL ) hl_null_access();
	r14 = r15->sx;
	r16 = 1.;
	...
	r8 = 1;
	r7 = r7 + r8;
	if( !r13 ) goto label$29ff4bb_8_77;
	r8 = 32768;
	goto label$29ff4bb_8_78;
	label$29ff4bb_8_77:
	r8 = 0;
	label$29ff4bb_8_78:
	r7 = r7 | r8;
	...
	r7 = r10->bind;
	r8 = 0;
	if( r7 < r8 ) goto label$29ff4bb_8_97;
	r15 = r10->transpos;
	r19 = r13;
	r18 = &r19;
	hxd_fmt_hmd_Writer_writePosition(r0,r15,r18);
	label$29ff4bb_8_97:
	goto label$29ff4bb_8_17;
	label$29ff4bb_8_98:
	r5 = r0->out;
	if( r5 == NULL ) hl_null_access();
	if( r1 == NULL ) hl_null_access();
	r4 = r1->split;
	if( r4 ) goto label$29ff4bb_8_105;
	r6 = 0;
	goto label$29ff4bb_8_108;
	label$29ff4bb_8_105:
	r4 = r1->split;
	if( r4 == NULL ) hl_null_access();
	r6 = r4->length;
	...
	r4 = r1->split;
	if( !r4 ) goto label$29ff4bb_8_156;
	r6 = 0;
	r4 = r1->split;
	label$29ff4bb_8_113:
	if( r4 == NULL ) hl_null_access();
	r8 = r4->length;
	if( r6 >= r8 ) goto label$29ff4bb_8_156;
	r8 = r4->length;
	if( ((unsigned)r6) < ((unsigned)r8) ) goto label$29ff4bb_8_121;
	r20 = NULL;
	goto label$29ff4bb_8_124;
	label$29ff4bb_8_121:
	r12 = r4->array;
	r11 = ((vdynamic**)(r12 + 1))[r6];
	...
	if( r21 == NULL ) hl_null_access();
	r22 = r21->length;
	if( r7 >= r22 ) goto label$29ff4bb_8_155;
	r22 = r21->length;
	if( ((unsigned)r7) < ((unsigned)r22) ) goto label$29ff4bb_8_146;
	r8 = 0;
	goto label$29ff4bb_8_150;
	label$29ff4bb_8_146:
	r23 = r21->bytes;
	r22 = 2;
	r22 = r7 << r22;
...
void hxd_fmt_hmd_Writer_write(hxd__fmt__hmd__Writer r0,hxd__fmt__hmd__Data r1) {
	...
	r5 = r0->version;
	r6 = 3;
	if( r6 >= r5 ) goto label$29ff4bb_9_18;
	...
	if( r12 == NULL ) hl_null_access();
	r14 = r12->length;
	if( r5 >= r14 ) goto label$29ff4bb_9_117;
	r14 = r12->length;
	if( ((unsigned)r5) < ((unsigned)r14) ) goto label$29ff4bb_9_36;
	r16 = NULL;
	goto label$29ff4bb_9_39;
	label$29ff4bb_9_36:
	r17 = r12->array;
	...
	if( r15 == NULL ) hl_null_access();
	r18 = r15->length;
	if( r6 >= r18 ) goto label$29ff4bb_9_79;
	r18 = r15->length;
	if( ((unsigned)r6) < ((unsigned)r18) ) goto label$29ff4bb_9_67;
	r20 = NULL;
	goto label$29ff4bb_9_70;
	label$29ff4bb_9_67:
	r17 = r15->array;
	...
	if( r21 == NULL ) hl_null_access();
	r18 = r21->length;
	if( r6 >= r18 ) goto label$29ff4bb_9_109;
	r18 = r21->length;
	if( ((unsigned)r6) < ((unsigned)r18) ) goto label$29ff4bb_9_100;
	r14 = 0;
	goto label$29ff4bb_9_104;
	label$29ff4bb_9_100:
	r10 = r21->bytes;
	r18 = 2;
	r18 = r6 << r18;
	...
	if( r12 == NULL ) hl_null_access();
	r14 = r12->length;
	if( r5 >= r14 ) goto label$29ff4bb_9_173;
	r14 = r12->length;
	if( ((unsigned)r5) < ((unsigned)r14) ) goto label$29ff4bb_9_134;
	r23 = NULL;
	goto label$29ff4bb_9_137;
	label$29ff4bb_9_134:
	r17 = r12->array;
	r7 = ((vdynamic**)(r17 + 1))[r5];
	...
	r15 = r23->props;
	if( !r15 ) goto label$29ff4bb_9_172;
	r15 = r23->props;
	if( r15 == NULL ) hl_null_access();
	r26 = (venum*)g$69da9ba;
	r27 = NULL;
	...
	r14 = 0;
	if( r6 < r14 ) goto label$29ff4bb_9_172;
	r8 = r23->specularTexture;
	hxd_fmt_hmd_Writer_writeName(r0,r8);
	r8 = r23->normalMap;
	hxd_fmt_hmd_Writer_writeName(r0,r8);
	label$29ff4bb_9_172:
	goto label$29ff4bb_9_126;
	label$29ff4bb_9_173:
	r13 = r0->out;
	if( r13 == NULL ) hl_null_access();
	if( r1 == NULL ) hl_null_access();
	...
	if( r12 == NULL ) hl_null_access();
	r14 = r12->length;
	if( r5 >= r14 ) goto label$29ff4bb_9_254;
	r14 = r12->length;
	if( ((unsigned)r5) < ((unsigned)r14) ) goto label$29ff4bb_9_190;
	r28 = NULL;
	goto label$29ff4bb_9_193;
	label$29ff4bb_9_190:
	r17 = r12->array;
	r7 = ((vdynamic**)(r17 + 1))[r5];
	...
	r6 = r28->geometry;
	r14 = 0;
	if( r6 >= r14 ) goto label$29ff4bb_9_220;
	goto label$29ff4bb_9_182;
	label$29ff4bb_9_220:
	r13 = r0->out;
	if( r13 == NULL ) hl_null_access();
	r21 = r28->materials;
	...
	if( r21 == NULL ) hl_null_access();
	r18 = r21->length;
	if( r6 >= r18 ) goto label$29ff4bb_9_245;
	r18 = r21->length;
	if( ((unsigned)r6) < ((unsigned)r18) ) goto label$29ff4bb_9_236;
	r14 = 0;
	goto label$29ff4bb_9_240;
	label$29ff4bb_9_236:
	r10 = r21->bytes;
	r18 = 2;
	r18 = r6 << r18;
	...
	if( r13 == NULL ) hl_null_access();
	haxe_io_Output_writeInt32(r13,r14);
	goto label$29ff4bb_9_228;
	label$29ff4bb_9_245:
	if( r28 == NULL ) hl_null_access();
	r31 = r28->skin;
	if( r31 ) goto label$29ff4bb_9_251;
	r8 = NULL;
	hxd_fmt_hmd_Writer_writeName(r0,r8);
	goto label$29ff4bb_9_253;
	label$29ff4bb_9_251:
	r31 = r28->skin;
	...
	if( r12 == NULL ) hl_null_access();
	r14 = r12->length;
	if( r5 >= r14 ) goto label$29ff4bb_9_407;
	r14 = r12->length;
	if( ((unsigned)r5) < ((unsigned)r14) ) goto label$29ff4bb_9_271;
	r32 = NULL;
	goto label$29ff4bb_9_274;
	label$29ff4bb_9_271:
	r17 = r12->array;
	r7 = ((vdynamic**)(r17 + 1))[r5];
	...
	if( r13 == NULL ) hl_null_access();
	r34 = 0.;
	if( r25 != r34 ) goto label$29ff4bb_9_291;
	r33 = 0.;
	goto label$29ff4bb_9_292;
	label$29ff4bb_9_291:
	r33 = r25;
	label$29ff4bb_9_292:
	...
	if( r13 == NULL ) hl_null_access();
	r34 = 0.;
	if( r25 != r34 ) goto label$29ff4bb_9_300;
	r33 = 0.;
	goto label$29ff4bb_9_301;
	label$29ff4bb_9_300:
	r33 = r25;
	label$29ff4bb_9_301:
	haxe_io_Output_writeFloat(r13,r33);
	...
	if( r13 == NULL ) hl_null_access();
	r35 = r32->loop;
	if( !r35 ) goto label$29ff4bb_9_308;
	r6 = 1;
	goto label$29ff4bb_9_309;
	label$29ff4bb_9_308:
	r6 = 0;
	label$29ff4bb_9_309:
	r15 = r32->events;
	if( !r15 ) goto label$29ff4bb_9_313;
	r14 = 2;
	goto label$29ff4bb_9_314;
	label$29ff4bb_9_313:
	r14 = 0;
	label$29ff4bb_9_314:
	r6 = r6 | r14;
	...
	if( r15 == NULL ) hl_null_access();
	r18 = r15->length;
	if( r6 >= r18 ) goto label$29ff4bb_9_375;
	r18 = r15->length;
	if( ((unsigned)r6) < ((unsigned)r18) ) goto label$29ff4bb_9_336;
	r36 = NULL;
	goto label$29ff4bb_9_339;
	label$29ff4bb_9_336:
	r17 = r15->array;
	r7 = ((vdynamic**)(r17 + 1))[r6];
	...
	r14 = r14 & r18;
	r18 = 0;
	if( r14 == r18 ) goto label$29ff4bb_9_374;
	r13 = r0->out;
	if( r13 == NULL ) hl_null_access();
	r19 = r36->props;
	...
	if( r19 == NULL ) hl_null_access();
	r37 = r19->length;
	if( r14 >= r37 ) goto label$29ff4bb_9_374;
	r37 = r19->length;
	if( ((unsigned)r14) < ((unsigned)r37) ) goto label$29ff4bb_9_368;
	r8 = NULL;
	goto label$29ff4bb_9_371;
	label$29ff4bb_9_368:
	r17 = r19->array;
	...
	++r14;
	hxd_fmt_hmd_Writer_writeName(r0,r8);
	goto label$29ff4bb_9_360;
	label$29ff4bb_9_374:
	goto label$29ff4bb_9_328;
	label$29ff4bb_9_375:
	if( r32 == NULL ) hl_null_access();
	r15 = r32->events;
	if( !r15 ) goto label$29ff4bb_9_406;
	r13 = r0->out;
	if( r13 == NULL ) hl_null_access();
	r15 = r32->events;
	if( r15 == NULL ) hl_null_access();
	...
	if( r15 == NULL ) hl_null_access();
	r18 = r15->length;
	if( r6 >= r18 ) goto label$29ff4bb_9_406;
	r18 = r15->length;
	if( ((unsigned)r6) < ((unsigned)r18) ) goto label$29ff4bb_9_394;
	r38 = NULL;
	goto label$29ff4bb_9_397;
	label$29ff4bb_9_394:
	r17 = r15->array;
	r7 = ((vdynamic**)(r17 + 1))[r6];
	...
	r8 = r38->data;
	hxd_fmt_hmd_Writer_writeName(r0,r8);
	goto label$29ff4bb_9_386;
	label$29ff4bb_9_406:
	goto label$29ff4bb_9_263;
	label$29ff4bb_9_407:
	if( r4 == NULL ) hl_null_access();

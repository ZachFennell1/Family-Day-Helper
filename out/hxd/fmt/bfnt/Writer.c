...
void hxd_fmt_bfnt_Writer_writeString(hxd__fmt__bfnt__Writer r0,String r1) {
	...
	r6 = r4->length;
	r7 = 65535;
	if( r7 >= r6 ) goto label$ee0389f_3_12;
	r3 = (String)s$Invalid_string_Size_over_0xFFFF;
	...
	r6 = r4->length;
	haxe_io_Output_writeUInt16(r9,r6);
	r9 = r0->out;
	if( r9 == NULL ) hl_null_access();
	haxe_io_Output_write(r9,r4);
	return;
}

...
bool hxd_res_Sound_supportedFormat(venum* r0) {
	bool r2;
	int r1;
...
hxd__snd__Data hxd_res_Sound_getData(hxd__res__Sound r0) {
	...
	int r6;
	r2 = r0->data;
	if( !r2 ) goto label$78c38bf_2_4;
	r2 = r0->data;
	return r2;
	label$78c38bf_2_4:
	r5 = r0->entry;
	if( r5 == NULL ) hl_null_access();
	r4 = ((haxe__io__Bytes (*)(hxd__fs__FileEntry))r5->$type->vobj_proto[1])(r5);
	...
	label$78c38bf_2_23:
	r2 = r0->data;
	if( r2 ) goto label$78c38bf_2_32;
	r10 = (String)s$Unsupported_sound_format_;
	r5 = r0->entry;
	if( r5 == NULL ) hl_null_access();
	r11 = ((String (*)(hxd__fs__FileEntry))r5->$type->vobj_proto[15])(r5);
	...
	if( !r12 ) goto label$78c38bf_2_37;
...
void hxd_res_Sound_dispose(hxd__res__Sound r0) {
	hxd__snd__Data r2;
	hxd_res_Sound_stop(r0);
	r2 = NULL;
	r0->data = r2;
	return;
}

void hxd_res_Sound_stop(hxd__res__Sound r0) {
	hxd__snd__Channel r2;
	r2 = r0->channel;
	if( !r2 ) goto label$78c38bf_4_7;
	r2 = r0->channel;
...
hxd__snd__Channel hxd_res_Sound_play(hxd__res__Sound r0,vdynamic* r1,vdynamic* r2,hxd__snd__ChannelGroup r3,hxd__snd__SoundGroup r4) {
	...
	double r6;
	if( r1 ) goto label$78c38bf_5_3;
	r5 = false;
	r1 = hl_alloc_dynbool(r5);
	label$78c38bf_5_3:
	if( r2 ) goto label$78c38bf_5_6;
	r6 = 1.;
...
bool hxd_res_Sound_startWorker() {
	bool r0;
	r0 = false;
	return r0;
}
...
void hxd_res_Sound_watchCallb(hxd__res__Sound r0) {
	...
	if( !r1 ) goto label$78c38bf_7_34;
	if( r1 == NULL ) hl_null_access();
	r4 = r1->channels;
	if( r3 == NULL ) hl_null_access();
	r5 = r3->channels;
	if( r4 != r5 ) goto label$78c38bf_7_19;
	r4 = r1->samples;
	r5 = r3->samples;
	if( r4 != r5 ) goto label$78c38bf_7_19;
	r6 = r1->sampleFormat;
	r7 = r3->sampleFormat;
	if( r6 != r7 ) goto label$78c38bf_7_19;
	r4 = r1->samplingRate;
	r5 = r3->samplingRate;
	if( r4 == r5 ) goto label$78c38bf_7_34;
	label$78c38bf_7_19:
	r8 = hxd_snd_Manager_get();
	if( r8 == NULL ) hl_null_access();
	...
	if( !r10 ) goto label$78c38bf_7_34;

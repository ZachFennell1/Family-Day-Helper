...
void hxd_snd_openal_Driver_setBufferData(hxd__snd__openal__Driver r0,hxd__snd__openal__BufferHandle r1,haxe__io__Bytes r2,int r3,venum* r4,int r5,int r6) {
	...
	switch(r8) {
		default:
			goto label$6103fff_13_24;
		case 0:
			r10 = 1;
			if( r5 != r10 ) goto label$6103fff_13_8;
			r9 = 4352;
			goto label$6103fff_13_9;
			label$6103fff_13_8:
			r9 = 4354;
			label$6103fff_13_9:
			r8 = r9;
		...
		case 1:
			r10 = 1;
			if( r5 != r10 ) goto label$6103fff_13_15;
			r9 = 4353;
			goto label$6103fff_13_16;
			label$6103fff_13_15:
			r9 = 4355;
			label$6103fff_13_16:
			r8 = r9;
		...
		case 2:
			r10 = 1;
			if( r5 != r10 ) goto label$6103fff_13_22;
			r9 = 4353;
			goto label$6103fff_13_23;
			label$6103fff_13_22:
			r9 = 4355;
			label$6103fff_13_23:
			r8 = r9;
...
int hxd_snd_openal_Driver_getPlayedSampleCount(hxd__snd__openal__Driver r0,hxd__snd__openal__SourceHandle r1) {
	...
	r2 = r2 + r3;
	r4 = 0;
	if( r2 >= r4 ) goto label$6103fff_14_10;
	r3 = 0;
	r2 = r3;
	label$6103fff_14_10:
	return r2;
...
void hxd_snd_openal_Driver_queueBuffer(hxd__snd__openal__Driver r0,hxd__snd__openal__SourceHandle r1,hxd__snd__openal__BufferHandle r2,int r3,bool r4) {
	...
	r10 = 0;
	if( r6 == r10 ) goto label$6103fff_16_30;
	...
	r10 = 4116;
	if( r8 != r10 ) goto label$6103fff_16_49;
	r10 = 0;
	if( r10 >= r3 ) goto label$6103fff_16_41;
	r8 = r1->inst;
	r10 = 4133;
	openal_al_sourcei(r8,r10,r3);
	goto label$6103fff_16_45;
	label$6103fff_16_41:
	r8 = r1->inst;
	r10 = 4133;
	r16 = 0;
	...
	label$6103fff_16_45:
	r17 = r1->playing;
	if( !r17 ) goto label$6103fff_16_49;
	r8 = r1->inst;
...
void hxd_snd_openal_Driver_unqueueBuffer(hxd__snd__openal__Driver r0,hxd__snd__openal__SourceHandle r1,hxd__snd__openal__BufferHandle r2) {
	...
	r6 = (int)r11;
	r12 = r2->isEnd;
	if( !r12 ) goto label$6103fff_17_33;
	r9 = 0;
	r1->sampleOffset = r9;
	goto label$6103fff_17_36;
	label$6103fff_17_33:
	r9 = r1->sampleOffset;
	r9 = r9 + r6;
	r1->sampleOffset = r9;
...
hxd__snd__EffectDriver hxd_snd_openal_Driver_getEffectDriver(hxd__snd__openal__Driver r0,String r1) {
	...
	vbyte *r5, *r6;
	int r3, r4;
	if( !r1 ) goto label$6103fff_20_9;
	r3 = r1->length;
	r4 = 7;
	if( r3 != r4 ) goto label$6103fff_20_9;
	r5 = r1->bytes;
	r6 = (vbyte*)USTR("lowpass");
	r3 = hl_string_compare(r5,r6,r3);
	r4 = 0;
	if( r3 == r4 ) goto label$6103fff_20_39;
	label$6103fff_20_9:
	if( !r1 ) goto label$6103fff_20_18;
	r3 = r1->length;
	r4 = 5;
	if( r3 != r4 ) goto label$6103fff_20_18;
	r5 = r1->bytes;
	r6 = (vbyte*)USTR("pitch");
	r3 = hl_string_compare(r5,r6,r3);
	r4 = 0;
	if( r3 == r4 ) goto label$6103fff_20_42;
	label$6103fff_20_18:
	if( !r1 ) goto label$6103fff_20_27;
	r3 = r1->length;
	r4 = 6;
	if( r3 != r4 ) goto label$6103fff_20_27;
	r5 = r1->bytes;
	r6 = (vbyte*)USTR("reverb");
	r3 = hl_string_compare(r5,r6,r3);
	r4 = 0;
	if( r3 == r4 ) goto label$6103fff_20_45;
	label$6103fff_20_27:
	if( !r1 ) goto label$6103fff_20_36;
	r3 = r1->length;
	r4 = 14;
	if( r3 != r4 ) goto label$6103fff_20_36;
	r5 = r1->bytes;
	r6 = (vbyte*)USTR("spatialization");
	r3 = hl_string_compare(r5,r6,r3);
	r4 = 0;
	if( r3 == r4 ) goto label$6103fff_20_48;
	label$6103fff_20_36:
	...
	r12 = r0->f$4;
	if( r12 ) goto label$6103fff_20_53;
	r12 = hl_to_virtual(&t$vrt_51912fa,(vdynamic*)r0);
	r0->f$4 = r12;
	label$6103fff_20_53:

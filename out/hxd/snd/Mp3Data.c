...
void hxd_snd_Mp3Data_seekFrame(hxd__snd__Mp3Data r0,int r1) {
	haxe__io__Bytes r5;
	...
	r8 = r6->length;
	if( ((unsigned)r1) < ((unsigned)r8) ) goto label$e22434f_3_14;
	r7 = 0;
	goto label$e22434f_3_18;
	label$e22434f_3_14:
	r9 = r6->bytes;
	r8 = 2;
	r8 = r1 << r8;
	...
	r8 = r5->length;
	r10 = 0;
	r2 = fmt_mp3_decode_frame(r3,r4,r2,r7,r9,r8,r10);
	return;
}

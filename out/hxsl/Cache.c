...
extern String s$Unsupported_batch_var_type_;
...
extern String s$Batch_Buffer;
extern hl_type t$hxsl_SizeDecl;
extern String s$Batch_Offset;
...
extern hl_type t$ctx_fbe0d47;
extern hl_type t$fun_46485d0;
extern hl_type t$ctx_a784818;
...
vvirtual* hxsl_Cache_getLinkShader__$3(venum* r0,venum* r1,int r2) {
	...
	switch(r3) {
		...
		case 1:
			...
			label$2c4895f_4_51:
			if( !r13 ) goto label$2c4895f_4_54;
			r3 = r13 ? r13->v.i : 0;
			r2 = r3;
			label$2c4895f_4_54:
			r23 = ((Enumt$ctx_7028576*)r0)->p4;
...
hxsl__BatchShader hxsl_Cache_makeBatchShader(hxsl__Cache r0,hxsl__RuntimeShader r1) {
	hxsl__SharedShader r5, r7;
	hxsl__BatchShader r9;
	haxe__ds__IntMap r3;
	hxsl__$BatchShader r8;
	vdynamic *r2;
	int r4;
	r3 = r0->batchShaders;
	if( r3 == NULL ) hl_null_access();
	...
	r5 = (hxsl__SharedShader)r2;
	if( r5 ) goto label$2c4895f_17_13;
	r7 = hxsl_Cache_createBatchShader(r0,r1);
	r5 = r7;
	r3 = r0->batchShaders;
	if( r3 == NULL ) hl_null_access();
	r4 = r1->id;
	...
	label$2c4895f_17_13:
	r8 = (hxsl__$BatchShader)g$_hxsl_BatchShader;
	r2 = Type_createEmptyInstance(((hl__Class)r8));
	r9 = (hxsl__BatchShader)hl_dyn_castp(&r2,&t$_dyn,&t$hxsl_BatchShader);
	if( r9 == NULL ) hl_null_access();
	r9->shader = r5;
	return r9;
}

vvirtual* hxsl_Cache_createBatchShader__$1(String r0,venum* r1,venum* r2) {
	vvirtual *r3, *r5;
	int r4;
	r3 = hl_alloc_virtual(&t$vrt_3e1dcdc);
	r4 = hxsl_Tools_allocVarId();
	if( hl_vfields(r3)[0] ) *(int*)(hl_vfields(r3)[0]) = (int)r4; else hl_dyn_seti(r3->value,23515/*id*/,&t$_i32,r4);
	if( hl_vfields(r3)[3] ) *(venum**)(hl_vfields(r3)[3]) = (venum*)r1; else hl_dyn_setp(r3->value,218690500/*type*/,&t$hxsl_Type,r1);
	if( hl_vfields(r3)[2] ) *(String*)(hl_vfields(r3)[2]) = (String)r0; else hl_dyn_setp(r3->value,150958933/*name*/,&t$String,r0);
	if( hl_vfields(r3)[1] ) *(venum**)(hl_vfields(r3)[1]) = (venum*)r2; else hl_dyn_setp(r3->value,118088286/*kind*/,&t$hxsl_VarKind,r2);
	r5 = hl_to_virtual(&t$vrt_09f4a29,(vdynamic*)r3);
	return r5;
}

vvirtual* hxsl_Cache_createBatchShader__$2(venum* r0,int r1) {
	vvirtual *r2, *r4, *r5, *r7, *r8, *r11;
	venum *r3, *r6, *r9, *r10;
	r2 = hl_alloc_virtual(&t$vrt_6e3ace9);
	r4 = ((Enumt$ctx_fbe0d47*)r0)->p1;
	r5 = hl_alloc_virtual(&t$vrt_6e3ace9);
	r6 = (venum*)g$haxe_macro_Binop_OpAdd;
	r7 = ((Enumt$ctx_fbe0d47*)r0)->p2;
	r8 = hl_alloc_virtual(&t$vrt_6e3ace9);
	r9 = hl_alloc_enum(&t$hxsl_Const,2);
	((hxsl_Const_CInt*)r9)->p0 = r1;
	r3 = hl_alloc_enum(&t$hxsl_TExprDef,0);
	((hxsl_TExprDef_TConst*)r3)->p0 = r9;
	if( hl_vfields(r8)[0] ) *(venum**)(hl_vfields(r8)[0]) = (venum*)r3; else hl_dyn_setp(r8->value,101/*e*/,&t$hxsl_TExprDef,r3);
	r10 = (venum*)g$hxsl_Type_TInt;
	if( hl_vfields(r8)[2] ) *(venum**)(hl_vfields(r8)[2]) = (venum*)r10; else hl_dyn_setp(r8->value,116/*t*/,&t$hxsl_Type,r10);
	r11 = ((Enumt$ctx_fbe0d47*)r0)->p0;
	if( hl_vfields(r8)[1] ) *(vvirtual**)(hl_vfields(r8)[1]) = (vvirtual*)r11; else hl_dyn_setp(r8->value,112/*p*/,&t$vrt_379f5a4,r11);
	r3 = hl_alloc_enum(&t$hxsl_TExprDef,5);
	((hxsl_TExprDef_TBinop*)r3)->p0 = r6;
	((hxsl_TExprDef_TBinop*)r3)->p1 = r7;
	((hxsl_TExprDef_TBinop*)r3)->p2 = r8;
	if( hl_vfields(r5)[0] ) *(venum**)(hl_vfields(r5)[0]) = (venum*)r3; else hl_dyn_setp(r5->value,101/*e*/,&t$hxsl_TExprDef,r3);
	r10 = (venum*)g$hxsl_Type_TInt;
	if( hl_vfields(r5)[2] ) *(venum**)(hl_vfields(r5)[2]) = (venum*)r10; else hl_dyn_setp(r5->value,116/*t*/,&t$hxsl_Type,r10);
	r11 = ((Enumt$ctx_fbe0d47*)r0)->p0;
	if( hl_vfields(r5)[1] ) *(vvirtual**)(hl_vfields(r5)[1]) = (vvirtual*)r11; else hl_dyn_setp(r5->value,112/*p*/,&t$vrt_379f5a4,r11);
	r3 = hl_alloc_enum(&t$hxsl_TExprDef,16);
	((hxsl_TExprDef_TArray*)r3)->p0 = r4;
	((hxsl_TExprDef_TArray*)r3)->p1 = r5;
	if( hl_vfields(r2)[0] ) *(venum**)(hl_vfields(r2)[0]) = (venum*)r3; else hl_dyn_setp(r2->value,101/*e*/,&t$hxsl_TExprDef,r3);
	r10 = ((Enumt$ctx_fbe0d47*)r0)->p3;
	if( hl_vfields(r2)[2] ) *(venum**)(hl_vfields(r2)[2]) = (venum*)r10; else hl_dyn_setp(r2->value,116/*t*/,&t$hxsl_Type,r10);
	r11 = ((Enumt$ctx_fbe0d47*)r0)->p0;
	if( hl_vfields(r2)[1] ) *(vvirtual**)(hl_vfields(r2)[1]) = (vvirtual*)r11; else hl_dyn_setp(r2->value,112/*p*/,&t$vrt_379f5a4,r11);
	return r2;
}

vvirtual* hxsl_Cache_createBatchShader__$3(venum* r0,hxsl__AllocParam r1,int r2) {
	String r5, r11;
	haxe__ds__ObjectMap r17;
	hl__types__ArrayObj r10, r13;
	vvirtual *r3, *r14, *r18, *r19, *r23, *r25, *r26, *r27, *r29, *r35;
	hl_type *r21;
	venum *r6, *r7, *r22, *r28, *r32, *r33, *r34, *r36;
	hxsl__SharedShader r24;
	hxsl__AllocGlobal r9;
	vclosure *r4, *r30;
	vdynamic *r12;
	varray *r20;
	int r15, r16, r31;
	r4 = ((Enumt$ctx_a784818*)r0)->p1;
	if( r4 == NULL ) hl_null_access();
	if( r1 == NULL ) hl_null_access();
	r5 = r1->name;
	r6 = r1->type;
	r7 = (venum*)g$hxsl_VarKind_Local;
	r3 = r4->hasValue ? ((vvirtual* (*)(vdynamic*,String,venum*,venum*))r4->fun)((vdynamic*)r4->value,r5,r6,r7) : ((vvirtual* (*)(String,venum*,venum*))r4->fun)(r5,r6,r7);
	r9 = r1->perObjectGlobal;
	if( !r9 ) goto label$2c4895f_20_59;
	r9 = r1->perObjectGlobal;
	if( r9 == NULL ) hl_null_access();
	r5 = r9->path;
	if( r5 == NULL ) hl_null_access();
	r11 = (String)s$5058f1a;
	r10 = String_split(r5,r11);
	if( r10 == NULL ) hl_null_access();
	r12 = hl_types_ArrayObj_pop(r10);
	r5 = (String)r12;
	r14 = r3;
	label$2c4895f_20_19:
	if( r10 == NULL ) hl_null_access();
	r15 = r10->length;
	r16 = 0;
	if( r16 >= r15 ) goto label$2c4895f_20_59;
	r5 = (String)s$5058f1a;
	r5 = hl_types_ArrayObj_join(r10,r5);
	r12 = hl_types_ArrayObj_pop(r10);
	r11 = (String)r12;
	r17 = ((Enumt$ctx_a784818*)r0)->p3;
	if( r17 == NULL ) hl_null_access();
	r12 = haxe_ds_ObjectMap_get(r17,((vdynamic*)r10));
	r18 = hl_to_virtual(&t$vrt_09f4a29,(vdynamic*)r12);
	if( r18 ) goto label$2c4895f_20_46;
	r4 = ((Enumt$ctx_a784818*)r0)->p1;
	if( r4 == NULL ) hl_null_access();
	r21 = &t$vrt_09f4a29;
	r15 = 0;
	r20 = hl_alloc_array(r21,r15);
	r13 = hl_types_ArrayObj_alloc(r20);
	r6 = hl_alloc_enum(&t$hxsl_Type,13);
	((hxsl_Type_TStruct*)r6)->p0 = r13;
	r7 = (venum*)g$hxsl_VarKind_Local;
	r19 = r4->hasValue ? ((vvirtual* (*)(vdynamic*,String,venum*,venum*))r4->fun)((vdynamic*)r4->value,r11,r6,r7) : ((vvirtual* (*)(String,venum*,venum*))r4->fun)(r11,r6,r7);
	r18 = r19;
	r17 = ((Enumt$ctx_a784818*)r0)->p3;
	if( r17 == NULL ) hl_null_access();
	haxe_ds_ObjectMap_set(r17,((vdynamic*)r10),((vdynamic*)r19));
	label$2c4895f_20_46:
	if( r18 == NULL ) hl_null_access();
	r6 = hl_vfields(r18)[5] ? (*(venum**)(hl_vfields(r18)[5])) : (venum*)hl_dyn_getp(r18->value,218690500/*type*/,&t$hxsl_Type);
	if( r6 == NULL ) hl_null_access();
	r15 = HL__ENUM_INDEX__(r6);
	r16 = 13;
	if( r15 != r16 ) goto label$2c4895f_20_55;
	r13 = ((hxsl_Type_TStruct*)r6)->p0;
	if( r13 == NULL ) hl_null_access();
	r15 = hl_types_ArrayObj_push(r13,((vdynamic*)r14));
	label$2c4895f_20_55:
	if( r14 == NULL ) hl_null_access();
	if( hl_vfields(r14)[3] ) *(vvirtual**)(hl_vfields(r14)[3]) = (vvirtual*)r18; else hl_dyn_setp(r14->value,-310508246/*parent*/,&t$vrt_09f4a29,r18);
	r14 = r18;
	goto label$2c4895f_20_19;
	label$2c4895f_20_59:
	r24 = ((Enumt$ctx_a784818*)r0)->p0;
	if( r24 == NULL ) hl_null_access();
	r23 = r24->data;
	if( r23 == NULL ) hl_null_access();
	r10 = hl_vfields(r23)[2] ? (*(hl__types__ArrayObj*)(hl_vfields(r23)[2])) : (hl__types__ArrayObj)hl_dyn_getp(r23->value,239676598/*vars*/,&t$hl_types_ArrayObj);
	if( r10 == NULL ) hl_null_access();
	r15 = hl_types_ArrayObj_push(r10,((vdynamic*)r3));
	if( r1 == NULL ) hl_null_access();
	r15 = r1->pos;
	r16 = 2;
	r15 = r15 >> r16;
	...
	switch(r16) {
		...
		case 4:
		case 6:
			r5 = (String)s$Unsupported_batch_var_type_;
			r22 = r1->type;
			r11 = Std_string(((vdynamic*)r22));
			r5 = String___add__(r5,r11);
			r12 = haxe_Exception_thrown(((vdynamic*)r5));
			hl_throw((vdynamic*)r12);
		case 3:
			r26 = hl_alloc_virtual(&t$vrt_6e3ace9);
			r27 = ((Enumt$ctx_a784818*)r0)->p2;
			if( hl_vfields(r26)[1] ) *(vvirtual**)(hl_vfields(r26)[1]) = (vvirtual*)r27; else hl_dyn_setp(r26->value,112/*p*/,&t$vrt_379f5a4,r27);
			r22 = r1->type;
			if( hl_vfields(r26)[2] ) *(venum**)(hl_vfields(r26)[2]) = (venum*)r22; else hl_dyn_setp(r26->value,116/*t*/,&t$hxsl_Type,r22);
			r30 = ((Enumt$ctx_a784818*)r0)->p5;
			if( r30 == NULL ) hl_null_access();
			r29 = r30->hasValue ? ((vvirtual* (*)(vdynamic*,int))r30->fun)((vdynamic*)r30->value,r15) : ((vvirtual* (*)(int))r30->fun)(r15);
			r10 = ((Enumt$ctx_a784818*)r0)->p4;
			if( r10 == NULL ) hl_null_access();
			r16 = r1->pos;
			r31 = 3;
			r16 = r16 & r31;
			r31 = r10->length;
			if( ((unsigned)r16) < ((unsigned)r31) ) goto label$2c4895f_20_98;
			r10 = NULL;
			goto label$2c4895f_20_101;
			label$2c4895f_20_98:
			r20 = r10->array;
			r12 = ((vdynamic**)(r20 + 1))[r16];
			r10 = (hl__types__ArrayObj)hl_dyn_castp(&r12,&t$_dyn,&t$hl_types_ArrayObj);
			label$2c4895f_20_101:
			r28 = hl_alloc_enum(&t$hxsl_TExprDef,9);
			((hxsl_TExprDef_TSwiz*)r28)->p0 = r29;
			((hxsl_TExprDef_TSwiz*)r28)->p1 = r10;
			if( hl_vfields(r26)[0] ) *(venum**)(hl_vfields(r26)[0]) = (venum*)r28; else hl_dyn_setp(r26->value,101/*e*/,&t$hxsl_TExprDef,r28);
			r25 = r26;
			goto label$2c4895f_20_290;
		case 5:
			r32 = ((hxsl_Type_TVec*)r6)->p1;
			r16 = ((hxsl_Type_TVec*)r6)->p0;
			switch(r16) {
				default:
				case 0:
				case 1:
				...
				case 2:
					...
					r31 = 1;
					if( r16 != r31 ) goto label$2c4895f_20_166;
					r16 = r1->pos;
					r31 = 3;
					r16 = r16 & r31;
					switch(r16) {
						default:
							r21 = &t$hxsl_Component;
							r16 = 2;
							r20 = hl_alloc_array(r21,r16);
							r33 = (venum*)g$hxsl_Component_Z;
							r16 = 0;
							((venum**)(r20 + 1))[r16] = r33;
							r33 = (venum*)g$hxsl_Component_W;
							r16 = 1;
							((venum**)(r20 + 1))[r16] = r33;
							r13 = hl_types_ArrayObj_alloc(r20);
							goto label$2c4895f_20_154;
						case 0:
							r21 = &t$hxsl_Component;
							r16 = 2;
							r20 = hl_alloc_array(r21,r16);
							r33 = (venum*)g$hxsl_Component_X;
							r16 = 0;
							((venum**)(r20 + 1))[r16] = r33;
							r33 = (venum*)g$hxsl_Component_Y;
							r16 = 1;
							((venum**)(r20 + 1))[r16] = r33;
							r13 = hl_types_ArrayObj_alloc(r20);
							goto label$2c4895f_20_154;
					...
					r28 = hl_alloc_enum(&t$hxsl_TExprDef,9);
					((hxsl_TExprDef_TSwiz*)r28)->p0 = r29;
					((hxsl_TExprDef_TSwiz*)r28)->p1 = r13;
					if( hl_vfields(r26)[0] ) *(venum**)(hl_vfields(r26)[0]) = (venum*)r28; else hl_dyn_setp(r26->value,101/*e*/,&t$hxsl_TExprDef,r28);
					r25 = r26;
					goto label$2c4895f_20_172;
					label$2c4895f_20_166:
					r5 = (String)s$Unsupported_batch_var_type_;
					r22 = r1->type;
					r11 = Std_string(((vdynamic*)r22));
					r5 = String___add__(r5,r11);
					r12 = haxe_Exception_thrown(((vdynamic*)r5));
					hl_throw((vdynamic*)r12);
					label$2c4895f_20_172:
					goto label$2c4895f_20_243;
				case 3:
					if( r32 == NULL ) hl_null_access();
					r16 = HL__ENUM_INDEX__(r32);
					r31 = 1;
					if( r16 != r31 ) goto label$2c4895f_20_221;
					r26 = hl_alloc_virtual(&t$vrt_6e3ace9);
					r27 = ((Enumt$ctx_a784818*)r0)->p2;
					if( hl_vfields(r26)[1] ) *(vvirtual**)(hl_vfields(r26)[1]) = (vvirtual*)r27; else hl_dyn_setp(r26->value,112/*p*/,&t$vrt_379f5a4,r27);
					r22 = r1->type;
					...
					r16 = r16 & r31;
					r31 = 0;
					if( r16 != r31 ) goto label$2c4895f_20_204;
					r21 = &t$hxsl_Component;
					r16 = 3;
					r20 = hl_alloc_array(r21,r16);
					r33 = (venum*)g$hxsl_Component_X;
					...
					r16 = 2;
					((venum**)(r20 + 1))[r16] = r33;
					r10 = hl_types_ArrayObj_alloc(r20);
					goto label$2c4895f_20_217;
					label$2c4895f_20_204:
					r21 = &t$hxsl_Component;
					r16 = 3;
					r20 = hl_alloc_array(r21,r16);
					r33 = (venum*)g$hxsl_Component_Y;
					...
					((venum**)(r20 + 1))[r16] = r33;
					r10 = hl_types_ArrayObj_alloc(r20);
					label$2c4895f_20_217:
					r28 = hl_alloc_enum(&t$hxsl_TExprDef,9);
					((hxsl_TExprDef_TSwiz*)r28)->p0 = r29;
					((hxsl_TExprDef_TSwiz*)r28)->p1 = r10;
					if( hl_vfields(r26)[0] ) *(venum**)(hl_vfields(r26)[0]) = (venum*)r28; else hl_dyn_setp(r26->value,101/*e*/,&t$hxsl_TExprDef,r28);
					r25 = r26;
					goto label$2c4895f_20_227;
					label$2c4895f_20_221:
					r5 = (String)s$Unsupported_batch_var_type_;
					r22 = r1->type;
					r11 = Std_string(((vdynamic*)r22));
					r5 = String___add__(r5,r11);
					r12 = haxe_Exception_thrown(((vdynamic*)r5));
					hl_throw((vdynamic*)r12);
					label$2c4895f_20_227:
					goto label$2c4895f_20_243;
				case 4:
					if( r32 == NULL ) hl_null_access();
					r16 = HL__ENUM_INDEX__(r32);
					r31 = 1;
					if( r16 != r31 ) goto label$2c4895f_20_237;
					r30 = ((Enumt$ctx_a784818*)r0)->p5;
					if( r30 == NULL ) hl_null_access();
					r26 = r30->hasValue ? ((vvirtual* (*)(vdynamic*,int))r30->fun)((vdynamic*)r30->value,r15) : ((vvirtual* (*)(int))r30->fun)(r15);
					r25 = r26;
					goto label$2c4895f_20_243;
					label$2c4895f_20_237:
					r5 = (String)s$Unsupported_batch_var_type_;
					r22 = r1->type;
					r11 = Std_string(((vdynamic*)r22));
					r5 = String___add__(r5,r11);
		...
		case 7:
			...
			r34 = (venum*)g$hxsl_TGlobal_Mat4;
			r28 = hl_alloc_enum(&t$hxsl_TExprDef,2);
			((hxsl_TExprDef_TGlobal*)r28)->p0 = r34;
			if( hl_vfields(r29)[0] ) *(venum**)(hl_vfields(r29)[0]) = (venum*)r28; else hl_dyn_setp(r29->value,101/*e*/,&t$hxsl_TExprDef,r28);
			r22 = (venum*)g$hxsl_Type_TVoid;
			if( hl_vfields(r29)[2] ) *(venum**)(hl_vfields(r29)[2]) = (venum*)r22; else hl_dyn_setp(r29->value,116/*t*/,&t$hxsl_Type,r22);
			r27 = ((Enumt$ctx_a784818*)r0)->p2;
			if( hl_vfields(r29)[1] ) *(vvirtual**)(hl_vfields(r29)[1]) = (vvirtual*)r27; else hl_dyn_setp(r29->value,112/*p*/,&t$vrt_379f5a4,r27);
			r21 = &t$vrt_6e3ace9;
			r16 = 4;
			r20 = hl_alloc_array(r21,r16);
			r30 = ((Enumt$ctx_a784818*)r0)->p5;
			if( r30 == NULL ) hl_null_access();
			r35 = r30->hasValue ? ((vvirtual* (*)(vdynamic*,int))r30->fun)((vdynamic*)r30->value,r15) : ((vvirtual* (*)(int))r30->fun)(r15);
			r16 = 0;
			((vvirtual**)(r20 + 1))[r16] = r35;
			r30 = ((Enumt$ctx_a784818*)r0)->p5;
			if( r30 == NULL ) hl_null_access();
			r31 = 1;
			r16 = r15 + r31;
			r35 = r30->hasValue ? ((vvirtual* (*)(vdynamic*,int))r30->fun)((vdynamic*)r30->value,r16) : ((vvirtual* (*)(int))r30->fun)(r16);
			r16 = 1;
			((vvirtual**)(r20 + 1))[r16] = r35;
			r30 = ((Enumt$ctx_a784818*)r0)->p5;
			if( r30 == NULL ) hl_null_access();
			...
			((hxsl_TExprDef_TCall*)r28)->p0 = r29;
			((hxsl_TExprDef_TCall*)r28)->p1 = r10;
			if( hl_vfields(r26)[0] ) *(venum**)(hl_vfields(r26)[0]) = (venum*)r28; else hl_dyn_setp(r26->value,101/*e*/,&t$hxsl_TExprDef,r28);
			r25 = r26;
	}
	label$2c4895f_20_290:
	r26 = hl_alloc_virtual(&t$vrt_6e3ace9);
	r27 = ((Enumt$ctx_a784818*)r0)->p2;
	if( hl_vfields(r26)[1] ) *(vvirtual**)(hl_vfields(r26)[1]) = (vvirtual*)r27; else hl_dyn_setp(r26->value,112/*p*/,&t$vrt_379f5a4,r27);
	r36 = (venum*)g$haxe_macro_Binop_OpAssign;
	r29 = hl_alloc_virtual(&t$vrt_6e3ace9);
	r28 = hl_alloc_enum(&t$hxsl_TExprDef,1);
	((hxsl_TExprDef_TVar*)r28)->p0 = r3;
	if( hl_vfields(r29)[0] ) *(venum**)(hl_vfields(r29)[0]) = (venum*)r28; else hl_dyn_setp(r29->value,101/*e*/,&t$hxsl_TExprDef,r28);
	r27 = ((Enumt$ctx_a784818*)r0)->p2;
	if( hl_vfields(r29)[1] ) *(vvirtual**)(hl_vfields(r29)[1]) = (vvirtual*)r27; else hl_dyn_setp(r29->value,112/*p*/,&t$vrt_379f5a4,r27);
	r22 = r1->type;
	...
	((hxsl_TExprDef_TBinop*)r28)->p0 = r36;
	((hxsl_TExprDef_TBinop*)r28)->p1 = r29;
	((hxsl_TExprDef_TBinop*)r28)->p2 = r25;
	if( hl_vfields(r26)[0] ) *(venum**)(hl_vfields(r26)[0]) = (venum*)r28; else hl_dyn_setp(r26->value,101/*e*/,&t$hxsl_TExprDef,r28);
	r22 = (venum*)g$hxsl_Type_TVoid;
	if( hl_vfields(r26)[2] ) *(venum**)(hl_vfields(r26)[2]) = (venum*)r22; else hl_dyn_setp(r26->value,116/*t*/,&t$hxsl_Type,r22);
	return r26;
...
hxsl__SharedShader hxsl_Cache_createBatchShader(hxsl__Cache r0,hxsl__RuntimeShader r1) {
	String r3, r12;
	haxe__ds__ObjectMap r30;
	hl__types__ArrayObj r23, r37, r40;
	vvirtual *r5, *r10, *r11, *r15, *r18, *r19, *r21, *r22, *r28, *r41, *r44, *r47, *r49, *r51;
	hxsl__RuntimeShaderData r29;
	hl_type *r25;
	venum *r13, *r14, *r16, *r17, *r20, *r26, *r32, *r34, *r36, *r43, *r45, *r46, *r48, *r50, *r52;
	hxsl__SharedShader r2;
	hxsl__AllocParam r38, r39, r42;
	hxsl__ShaderConst r53;
	vclosure *r9, *r33, *r35;
	vdynamic *r8;
	varray *r24, *r31;
	int r6, r7, r27;
	static vclosure cl$0 = { &t$fun_4fdd7b4, hxsl_Cache_createBatchShader__$1, 0 };
	r2 = (hxsl__SharedShader)hl_alloc_obj(&t$hxsl_SharedShader);
	r3 = (String)s$;
	hxsl_SharedShader_new(r2,r3);
	if( r1 == NULL ) hl_null_access();
	r5 = r1->spec;
	if( r5 == NULL ) hl_null_access();
	r3 = hl_vfields(r5)[1] ? (*(String*)(hl_vfields(r5)[1])) : (String)hl_dyn_getp(r5->value,359375608/*signature*/,&t$String);
	if( r3 == NULL ) hl_null_access();
	r6 = 0;
	r7 = 8;
	r8 = hl_alloc_dynamic(&t$_i32);
	r8->v.i = r7;
	r3 = String_substr(r3,r6,r8);
	r9 = &cl$0;
	r10 = NULL;
	if( r9 == NULL ) hl_null_access();
	r12 = (String)s$Batch_Count;
	r13 = (venum*)g$hxsl_Type_TInt;
	r14 = (venum*)g$hxsl_VarKind_Param;
	r11 = r9->hasValue ? ((vvirtual* (*)(vdynamic*,String,venum*,venum*))r9->fun)((vdynamic*)r9->value,r12,r13,r14) : ((vvirtual* (*)(String,venum*,venum*))r9->fun)(r12,r13,r14);
	r12 = (String)s$Batch_Buffer;
	r6 = 4;
	r16 = (venum*)g$hxsl_VecType_VFloat;
	r13 = hl_alloc_enum(&t$hxsl_Type,5);
	((hxsl_Type_TVec*)r13)->p0 = r6;
	((hxsl_Type_TVec*)r13)->p1 = r16;
	r17 = hl_alloc_enum(&t$hxsl_SizeDecl,1);
	((hxsl_SizeDecl_SVar*)r17)->p0 = r11;
	{ venum *tmp;
	tmp = hl_alloc_enum(&t$hxsl_Type,16);
	((hxsl_Type_TBuffer*)tmp)->p0 = r13;
	((hxsl_Type_TBuffer*)tmp)->p1 = r17;
	r13 = tmp; };
	r14 = (venum*)g$hxsl_VarKind_Param;
	r15 = r9->hasValue ? ((vvirtual* (*)(vdynamic*,String,venum*,venum*))r9->fun)((vdynamic*)r9->value,r12,r13,r14) : ((vvirtual* (*)(String,venum*,venum*))r9->fun)(r12,r13,r14);
	r12 = (String)s$Batch_Offset;
	r13 = (venum*)g$hxsl_Type_TInt;
	r14 = (venum*)g$hxsl_VarKind_Local;
	r18 = r9->hasValue ? ((vvirtual* (*)(vdynamic*,String,venum*,venum*))r9->fun)((vdynamic*)r9->value,r12,r13,r14) : ((vvirtual* (*)(String,venum*,venum*))r9->fun)(r12,r13,r14);
	r19 = hl_alloc_virtual(&t$vrt_6e3ace9);
	...
	if( hl_vfields(r19)[1] ) *(vvirtual**)(hl_vfields(r19)[1]) = (vvirtual*)r10; else hl_dyn_setp(r19->value,112/*p*/,&t$vrt_379f5a4,r10);
	if( r15 == NULL ) hl_null_access();
	r13 = hl_vfields(r15)[5] ? (*(venum**)(hl_vfields(r15)[5])) : (venum*)hl_dyn_getp(r15->value,218690500/*type*/,&t$hxsl_Type);
	if( hl_vfields(r19)[2] ) *(venum**)(hl_vfields(r19)[2]) = (venum*)r13; else hl_dyn_setp(r19->value,116/*t*/,&t$hxsl_Type,r13);
	r22 = hl_alloc_virtual(&t$vrt_6e3ace9);
	r20 = hl_alloc_enum(&t$hxsl_TExprDef,1);
	((hxsl_TExprDef_TVar*)r20)->p0 = r18;
	if( hl_vfields(r22)[0] ) *(venum**)(hl_vfields(r22)[0]) = (venum*)r20; else hl_dyn_setp(r22->value,101/*e*/,&t$hxsl_TExprDef,r20);
	if( hl_vfields(r22)[1] ) *(vvirtual**)(hl_vfields(r22)[1]) = (vvirtual*)r10; else hl_dyn_setp(r22->value,112/*p*/,&t$vrt_379f5a4,r10);
	if( r18 == NULL ) hl_null_access();
	r13 = hl_vfields(r18)[5] ? (*(venum**)(hl_vfields(r18)[5])) : (venum*)hl_dyn_getp(r18->value,218690500/*type*/,&t$hxsl_Type);
	if( hl_vfields(r22)[2] ) *(venum**)(hl_vfields(r22)[2]) = (venum*)r13; else hl_dyn_setp(r22->value,116/*t*/,&t$hxsl_Type,r13);
	r6 = 4;
	r16 = (venum*)g$hxsl_VecType_VFloat;
	r13 = hl_alloc_enum(&t$hxsl_Type,5);
	((hxsl_Type_TVec*)r13)->p0 = r6;
	...
	r6 = 16;
	if( r11 == NULL ) hl_null_access();
	r25 = &t$hxsl_VarQualifier;
	r7 = 1;
	r24 = hl_alloc_array(r25,r7);
	r7 = 1;
	r7 = r7 << r6;
	r8 = hl_alloc_dynamic(&t$_i32);
	r8->v.i = r7;
	r26 = hl_alloc_enum(&t$hxsl_VarQualifier,0);
	((hxsl_VarQualifier_Const*)r26)->p0 = r8;
	r7 = 0;
	((venum**)(r24 + 1))[r7] = r26;
	r23 = hl_types_ArrayObj_alloc(r24);
	if( hl_vfields(r11)[4] ) *(hl__types__ArrayObj*)(hl_vfields(r11)[4]) = (hl__types__ArrayObj)r23; else hl_dyn_setp(r11->value,476822680/*qualifiers*/,&t$hl_types_ArrayObj,r23);
	r28 = hl_alloc_virtual(&t$vrt_f479cb2);
	r12 = (String)s$batchShader_;
	r12 = String___add__(r12,r3);
	if( hl_vfields(r28)[1] ) *(String*)(hl_vfields(r28)[1]) = (String)r12; else hl_dyn_setp(r28->value,150958933/*name*/,&t$String,r12);
	r25 = &t$vrt_09f4a29;
	r7 = 3;
	r24 = hl_alloc_array(r25,r7);
	r7 = 0;
	((vvirtual**)(r24 + 1))[r7] = r11;
	r7 = 1;
	((vvirtual**)(r24 + 1))[r7] = r15;
	r7 = 2;
	((vvirtual**)(r24 + 1))[r7] = r18;
	r23 = hl_types_ArrayObj_alloc(r24);
	if( hl_vfields(r28)[2] ) *(hl__types__ArrayObj*)(hl_vfields(r28)[2]) = (hl__types__ArrayObj)r23; else hl_dyn_setp(r28->value,239676598/*vars*/,&t$hl_types_ArrayObj,r23);
	r25 = &t$vrt_ab557b2;
	r7 = 0;
	r24 = hl_alloc_array(r25,r7);
	r23 = hl_types_ArrayObj_alloc(r24);
	if( hl_vfields(r28)[0] ) *(hl__types__ArrayObj*)(hl_vfields(r28)[0]) = (hl__types__ArrayObj)r23; else hl_dyn_setp(r28->value,63237214/*funs*/,&t$hl_types_ArrayObj,r23);
	r2->data = r28;
	r29 = r1->vertex;
	if( r29 == NULL ) hl_null_access();
	r7 = r29->paramsSize;
	...
	r27 = r29->paramsSize;
	r7 = r7 + r27;
	r30 = (haxe__ds__ObjectMap)hl_alloc_obj(&t$haxe_ds_ObjectMap);
	haxe_ds_ObjectMap_new(r30);
	r25 = &t$hl_types_ArrayObj;
	r27 = 4;
	r24 = hl_alloc_array(r25,r27);
	r25 = &t$hxsl_Component;
	r27 = 1;
	r31 = hl_alloc_array(r25,r27);
	r32 = (venum*)g$hxsl_Component_X;
	r27 = 0;
	((venum**)(r31 + 1))[r27] = r32;
	r23 = hl_types_ArrayObj_alloc(r31);
	r27 = 0;
	((hl__types__ArrayObj*)(r24 + 1))[r27] = r23;
	r25 = &t$hxsl_Component;
	r27 = 1;
	r31 = hl_alloc_array(r25,r27);
	r32 = (venum*)g$hxsl_Component_Y;
	r27 = 0;
	((venum**)(r31 + 1))[r27] = r32;
	r23 = hl_types_ArrayObj_alloc(r31);
	r27 = 1;
	...
	((hl__types__ArrayObj*)(r24 + 1))[r27] = r23;
	r23 = hl_types_ArrayObj_alloc(r24);
	r34 = hl_alloc_enum(&t$ctx_fbe0d47,0);
	((Enumt$ctx_fbe0d47*)r34)->p0 = (vvirtual*)r10;
	((Enumt$ctx_fbe0d47*)r34)->p1 = (vvirtual*)r19;
	((Enumt$ctx_fbe0d47*)r34)->p2 = (vvirtual*)r22;
	((Enumt$ctx_fbe0d47*)r34)->p3 = (venum*)r13;
	r33 = hl_alloc_closure_ptr(&t$fun_46485d0,hxsl_Cache_createBatchShader__$2,r34);
	r36 = hl_alloc_enum(&t$ctx_a784818,0);
	((Enumt$ctx_a784818*)r36)->p0 = (hxsl__SharedShader)r2;
	((Enumt$ctx_a784818*)r36)->p1 = (vclosure*)r9;
	((Enumt$ctx_a784818*)r36)->p2 = (vvirtual*)r10;
	((Enumt$ctx_a784818*)r36)->p3 = (haxe__ds__ObjectMap)r30;
	((Enumt$ctx_a784818*)r36)->p4 = (hl__types__ArrayObj)r23;
	((Enumt$ctx_a784818*)r36)->p5 = (vclosure*)r33;
	r35 = hl_alloc_closure_ptr(&t$fun_ebc3ce1,hxsl_Cache_createBatchShader__$3,r36);
	r25 = &t$vrt_6e3ace9;
	r27 = 0;
	r24 = hl_alloc_array(r25,r27);
	r37 = hl_types_ArrayObj_alloc(r24);
	r29 = r1->vertex;
	if( r29 == NULL ) hl_null_access();
	r38 = r29->params;
	label$2c4895f_21_152:
	if( !r38 ) goto label$2c4895f_21_163;
	if( r37 == NULL ) hl_null_access();
	if( r35 == NULL ) hl_null_access();
	r27 = 0;
	r41 = r35->hasValue ? ((vvirtual* (*)(vdynamic*,hxsl__AllocParam,int))r35->fun)((vdynamic*)r35->value,r38,r27) : ((vvirtual* (*)(hxsl__AllocParam,int))r35->fun)(r38,r27);
	r27 = hl_types_ArrayObj_push(r37,((vdynamic*)r41));
	if( r38 == NULL ) hl_null_access();
	r39 = r38->next;
	r38 = r39;
	goto label$2c4895f_21_152;
	label$2c4895f_21_163:
	if( r1 == NULL ) hl_null_access();
	r29 = r1->fragment;
	if( r29 == NULL ) hl_null_access();
	r39 = r29->params;
	label$2c4895f_21_167:
	if( !r39 ) goto label$2c4895f_21_181;
	if( r37 == NULL ) hl_null_access();
	if( r35 == NULL ) hl_null_access();
	if( r1 == NULL ) hl_null_access();
	r29 = r1->vertex;
	if( r29 == NULL ) hl_null_access();
	r27 = r29->paramsSize;
	r41 = r35->hasValue ? ((vvirtual* (*)(vdynamic*,hxsl__AllocParam,int))r35->fun)((vdynamic*)r35->value,r39,r27) : ((vvirtual* (*)(hxsl__AllocParam,int))r35->fun)(r39,r27);
	r27 = hl_types_ArrayObj_push(r37,((vdynamic*)r41));
	if( r39 == NULL ) hl_null_access();
	r42 = r39->next;
	r39 = r42;
	goto label$2c4895f_21_167;
	label$2c4895f_21_181:
	if( r37 == NULL ) hl_null_access();
	r41 = hl_alloc_virtual(&t$vrt_6e3ace9);
	if( hl_vfields(r41)[1] ) *(vvirtual**)(hl_vfields(r41)[1]) = (vvirtual*)r10; else hl_dyn_setp(r41->value,112/*p*/,&t$vrt_379f5a4,r10);
	r43 = (venum*)g$haxe_macro_Binop_OpAssign;
	r44 = hl_alloc_virtual(&t$vrt_6e3ace9);
	if( hl_vfields(r44)[1] ) *(vvirtual**)(hl_vfields(r44)[1]) = (vvirtual*)r10; else hl_dyn_setp(r44->value,112/*p*/,&t$vrt_379f5a4,r10);
	r45 = (venum*)g$hxsl_Type_TInt;
	if( hl_vfields(r44)[2] ) *(venum**)(hl_vfields(r44)[2]) = (venum*)r45; else hl_dyn_setp(r44->value,116/*t*/,&t$hxsl_Type,r45);
	r46 = (venum*)g$haxe_macro_Binop_OpMult;
	r47 = hl_alloc_virtual(&t$vrt_6e3ace9);
	r48 = (venum*)g$hxsl_TGlobal_InstanceID;
	r20 = hl_alloc_enum(&t$hxsl_TExprDef,2);
	((hxsl_TExprDef_TGlobal*)r20)->p0 = r48;
	if( hl_vfields(r47)[0] ) *(venum**)(hl_vfields(r47)[0]) = (venum*)r20; else hl_dyn_setp(r47->value,101/*e*/,&t$hxsl_TExprDef,r20);
	r45 = (venum*)g$hxsl_Type_TInt;
	if( hl_vfields(r47)[2] ) *(venum**)(hl_vfields(r47)[2]) = (venum*)r45; else hl_dyn_setp(r47->value,116/*t*/,&t$hxsl_Type,r45);
	if( hl_vfields(r47)[1] ) *(vvirtual**)(hl_vfields(r47)[1]) = (vvirtual*)r10; else hl_dyn_setp(r47->value,112/*p*/,&t$vrt_379f5a4,r10);
	r49 = hl_alloc_virtual(&t$vrt_6e3ace9);
	r50 = hl_alloc_enum(&t$hxsl_Const,2);
	((hxsl_Const_CInt*)r50)->p0 = r7;
	r20 = hl_alloc_enum(&t$hxsl_TExprDef,0);
	((hxsl_TExprDef_TConst*)r20)->p0 = r50;
	if( hl_vfields(r49)[0] ) *(venum**)(hl_vfields(r49)[0]) = (venum*)r20; else hl_dyn_setp(r49->value,101/*e*/,&t$hxsl_TExprDef,r20);
	if( hl_vfields(r49)[1] ) *(vvirtual**)(hl_vfields(r49)[1]) = (vvirtual*)r10; else hl_dyn_setp(r49->value,112/*p*/,&t$vrt_379f5a4,r10);
	r45 = (venum*)g$hxsl_Type_TInt;
	if( hl_vfields(r49)[2] ) *(venum**)(hl_vfields(r49)[2]) = (venum*)r45; else hl_dyn_setp(r49->value,116/*t*/,&t$hxsl_Type,r45);
	r20 = hl_alloc_enum(&t$hxsl_TExprDef,5);
	((hxsl_TExprDef_TBinop*)r20)->p0 = r46;
	((hxsl_TExprDef_TBinop*)r20)->p1 = r47;
	((hxsl_TExprDef_TBinop*)r20)->p2 = r49;
	if( hl_vfields(r44)[0] ) *(venum**)(hl_vfields(r44)[0]) = (venum*)r20; else hl_dyn_setp(r44->value,101/*e*/,&t$hxsl_TExprDef,r20);
	r20 = hl_alloc_enum(&t$hxsl_TExprDef,5);
	((hxsl_TExprDef_TBinop*)r20)->p0 = r43;
	((hxsl_TExprDef_TBinop*)r20)->p1 = r22;
	((hxsl_TExprDef_TBinop*)r20)->p2 = r44;
	if( hl_vfields(r41)[0] ) *(venum**)(hl_vfields(r41)[0]) = (venum*)r20; else hl_dyn_setp(r41->value,101/*e*/,&t$hxsl_TExprDef,r20);
	r45 = (venum*)g$hxsl_Type_TVoid;
	if( hl_vfields(r41)[2] ) *(venum**)(hl_vfields(r41)[2]) = (venum*)r45; else hl_dyn_setp(r41->value,116/*t*/,&t$hxsl_Type,r45);
	hl_types_ArrayObj_unshift(r37,((vdynamic*)r41));
	if( r9 == NULL ) hl_null_access();
	r12 = (String)s$init;
	r25 = &t$vrt_d3744c2;
	r27 = 0;
	r24 = hl_alloc_array(r25,r27);
	r40 = hl_types_ArrayObj_alloc(r24);
	r45 = hl_alloc_enum(&t$hxsl_Type,14);
	((hxsl_Type_TFun*)r45)->p0 = r40;
	r14 = (venum*)g$hxsl_VarKind_Function;
	r21 = r9->hasValue ? ((vvirtual* (*)(vdynamic*,String,venum*,venum*))r9->fun)((vdynamic*)r9->value,r12,r45,r14) : ((vvirtual* (*)(String,venum*,venum*))r9->fun)(r12,r45,r14);
	r51 = hl_alloc_virtual(&t$vrt_ab557b2);
	r52 = (venum*)g$hxsl_FunctionKind_Init;
	if( hl_vfields(r51)[2] ) *(venum**)(hl_vfields(r51)[2]) = (venum*)r52; else hl_dyn_setp(r51->value,118088286/*kind*/,&t$hxsl_FunctionKind,r52);
	if( hl_vfields(r51)[3] ) *(vvirtual**)(hl_vfields(r51)[3]) = (vvirtual*)r21; else hl_dyn_setp(r51->value,5691731/*ref*/,&t$vrt_09f4a29,r21);
	r25 = &t$vrt_09f4a29;
	r27 = 0;
	r24 = hl_alloc_array(r25,r27);
	r40 = hl_types_ArrayObj_alloc(r24);
	if( hl_vfields(r51)[0] ) *(hl__types__ArrayObj*)(hl_vfields(r51)[0]) = (hl__types__ArrayObj)r40; else hl_dyn_setp(r51->value,7638631/*args*/,&t$hl_types_ArrayObj,r40);
	r45 = (venum*)g$hxsl_Type_TVoid;
	if( hl_vfields(r51)[4] ) *(venum**)(hl_vfields(r51)[4]) = (venum*)r45; else hl_dyn_setp(r51->value,5691745/*ret*/,&t$hxsl_Type,r45);
	r41 = hl_alloc_virtual(&t$vrt_6e3ace9);
	r20 = hl_alloc_enum(&t$hxsl_TExprDef,4);
	((hxsl_TExprDef_TBlock*)r20)->p0 = r37;
	if( hl_vfields(r41)[0] ) *(venum**)(hl_vfields(r41)[0]) = (venum*)r20; else hl_dyn_setp(r41->value,101/*e*/,&t$hxsl_TExprDef,r20);
	if( hl_vfields(r41)[1] ) *(vvirtual**)(hl_vfields(r41)[1]) = (vvirtual*)r10; else hl_dyn_setp(r41->value,112/*p*/,&t$vrt_379f5a4,r10);
	r45 = (venum*)g$hxsl_Type_TVoid;
	if( hl_vfields(r41)[2] ) *(venum**)(hl_vfields(r41)[2]) = (venum*)r45; else hl_dyn_setp(r41->value,116/*t*/,&t$hxsl_Type,r45);
	if( hl_vfields(r51)[1] ) *(vvirtual**)(hl_vfields(r51)[1]) = (vvirtual*)r41; else hl_dyn_setp(r51->value,52297279/*expr*/,&t$vrt_6e3ace9,r41);
	if( r2 == NULL ) hl_null_access();
	r28 = r2->data;
	if( r28 == NULL ) hl_null_access();
	r40 = hl_vfields(r28)[0] ? (*(hl__types__ArrayObj*)(hl_vfields(r28)[0])) : (hl__types__ArrayObj)hl_dyn_getp(r28->value,63237214/*funs*/,&t$hl_types_ArrayObj);
	if( r40 == NULL ) hl_null_access();
	r27 = hl_types_ArrayObj_push(r40,((vdynamic*)r51));
	r53 = (hxsl__ShaderConst)hl_alloc_obj(&t$hxsl_ShaderConst);
	r27 = 0;
	hxsl_ShaderConst_new(r53,r11,r27,r6);
	r2->consts = r53;
	r53 = r2->consts;
	if( r53 == NULL ) hl_null_access();
	r27 = 0;

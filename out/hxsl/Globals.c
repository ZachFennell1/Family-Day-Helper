...
int hxsl_Globals_allocChannelID(hxsl__Globals r0,h3d__mat__Texture r1) {
	...
	r4 = r0->maxChannels;
	label$edd9d80_6_2:
	if( r2 >= r4 ) goto label$edd9d80_6_18;
	r5 = r2;
	++r2;
	r6 = r0->channels;
	if( r6 == NULL ) hl_null_access();
	r7 = r6->length;
	if( ((unsigned)r5) < ((unsigned)r7) ) goto label$edd9d80_6_12;
	r8 = NULL;
	goto label$edd9d80_6_15;
	label$edd9d80_6_12:
	r10 = r6->array;
	r9 = ((vdynamic**)(r10 + 1))[r5];
	r8 = (h3d__mat__Texture)r9;
	label$edd9d80_6_15:
	if( r8 != r1 ) goto label$edd9d80_6_17;
	return r5;
	label$edd9d80_6_17:
	goto label$edd9d80_6_2;
	label$edd9d80_6_18:
	r2 = r0->maxChannels;
	r4 = 1;
	...
	r4 = r4 << r5;
	if( r2 != r4 ) goto label$edd9d80_6_27;
	...
	if( r6 == NULL ) hl_null_access();
	r5 = r6->length;
	if( ((unsigned)r4) < ((unsigned)r5) ) goto label$edd9d80_6_36;
...
String hxsl_Globals_getIDName(int r0) {
	...
	varray *r6;
	int r3;
	r2 = (hxsl__$Globals)g$_hxsl_Globals;
	r1 = r2->ALL;
	if( r1 == NULL ) hl_null_access();
	r3 = r1->length;
	if( ((unsigned)r0) < ((unsigned)r3) ) goto label$edd9d80_8_7;
	r4 = NULL;
	goto label$edd9d80_8_10;
	label$edd9d80_8_7:
	r6 = r1->array;
	r5 = ((vdynamic**)(r6 + 1))[r0];
	r4 = (String)r5;

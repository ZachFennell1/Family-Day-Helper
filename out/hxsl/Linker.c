...
void hxsl_Linker_mergeVar(hxsl__Linker r0,String r1,vvirtual* r2,vvirtual* r3,vvirtual* r4,String r5) {
	...
	switch(r7) {
		...
		case 2:
			if( !r5 ) goto label$6629fd1_3_9;
			r11 = hxsl_Tools_hasBorrowQualifier(r3,r5);
			if( r11 ) goto label$6629fd1_3_12;
			label$6629fd1_3_9:
			r10 = (String)s$assert;
	...
	if( r8 == r13 ) goto label$6629fd1_3_40;
	r8 = hl_vfields(r2)[1] ? (*(venum**)(hl_vfields(r2)[1])) : (venum*)hl_dyn_getp(r2->value,118088286/*kind*/,&t$hxsl_VarKind);
	...
	r18 = 13;
	if( r7 != r18 ) goto label$6629fd1_3_121;
	if( r16 == NULL ) hl_null_access();
	r7 = HL__ENUM_INDEX__(r16);
	r18 = 13;
	if( r7 != r18 ) goto label$6629fd1_3_103;
	...
	r21 = r20->length;
	if( r7 >= r21 ) goto label$6629fd1_3_102;
	r21 = r20->length;
	if( ((unsigned)r7) < ((unsigned)r21) ) goto label$6629fd1_3_61;
	r9 = NULL;
	goto label$6629fd1_3_64;
	label$6629fd1_3_61:
	r22 = r20->array;
	...
	r24 = r19->length;
	if( r18 >= r24 ) goto label$6629fd1_3_87;
	r24 = r19->length;
	if( ((unsigned)r18) < ((unsigned)r24) ) goto label$6629fd1_3_75;
	r25 = NULL;
	goto label$6629fd1_3_78;
	label$6629fd1_3_75:
	r22 = r19->array;
	...
	if( r10 != r14 && (!r10 || !r14 || String___compare(r10,(vdynamic*)r14) != 0) ) goto label$6629fd1_3_86;
	r23 = r25;
	goto label$6629fd1_3_87;
	label$6629fd1_3_86:
	goto label$6629fd1_3_67;
	label$6629fd1_3_87:
	if( r23 ) goto label$6629fd1_3_95;
	r14 = NULL;
	r26 = NULL;
	...
	label$6629fd1_3_101:
	goto label$6629fd1_3_53;
	label$6629fd1_3_102:
	goto label$6629fd1_3_120;
	label$6629fd1_3_103:
	...
	if( r11 ) goto label$6629fd1_3_120;
	r10 = (String)s$3590cb8;
	r10 = String___add__(r10,r1);
	...
	r27 = hl_vfields(r3)[5] ? (*(venum**)(hl_vfields(r3)[5])) : (venum*)hl_dyn_getp(r3->value,218690500/*type*/,&t$hxsl_Type);
	r11 = hl_type_enum_eq(((vdynamic*)r17),((vdynamic*)r27));
	if( r11 ) goto label$6629fd1_3_138;
	r10 = (String)s$3590cb8;
	r10 = String___add__(r10,r1);
	r14 = (String)s$_type_does_not_match_;
	r10 = String___add__(r10,r14);
...
hxsl___Linker__AllocatedVar hxsl_Linker_allocVar(hxsl__Linker r0,vvirtual* r1,vvirtual* r2,String r3,String r4,hxsl___Linker__AllocatedVar r5) {
	...
	if( !r8 ) goto label$6629fd1_4_28;
	if( r5 ) goto label$6629fd1_4_28;
	r8 = hl_vfields(r1)[3] ? (*(vvirtual**)(hl_vfields(r1)[3])) : (vvirtual*)hl_dyn_getp(r1->value,-310508246/*parent*/,&t$vrt_09f4a29);
	r11 = NULL;
	r9 = NULL;
	...
	if( !r13 ) goto label$6629fd1_4_60;
	r14 = 0;
	r13 = hl_vfields(r1)[4] ? (*(hl__types__ArrayObj*)(hl_vfields(r1)[4])) : (hl__types__ArrayObj)hl_dyn_getp(r1->value,476822680/*qualifiers*/,&t$hl_types_ArrayObj);
	label$6629fd1_4_41:
	if( r13 == NULL ) hl_null_access();
	r16 = r13->length;
	if( r14 >= r16 ) goto label$6629fd1_4_60;
	r16 = r13->length;
	if( ((unsigned)r14) < ((unsigned)r16) ) goto label$6629fd1_4_49;
	r18 = NULL;
	goto label$6629fd1_4_52;
	label$6629fd1_4_49:
	r20 = r13->array;
	...
	r16 = 4;
	if( r15 != r16 ) goto label$6629fd1_4_59;
	r11 = ((hxsl_VarQualifier_Name*)r18)->p0;
	r10 = r11;
	label$6629fd1_4_59:
	goto label$6629fd1_4_41;
	label$6629fd1_4_60:
	r22 = r0->varMap;
	...
	if( r1 == NULL ) hl_null_access();
	r11 = hl_vfields(r1)[2] ? (*(String*)(hl_vfields(r1)[2])) : (String)hl_dyn_getp(r1->value,150958933/*name*/,&t$String);
	if( !r9 ) goto label$6629fd1_4_214;
	r14 = 0;
	if( r9 == NULL ) hl_null_access();
	r13 = r9->merged;
	label$6629fd1_4_70:
	if( r13 == NULL ) hl_null_access();
	r16 = r13->length;
	if( r14 >= r16 ) goto label$6629fd1_4_85;
	r16 = r13->length;
	if( ((unsigned)r14) < ((unsigned)r16) ) goto label$6629fd1_4_78;
	r8 = NULL;
	goto label$6629fd1_4_81;
	label$6629fd1_4_78:
	r20 = r13->array;
	r19 = ((vdynamic**)(r20 + 1))[r14];
	...
	label$6629fd1_4_81:
	++r14;
	if( r8 != r1 && (!r8 || !r1 || !r8->value || !r1->value || r8->value != r1->value) ) goto label$6629fd1_4_84;
	return r9;
	label$6629fd1_4_84:
	goto label$6629fd1_4_70;
	label$6629fd1_4_85:
	if( r9 == NULL ) hl_null_access();
	r8 = r9->v;
	...
	if( r26 != r27 ) goto label$6629fd1_4_99;
	if( r25 ) goto label$6629fd1_4_99;
	r18 = (venum*)g$hxsl_VarQualifier_Shared;
	r28 = hxsl_Tools_hasQualifier(r1,r18);
	if( r28 ) goto label$6629fd1_4_99;
	if( r6 == NULL ) hl_null_access();
	r28 = r6->isBatchShader;
	if( !r28 ) goto label$6629fd1_4_142;
	label$6629fd1_4_99:
	r26 = hl_vfields(r1)[1] ? (*(venum**)(hl_vfields(r1)[1])) : (venum*)hl_dyn_getp(r1->value,118088286/*kind*/,&t$hxsl_VarKind);
	r27 = (venum*)g$hxsl_VarKind_Function;
	if( r26 == r27 ) goto label$6629fd1_4_142;
	r26 = hl_vfields(r1)[1] ? (*(venum**)(hl_vfields(r1)[1])) : (venum*)hl_dyn_getp(r1->value,118088286/*kind*/,&t$hxsl_VarKind);
	r27 = (venum*)g$hxsl_VarKind_Var;
	if( r26 == r27 ) goto label$6629fd1_4_108;
	r26 = hl_vfields(r1)[1] ? (*(venum**)(hl_vfields(r1)[1])) : (venum*)hl_dyn_getp(r1->value,118088286/*kind*/,&t$hxsl_VarKind);
	r27 = (venum*)g$hxsl_VarKind_Local;
	if( r26 != r27 ) goto label$6629fd1_4_111;
	label$6629fd1_4_108:
	...
	r27 = (venum*)g$hxsl_VarKind_Param;
	if( r26 != r27 ) goto label$6629fd1_4_125;
	if( r28 ) goto label$6629fd1_4_125;
	r18 = (venum*)g$hxsl_VarQualifier_Shared;
	r30 = hxsl_Tools_hasQualifier(r8,r18);
	if( r30 ) goto label$6629fd1_4_125;
	if( r6 == NULL ) hl_null_access();
	r30 = r6->isBatchShader;
	if( !r30 ) goto label$6629fd1_4_139;
	label$6629fd1_4_125:
	r26 = hl_vfields(r8)[1] ? (*(venum**)(hl_vfields(r8)[1])) : (venum*)hl_dyn_getp(r8->value,118088286/*kind*/,&t$hxsl_VarKind);
	r27 = (venum*)g$hxsl_VarKind_Function;
	if( r26 == r27 ) goto label$6629fd1_4_139;
	r26 = hl_vfields(r8)[1] ? (*(venum**)(hl_vfields(r8)[1])) : (venum*)hl_dyn_getp(r8->value,118088286/*kind*/,&t$hxsl_VarKind);
	r27 = (venum*)g$hxsl_VarKind_Var;
	if( r26 == r27 ) goto label$6629fd1_4_134;
	r26 = hl_vfields(r8)[1] ? (*(venum**)(hl_vfields(r8)[1])) : (venum*)hl_dyn_getp(r8->value,118088286/*kind*/,&t$hxsl_VarKind);
	r27 = (venum*)g$hxsl_VarKind_Local;
	if( r26 != r27 ) goto label$6629fd1_4_137;
	label$6629fd1_4_134:
	r18 = (venum*)g$hxsl_VarQualifier_Private;
	r30 = hxsl_Tools_hasQualifier(r8,r18);
	if( r30 ) goto label$6629fd1_4_139;
	label$6629fd1_4_137:
	r30 = false;
	goto label$6629fd1_4_140;
	label$6629fd1_4_139:
	r30 = true;
	label$6629fd1_4_140:
	r29 = r30;
	goto label$6629fd1_4_144;
	label$6629fd1_4_142:
	r28 = true;
	r29 = r28;
	label$6629fd1_4_144:
	if( r29 ) goto label$6629fd1_4_153;
	r26 = hl_vfields(r1)[1] ? (*(venum**)(hl_vfields(r1)[1])) : (venum*)hl_dyn_getp(r1->value,118088286/*kind*/,&t$hxsl_VarKind);
	r27 = (venum*)g$hxsl_VarKind_Param;
	if( r26 != r27 ) goto label$6629fd1_4_201;
	r8 = r9->v;
	if( r8 == NULL ) hl_null_access();
	r26 = hl_vfields(r8)[1] ? (*(venum**)(hl_vfields(r8)[1])) : (venum*)hl_dyn_getp(r8->value,118088286/*kind*/,&t$hxsl_VarKind);
	r27 = (venum*)g$hxsl_VarKind_Param;
	...
	label$6629fd1_4_154:
	r28 = true;
	if( !r28 ) goto label$6629fd1_4_188;
	r22 = r0->varMap;
	if( r22 == NULL ) hl_null_access();
	r15 = r14;
	r31 = &r15;
	...
	if( r23 ) goto label$6629fd1_4_168;
	...
	if( r13 == NULL ) hl_null_access();
	r35 = r13->length;
	if( r15 >= r35 ) goto label$6629fd1_4_186;
	r35 = r13->length;
	if( ((unsigned)r15) < ((unsigned)r35) ) goto label$6629fd1_4_179;
	r8 = NULL;
	goto label$6629fd1_4_182;
	label$6629fd1_4_179:
	r20 = r13->array;
	...
	label$6629fd1_4_182:
	++r15;
	if( r8 != r1 && (!r8 || !r1 || !r8->value || !r1->value || r8->value != r1->value) ) goto label$6629fd1_4_185;
	return r23;
	label$6629fd1_4_185:
	goto label$6629fd1_4_171;
	label$6629fd1_4_186:
	++r14;
	goto label$6629fd1_4_154;
	label$6629fd1_4_188:
	r15 = r14;
	r31 = &r15;
	r32 = hl_itos(r15,r31);
	...
	if( r5 ) goto label$6629fd1_4_232;
	r12 = NULL;
	goto label$6629fd1_4_234;
	label$6629fd1_4_232:
	...
	r16 = 13;
	if( r15 != r16 ) goto label$6629fd1_4_289;
	...
	if( r13 == NULL ) hl_null_access();
	r35 = r13->length;
	if( r15 >= r35 ) goto label$6629fd1_4_286;
	r35 = r13->length;
	if( ((unsigned)r15) < ((unsigned)r35) ) goto label$6629fd1_4_276;
	r12 = NULL;
	goto label$6629fd1_4_279;
	label$6629fd1_4_276:
	r20 = r13->array;
	r19 = ((vdynamic**)(r20 + 1))[r15];
...
vvirtual* hxsl_Linker_mapExprVar(hxsl__Linker r0,vvirtual* r1) {
	...
	switch(r5) {
		...
		case 1:
			...
			r15 = r0->curShader;
			if( !r15 ) goto label$6629fd1_5_48;
			r15 = r0->curShader;
			if( r15 == NULL ) hl_null_access();
			r9 = r15->write;
			if( r9 == NULL ) hl_null_access();
			...
			if( r15 == NULL ) hl_null_access();
			r16 = r15->vertex;
			if( r16 ) goto label$6629fd1_5_48;
			r10 = r11->v;
			...
			if( r17 != r18 ) goto label$6629fd1_5_48;
			r15 = r0->curShader;
			if( r15 == NULL ) hl_null_access();
			r8 = false;
				...
				case 4:
					...
					switch(r5) {
						...
						case 1:
							...
							r5 = hl_vfields(r7)[0] ? (*(int*)(hl_vfields(r7)[0])) : (int)hl_dyn_geti(r7->value,23515/*id*/,&t$_i32);
							r8 = haxe_ds_IntMap_exists(r9,r5);
							if( r8 ) goto label$6629fd1_5_115;
							...
							r11 = hxsl_Linker_allocVar(r0,r7,r12,r13,r14,r11);
							r15 = r0->curShader;
							if( !r15 ) goto label$6629fd1_5_96;
							r15 = r0->curShader;
							if( r15 == NULL ) hl_null_access();
							r9 = r15->write;
							if( r9 == NULL ) hl_null_access();
							...
							r5 = hl_vfields(r7)[0] ? (*(int*)(hl_vfields(r7)[0])) : (int)hl_dyn_geti(r7->value,23515/*id*/,&t$_i32);
							r8 = haxe_ds_IntMap_exists(r9,r5);
							if( r8 ) goto label$6629fd1_5_145;
							...
							r11 = hxsl_Linker_allocVar(r0,r7,r12,r13,r14,r11);
							r15 = r0->curShader;
							if( !r15 ) goto label$6629fd1_5_137;
							r15 = r0->curShader;
							if( r15 == NULL ) hl_null_access();
							r9 = r15->write;
							if( r9 == NULL ) hl_null_access();
						...
						case 9:
							...
							r32 = 1;
							if( r5 != r32 ) goto label$6629fd1_5_188;
							...
							r5 = hl_vfields(r7)[0] ? (*(int*)(hl_vfields(r7)[0])) : (int)hl_dyn_geti(r7->value,23515/*id*/,&t$_i32);
							r8 = haxe_ds_IntMap_exists(r9,r5);
							if( r8 ) goto label$6629fd1_5_188;
							...
							r15 = r0->curShader;
							if( !r15 ) goto label$6629fd1_5_180;
							r15 = r0->curShader;
							if( r15 == NULL ) hl_null_access();
							r9 = r15->write;
							if( r9 == NULL ) hl_null_access();
				...
				case 20:
					...
					switch(r5) {
						...
						case 1:
							...
							r5 = hl_vfields(r7)[0] ? (*(int*)(hl_vfields(r7)[0])) : (int)hl_dyn_geti(r7->value,23515/*id*/,&t$_i32);
							r8 = haxe_ds_IntMap_exists(r9,r5);
							if( r8 ) goto label$6629fd1_5_226;
							r23 = hxsl_Linker_mapExprVar(r0,r3);
							r27 = hxsl_Linker_mapExprVar(r0,r20);
							if( r23 == NULL ) hl_null_access();
							r12 = hl_vfields(r23)[1] ? (*(vvirtual**)(hl_vfields(r23)[1])) : (vvirtual*)hl_dyn_getp(r23->value,112/*p*/,&t$vrt_379f5a4);
							...
							r11 = hxsl_Linker_allocVar(r0,r7,r12,r13,r14,r11);
							r15 = r0->curShader;
							if( !r15 ) goto label$6629fd1_5_218;
							r15 = r0->curShader;
							if( r15 == NULL ) hl_null_access();
							r9 = r15->write;
							if( r9 == NULL ) hl_null_access();
						...
						case 9:
							...
							r5 = HL__ENUM_INDEX__(r25);
							r32 = 1;
							if( r5 != r32 ) goto label$6629fd1_5_269;
							r7 = ((hxsl_TExprDef_TVar*)r25)->p0;
							r9 = r0->locals;
							if( r9 == NULL ) hl_null_access();
							if( r7 == NULL ) hl_null_access();
							r5 = hl_vfields(r7)[0] ? (*(int*)(hl_vfields(r7)[0])) : (int)hl_dyn_geti(r7->value,23515/*id*/,&t$_i32);
							r8 = haxe_ds_IntMap_exists(r9,r5);
							if( r8 ) goto label$6629fd1_5_269;
							r27 = hxsl_Linker_mapExprVar(r0,r3);
							r28 = hxsl_Linker_mapExprVar(r0,r20);
							if( r27 == NULL ) hl_null_access();
							r33 = hl_vfields(r27)[1] ? (*(vvirtual**)(hl_vfields(r27)[1])) : (vvirtual*)hl_dyn_getp(r27->value,112/*p*/,&t$vrt_379f5a4);
							...
							r11 = hxsl_Linker_allocVar(r0,r7,r33,r13,r14,r11);
							r15 = r0->curShader;
							if( !r15 ) goto label$6629fd1_5_261;
							r15 = r0->curShader;
							if( r15 == NULL ) hl_null_access();
							r9 = r15->write;
							if( r9 == NULL ) hl_null_access();
		...
		case 11:
			r15 = r0->curShader;
			if( !r15 ) goto label$6629fd1_5_291;
			r15 = r0->curShader;
			if( r15 == NULL ) hl_null_access();
			r8 = false;
			r16 = hl_alloc_dynbool(r8);
...
int hxsl_Linker_sortByPriorityDesc(hxsl__Linker r0,hxsl___Linker__ShaderInfos r1,hxsl___Linker__ShaderInfos r2) {
	...
	if( r2 == NULL ) hl_null_access();
	r4 = r2->priority;
	if( r3 != r4 ) goto label$6629fd1_7_9;
	r3 = r1->uid;
	r4 = r2->uid;
	r3 = r3 - r4;
	return r3;
...
void hxsl_Linker_buildDependency(hxsl__Linker r0,hxsl___Linker__ShaderInfos r1,hxsl___Linker__AllocatedVar r2,bool r3) {
	...
	if( r7 == NULL ) hl_null_access();
	r9 = r7->length;
	if( r6 >= r9 ) goto label$6629fd1_8_62;
	r9 = r7->length;
	if( ((unsigned)r6) < ((unsigned)r9) ) goto label$6629fd1_8_11;
	r10 = NULL;
	goto label$6629fd1_8_14;
	label$6629fd1_8_11:
	r12 = r7->array;
	...
	label$6629fd1_8_14:
	++r6;
	if( r10 != r1 ) goto label$6629fd1_8_19;
	r13 = true;
	r4 = r13;
	goto label$6629fd1_8_3;
	label$6629fd1_8_19:
	if( r4 ) goto label$6629fd1_8_21;
	goto label$6629fd1_8_3;
	label$6629fd1_8_21:
	if( r10 == NULL ) hl_null_access();
	r14 = r10->write;
	...
	if( r13 ) goto label$6629fd1_8_29;
	goto label$6629fd1_8_3;
	label$6629fd1_8_29:
	if( r1 == NULL ) hl_null_access();
	r15 = r1->vertex;
	r13 = r15 ? r15->v.b : 0;
	if( !r13 ) goto label$6629fd1_8_43;
	r15 = r10->vertex;
	r13 = false;
	r16 = hl_alloc_dynbool(r13);
	if( r15 != r16 && (!r15 || !r16 || (r15->v.b != r16->v.b)) ) goto label$6629fd1_8_38;
	goto label$6629fd1_8_3;
	label$6629fd1_8_38:
	r15 = r10->vertex;
	if( r15 ) goto label$6629fd1_8_43;
	r13 = true;
	...
	r8 = r2->id;
	r13 = haxe_ds_IntMap_exists(r14,r8);
	if( r13 ) goto label$6629fd1_8_61;
	return;
	label$6629fd1_8_61:
	goto label$6629fd1_8_3;
	label$6629fd1_8_62:
	...
	if( r18 != r20 ) goto label$6629fd1_8_80;
...
void hxsl_Linker_initDependencies(hxsl__Linker r0,hxsl___Linker__ShaderInfos r1) {
	...
	goto label$6629fd1_9_11;
	label$6629fd1_9_24:
	if( r1 == NULL ) hl_null_access();
	r11 = r1->vertex;
	if( r11 ) goto label$6629fd1_9_47;
	r3 = r1->deps;
	if( r3 == NULL ) hl_null_access();
	...
	if( r11 != r13 && (!r11 || !r13 || (r11->v.b != r13->v.b)) ) goto label$6629fd1_9_46;
	if( r1 == NULL ) hl_null_access();
	r8 = false;
	r11 = hl_alloc_dynbool(r8);
	r1->vertex = r11;
	goto label$6629fd1_9_47;
	label$6629fd1_9_46:
	goto label$6629fd1_9_31;
	label$6629fd1_9_47:
	if( r1 == NULL ) hl_null_access();
	r11 = r1->vertex;
	r8 = r11 ? r11->v.b : 0;
	if( !r8 ) goto label$6629fd1_9_67;
	r3 = r1->deps;
	if( r3 == NULL ) hl_null_access();
	r5 = haxe_ds_ObjectMap_keys(r3);
	r12 = hl_to_virtual(&t$vrt_ce3c427,(vdynamic*)r5);
	...
	if( r4 == NULL ) hl_null_access();
	r11 = r4->vertex;
	if( r11 ) goto label$6629fd1_9_66;
	r8 = true;
	r11 = hl_alloc_dynbool(r8);
	r4->vertex = r11;
	label$6629fd1_9_66:
	goto label$6629fd1_9_55;
	label$6629fd1_9_67:
	return;
}
...
void hxsl_Linker_collect(hxsl__Linker r0,hxsl___Linker__ShaderInfos r1,hl__types__ArrayObj r2,bool r3) {
	...
	if( r1 == NULL ) hl_null_access();
	r5 = r1->onStack;
	if( !r5 ) goto label$6629fd1_10_10;
	...
	if( r11 != r12 && (!r11 || !r12 || (r11->v.b != r12->v.b)) ) goto label$6629fd1_10_14;
	return;
	label$6629fd1_10_14:
	...
	if( !r5 ) goto label$6629fd1_10_34;
	...
	goto label$6629fd1_10_26;
	label$6629fd1_10_34:
	r20 = r13;
	if( r13 == NULL ) hl_null_access();
	r21 = hl_alloc_closure_ptr(&t$fun_c19c443,hxsl_Linker_sortByPriorityDesc,r0);
	if( r21 ) goto label$6629fd1_10_40;
	r22 = NULL;
	goto label$6629fd1_10_41;
	label$6629fd1_10_40:
	...
	if( r20 == NULL ) hl_null_access();
	r23 = r20->length;
	if( r16 >= r23 ) goto label$6629fd1_10_57;
	r23 = r20->length;
	if( ((unsigned)r16) < ((unsigned)r23) ) goto label$6629fd1_10_51;
	r6 = NULL;
	goto label$6629fd1_10_54;
	label$6629fd1_10_51:
	r14 = r20->array;
	...
	goto label$6629fd1_10_43;
	label$6629fd1_10_57:
	if( r1 == NULL ) hl_null_access();
	r11 = r1->vertex;
	if( r11 ) goto label$6629fd1_10_62;
	r11 = hl_alloc_dynbool(r3);
	r1->vertex = r11;
	label$6629fd1_10_62:
	r11 = r1->vertex;
	r12 = hl_alloc_dynbool(r3);
	if( r11 != r12 && (!r11 || !r12 || (r11->v.b != r12->v.b)) ) goto label$6629fd1_10_67;
	if( r2 == NULL ) hl_null_access();
...
void hxsl_Linker_uniqueLocals(hxsl__Linker r0,vvirtual* r1,haxe__ds__StringMap r2) {
	...
	switch(r6) {
		...
		case 4:
			...
			if( !r14 ) goto label$6629fd1_12_27;
			...
			if( r11 == NULL ) hl_null_access();
			r19 = r11->length;
			if( r6 >= r19 ) goto label$6629fd1_12_43;
			r19 = r11->length;
			if( ((unsigned)r6) < ((unsigned)r19) ) goto label$6629fd1_12_37;
			r4 = NULL;
			goto label$6629fd1_12_40;
			label$6629fd1_12_37:
			r20 = r11->array;
		...
		case 7:
			...
			if( !r14 ) goto label$6629fd1_12_72;
			r6 = 2;
			label$6629fd1_12_52:
			if( r2 == NULL ) hl_null_access();
			if( r21 == NULL ) hl_null_access();
			...
			r14 = haxe_ds_StringMap_exists(r2,r15);
			if( !r14 ) goto label$6629fd1_12_65;
			++r6;
...
void hxsl_Linker_link__$1(venum* r0,hxsl___Linker__AllocatedVar r1) {
	...
	if( !r8 ) goto label$6629fd1_13_31;
	r9 = ((Enumt$ctx_f324580*)r0)->p2;
	if( r9 == NULL ) hl_null_access();
	r5 = 0;
	r10 = r9->length;
	if( ((unsigned)r5) < ((unsigned)r10) ) goto label$6629fd1_13_24;
	r11 = NULL;
...
void hxsl_Linker_link__$2(venum* r0,vvirtual* r1) {
	...
	r5 = HL__ENUM_INDEX__(r2);
	r7 = 13;
	if( r5 != r7 ) goto label$6629fd1_14_51;
	...
	if( r9 == r10 ) goto label$6629fd1_14_51;
	r13 = &t$vrt_09f4a29;
	r5 = 0;
	...
	if( r8 == NULL ) hl_null_access();
	r14 = r8->length;
	if( r5 >= r14 ) goto label$6629fd1_14_48;
	r14 = r8->length;
	if( ((unsigned)r5) < ((unsigned)r14) ) goto label$6629fd1_14_23;
	r3 = NULL;
	goto label$6629fd1_14_26;
	label$6629fd1_14_23:
	r12 = r8->array;
	...
	if( !r17 ) goto label$6629fd1_14_47;
	r15 = ((Enumt$ctx_e171bcc*)r0)->p1;
	if( r15 == NULL ) hl_null_access();
	r7 = 0;
	r14 = r15->length;
	if( ((unsigned)r7) < ((unsigned)r14) ) goto label$6629fd1_14_40;
	r19 = NULL;
	goto label$6629fd1_14_43;
	label$6629fd1_14_40:
	r12 = r15->array;
...
vvirtual* hxsl_Linker_link__$3(venum* r0,venum* r1,String r2,hl__types__ArrayObj r3) {
	...
	if( r3 == NULL ) hl_null_access();
	r17 = r3->length;
	if( r5 >= r17 ) goto label$6629fd1_15_73;
	r17 = r3->length;
	if( ((unsigned)r5) < ((unsigned)r17) ) goto label$6629fd1_15_39;
	r19 = NULL;
	goto label$6629fd1_15_42;
	label$6629fd1_15_39:
	r8 = r3->array;
	...
	r17 = 4;
	if( r16 != r17 ) goto label$6629fd1_15_69;
	r18 = ((hxsl_TExprDef_TBlock*)r20)->p0;
	r16 = 0;
	label$6629fd1_15_53:
	if( r18 == NULL ) hl_null_access();
	r22 = r18->length;
	if( r16 >= r22 ) goto label$6629fd1_15_68;
	r22 = r18->length;
	if( ((unsigned)r16) < ((unsigned)r22) ) goto label$6629fd1_15_61;
	r21 = NULL;
	goto label$6629fd1_15_64;
	label$6629fd1_15_61:
	r8 = r18->array;
	...
	goto label$6629fd1_15_53;
	label$6629fd1_15_68:
	goto label$6629fd1_15_72;
	label$6629fd1_15_69:
	if( r7 == NULL ) hl_null_access();
	r21 = r19->body;
	r16 = hl_types_ArrayObj_push(r7,((vdynamic*)r21));
	label$6629fd1_15_72:
	goto label$6629fd1_15_31;
	label$6629fd1_15_73:
	...
	r5 = r7->length;
	r16 = 0;
	if( r5 != r16 ) goto label$6629fd1_15_84;
	r24 = NULL;
	goto label$6629fd1_15_94;
	label$6629fd1_15_84:
	r5 = 0;
	r16 = r7->length;
	if( ((unsigned)r5) < ((unsigned)r16) ) goto label$6629fd1_15_89;
	r23 = NULL;
...
vvirtual* hxsl_Linker_link(hxsl__Linker r0,hl__types__ArrayObj r1) {
	...
	if( r1 == NULL ) hl_null_access();
	r12 = r1->length;
	if( r9 >= r12 ) goto label$6629fd1_16_47;
	r12 = r1->length;
	if( ((unsigned)r9) < ((unsigned)r12) ) goto label$6629fd1_16_33;
	r14 = NULL;
	goto label$6629fd1_16_36;
	label$6629fd1_16_33:
	r7 = r1->array;
	...
	if( !r17 ) goto label$6629fd1_16_43;
	...
	if( r1 == NULL ) hl_null_access();
	r20 = r1->length;
	if( r11 >= r20 ) goto label$6629fd1_16_154;
	r20 = r1->length;
	if( ((unsigned)r11) < ((unsigned)r20) ) goto label$6629fd1_16_63;
	r14 = NULL;
	goto label$6629fd1_16_66;
	label$6629fd1_16_63:
	r7 = r1->array;
	...
	++r11;
	r17 = r0->batchMode;
	if( !r17 ) goto label$6629fd1_16_76;
	if( r14 == NULL ) hl_null_access();
	...
	if( r21 == NULL ) hl_null_access();
	r24 = r21->length;
	if( r12 >= r24 ) goto label$6629fd1_16_122;
	r24 = r21->length;
	if( ((unsigned)r12) < ((unsigned)r24) ) goto label$6629fd1_16_89;
	r26 = NULL;
	goto label$6629fd1_16_92;
	label$6629fd1_16_89:
	r7 = r21->array;
	...
	if( !r17 ) goto label$6629fd1_16_115;
	if( r27 == NULL ) hl_null_access();
	r28 = r27->v;
	...
	if( r30 != r31 ) goto label$6629fd1_16_115;
	r22 = r27->path;
	r23 = (String)s$Batch_;
	r17 = StringTools_startsWith(r22,r23);
	if( r17 ) goto label$6629fd1_16_115;
	...
	if( r30 != r31 ) goto label$6629fd1_16_121;
	if( r13 == NULL ) hl_null_access();
	r20 = hl_types_ArrayObj_push(r13,((vdynamic*)r26));
	label$6629fd1_16_121:
	goto label$6629fd1_16_81;
	label$6629fd1_16_122:
	r12 = 0;
	if( r14 == NULL ) hl_null_access();
	...
	label$6629fd1_16_125:
	if( r21 == NULL ) hl_null_access();
	r24 = r21->length;
	if( r12 >= r24 ) goto label$6629fd1_16_150;
	r24 = r21->length;
	if( ((unsigned)r12) < ((unsigned)r24) ) goto label$6629fd1_16_133;
	r32 = NULL;
	goto label$6629fd1_16_136;
	label$6629fd1_16_133:
	r7 = r21->array;
	r15 = ((vdynamic**)(r7 + 1))[r12];
	r32 = hl_to_virtual(&t$vrt_ab557b2,(vdynamic*)r15);
	label$6629fd1_16_136:
	++r12;
	...
	r27->kind = r34;
	goto label$6629fd1_16_125;
	label$6629fd1_16_150:
	r12 = r0->curInstance;
	++r12;
	r0->curInstance = r12;
	goto label$6629fd1_16_55;
	label$6629fd1_16_154:
	r11 = 0;
	r12 = 4;
	...
	*(int*)(r36 + r24) = r20;
	...
	r12 = 0;
	label$6629fd1_16_186:
	if( r1 == NULL ) hl_null_access();
	r24 = r1->length;
	if( r12 >= r24 ) goto label$6629fd1_16_373;
	r24 = r1->length;
	if( ((unsigned)r12) < ((unsigned)r24) ) goto label$6629fd1_16_194;
	r14 = NULL;
	goto label$6629fd1_16_197;
	label$6629fd1_16_194:
	r7 = r1->array;
	r15 = ((vdynamic**)(r7 + 1))[r12];
	r14 = hl_to_virtual(&t$vrt_f479cb2,(vdynamic*)r15);
	label$6629fd1_16_197:
	++r12;
	r20 = 0;
	if( r14 == NULL ) hl_null_access();
	r21 = hl_vfields(r14)[0] ? (*(hl__types__ArrayObj*)(hl_vfields(r14)[0])) : (hl__types__ArrayObj)hl_dyn_getp(r14->value,63237214/*funs*/,&t$hl_types_ArrayObj);
	label$6629fd1_16_201:
	if( r21 == NULL ) hl_null_access();
	r39 = r21->length;
	if( r20 >= r39 ) goto label$6629fd1_16_371;
	r39 = r21->length;
	if( ((unsigned)r20) < ((unsigned)r39) ) goto label$6629fd1_16_209;
	r32 = NULL;
	goto label$6629fd1_16_212;
	label$6629fd1_16_209:
	r7 = r21->array;
	r15 = ((vdynamic**)(r7 + 1))[r20];
	r32 = hl_to_virtual(&t$vrt_ab557b2,(vdynamic*)r15);
	label$6629fd1_16_212:
	++r20;
	if( r32 == NULL ) hl_null_access();
	r26 = hl_vfields(r32)[3] ? (*(vvirtual**)(hl_vfields(r32)[3])) : (vvirtual*)hl_dyn_getp(r32->value,5691731/*ref*/,&t$vrt_09f4a29);
	r33 = hl_vfields(r32)[1] ? (*(vvirtual**)(hl_vfields(r32)[1])) : (vvirtual*)hl_dyn_getp(r32->value,52297279/*expr*/,&t$vrt_6e3ace9);
	...
	switch(r24) {
		...
		case 1:
			...
			if( r34 != r41 ) goto label$6629fd1_16_242;
			r23 = (String)s$vertex;
			goto label$6629fd1_16_243;
			label$6629fd1_16_242:
			r23 = (String)s$fragment;
			label$6629fd1_16_243:
			r22 = String___add__(r22,r23);
			r34 = r27->kind;
			r41 = (venum*)g$hxsl_FunctionKind_Vertex;
			if( r34 == r41 ) goto label$6629fd1_16_249;
			r17 = false;
			goto label$6629fd1_16_250;
			label$6629fd1_16_249:
			r17 = true;
			label$6629fd1_16_250:
		...
		case 2:
			...
			if( !r22 ) goto label$6629fd1_16_266;
			r24 = r22->length;
			r39 = 16;
			if( r24 != r39 ) goto label$6629fd1_16_266;
			r36 = r22->bytes;
			r43 = (vbyte*)USTR("__init__fragment");
			r24 = hl_string_compare(r36,r43,r24);
			r39 = 0;
			if( r24 == r39 ) goto label$6629fd1_16_279;
			label$6629fd1_16_266:
			if( !r22 ) goto label$6629fd1_16_275;
			r24 = r22->length;
			r39 = 14;
			if( r24 != r39 ) goto label$6629fd1_16_275;
			r36 = r22->bytes;
			r43 = (vbyte*)USTR("__init__vertex");
			r24 = hl_string_compare(r36,r43,r24);
			r39 = 0;
			if( r24 == r39 ) goto label$6629fd1_16_284;
			label$6629fd1_16_275:
			r44 = r35;
			r45 = NULL;
			r42 = r45;
			goto label$6629fd1_16_288;
			label$6629fd1_16_279:
			r44 = r38;
			r17 = false;
			r45 = hl_alloc_dynbool(r17);
			r42 = r45;
			goto label$6629fd1_16_288;
			label$6629fd1_16_284:
			r44 = r37;
			r17 = true;
			r45 = hl_alloc_dynbool(r17);
			r42 = r45;
			label$6629fd1_16_288:
			r33 = hl_vfields(r32)[1] ? (*(vvirtual**)(hl_vfields(r32)[1])) : (vvirtual*)hl_dyn_getp(r32->value,52297279/*expr*/,&t$vrt_6e3ace9);
			if( r33 == NULL ) hl_null_access();
			...
			r39 = 4;
			if( r24 != r39 ) goto label$6629fd1_16_340;
			r25 = ((hxsl_TExprDef_TBlock*)r46)->p0;
			r24 = 0;
			r39 = 0;
			label$6629fd1_16_298:
			if( r25 == NULL ) hl_null_access();
			r48 = r25->length;
			if( r39 >= r48 ) goto label$6629fd1_16_339;
			r48 = r25->length;
			if( ((unsigned)r39) < ((unsigned)r48) ) goto label$6629fd1_16_306;
			r33 = NULL;
			goto label$6629fd1_16_309;
			label$6629fd1_16_306:
			r7 = r25->array;
			r15 = ((vdynamic**)(r7 + 1))[r39];
			r33 = hl_to_virtual(&t$vrt_6e3ace9,(vdynamic*)r15);
			label$6629fd1_16_309:
			++r39;
			if( r14 == NULL ) hl_null_access();
			r22 = hl_vfields(r14)[1] ? (*(String*)(hl_vfields(r14)[1])) : (String)hl_dyn_getp(r14->value,150958933/*name*/,&t$String);
			r23 = (String)s$5058f1a;
			...
			r47 = 0;
			r48 = r44->length;
			if( ((unsigned)r47) < ((unsigned)r48) ) goto label$6629fd1_16_330;
			hl_types_ArrayBytes_Int___expand(r44,r47);
			label$6629fd1_16_330:
			r36 = r44->bytes;
			r48 = 2;
			r48 = r47 << r48;
			r51 = *(int*)(r36 + r48);
			...
			*(int*)(r36 + r48) = r51;
			...
			goto label$6629fd1_16_298;
			label$6629fd1_16_339:
			goto label$6629fd1_16_362;
			label$6629fd1_16_340:
			if( r14 == NULL ) hl_null_access();
			r22 = hl_vfields(r14)[1] ? (*(String*)(hl_vfields(r14)[1])) : (String)hl_dyn_getp(r14->value,150958933/*name*/,&t$String);
			r23 = (String)s$5058f1a;
			r22 = String___add__(r22,r23);
			...
			r24 = 0;
			r39 = r44->length;
			if( ((unsigned)r24) < ((unsigned)r39) ) goto label$6629fd1_16_354;
			hl_types_ArrayBytes_Int___expand(r44,r24);
			label$6629fd1_16_354:
			r36 = r44->bytes;
			r39 = 2;
			r39 = r24 << r39;
			r47 = *(int*)(r36 + r39);
	...
	label$6629fd1_16_370:
	goto label$6629fd1_16_201;
	label$6629fd1_16_371:
	++r11;
	goto label$6629fd1_16_186;
	label$6629fd1_16_373:
	r21 = r0->shaders;
	if( r21 == NULL ) hl_null_access();
	r53 = hl_alloc_closure_ptr(&t$fun_c19c443,hxsl_Linker_sortByPriorityDesc,r0);
	if( r53 ) goto label$6629fd1_16_379;
	r54 = NULL;
	goto label$6629fd1_16_380;
	label$6629fd1_16_379:
	r54 = hl_alloc_closure_ptr(&t$fun_8fddd91,wrapt$fun_8fddd91,r53);
	label$6629fd1_16_380:
	...
	r40->deps = r18;
	r12 = 0;
	label$6629fd1_16_390:
	if( r13 == NULL ) hl_null_access();
	r24 = r13->length;
	if( r12 >= r24 ) goto label$6629fd1_16_410;
	r24 = r13->length;
	if( ((unsigned)r12) < ((unsigned)r24) ) goto label$6629fd1_16_398;
	r26 = NULL;
	goto label$6629fd1_16_401;
	label$6629fd1_16_398:
	r7 = r13->array;
	r15 = ((vdynamic**)(r7 + 1))[r12];
	r26 = hl_to_virtual(&t$vrt_09f4a29,(vdynamic*)r15);
	label$6629fd1_16_401:
	++r12;
	r29 = NULL;
	r22 = NULL;
	r23 = NULL;
	...
	goto label$6629fd1_16_390;
	label$6629fd1_16_410:
	r12 = 0;
	r21 = r0->shaders;
	label$6629fd1_16_412:
	if( r21 == NULL ) hl_null_access();
	r24 = r21->length;
	if( r12 >= r24 ) goto label$6629fd1_16_435;
	r24 = r21->length;
	if( ((unsigned)r12) < ((unsigned)r24) ) goto label$6629fd1_16_420;
	r55 = NULL;
	goto label$6629fd1_16_423;
	label$6629fd1_16_420:
	r7 = r21->array;
	r15 = ((vdynamic**)(r7 + 1))[r12];
	r55 = (hxsl___Linker__ShaderInfos)r15;
	label$6629fd1_16_423:
	++r12;
	if( r55 == NULL ) hl_null_access();
	r17 = r55->hasDiscard;
	if( !r17 ) goto label$6629fd1_16_434;
	...
	label$6629fd1_16_434:
	goto label$6629fd1_16_412;
	label$6629fd1_16_435:
	r12 = 0;
	r21 = r0->shaders;
	label$6629fd1_16_437:
	if( r21 == NULL ) hl_null_access();
	r24 = r21->length;
	if( r12 >= r24 ) goto label$6629fd1_16_479;
	r24 = r21->length;
	if( ((unsigned)r12) < ((unsigned)r24) ) goto label$6629fd1_16_445;
	r55 = NULL;
	goto label$6629fd1_16_448;
	label$6629fd1_16_445:
	r7 = r21->array;
	r15 = ((vdynamic**)(r7 + 1))[r12];
	r55 = (hxsl___Linker__ShaderInfos)r15;
	label$6629fd1_16_448:
	++r12;
	if( r55 == NULL ) hl_null_access();
	r42 = r55->vertex;
	if( !r42 ) goto label$6629fd1_16_453;
	goto label$6629fd1_16_437;
	label$6629fd1_16_453:
	r17 = true;
	r5 = r55->read;
	if( r5 == NULL ) hl_null_access();
	r57 = haxe_ds_IntMap_iterator(r5);
	r58 = hl_to_virtual(&t$vrt_6b0798b,(vdynamic*)r57);
	label$6629fd1_16_458:
	...
	if( !r59 ) goto label$6629fd1_16_473;
	...
	r30 = hl_vfields(r26)[1] ? (*(venum**)(hl_vfields(r26)[1])) : (venum*)hl_dyn_getp(r26->value,118088286/*kind*/,&t$hxsl_VarKind);
	r31 = (venum*)g$hxsl_VarKind_Param;
	if( r30 == r31 ) goto label$6629fd1_16_472;
	r59 = false;
	r17 = r59;
	goto label$6629fd1_16_473;
	label$6629fd1_16_472:
	goto label$6629fd1_16_458;
	label$6629fd1_16_473:
	if( !r17 ) goto label$6629fd1_16_478;
	if( r55 == NULL ) hl_null_access();
	r59 = false;
	r42 = hl_alloc_dynbool(r59);
	r55->vertex = r42;
	label$6629fd1_16_478:
	goto label$6629fd1_16_437;
	label$6629fd1_16_479:
	r8 = &t$hxsl__Linker_ShaderInfos;
	r12 = 0;
	...
	r55 = (hxsl___Linker__ShaderInfos)r15;
	if( r55 == r40 ) goto label$6629fd1_16_498;
	r22 = (String)s$assert;
	r15 = haxe_Exception_thrown(((vdynamic*)r22));
	hl_throw((vdynamic*)r15);
	label$6629fd1_16_498:
	r12 = 0;
	r49 = r0->shaders;
	label$6629fd1_16_500:
	if( r49 == NULL ) hl_null_access();
	r24 = r49->length;
	if( r12 >= r24 ) goto label$6629fd1_16_516;
	r24 = r49->length;
	if( ((unsigned)r12) < ((unsigned)r24) ) goto label$6629fd1_16_508;
	r55 = NULL;
	goto label$6629fd1_16_511;
	label$6629fd1_16_508:
	r7 = r49->array;
	r15 = ((vdynamic**)(r7 + 1))[r12];
	r55 = (hxsl___Linker__ShaderInfos)r15;
	label$6629fd1_16_511:
	++r12;
	if( r55 == NULL ) hl_null_access();
	r42 = NULL;
	r55->marked = r42;
	goto label$6629fd1_16_500;
	label$6629fd1_16_516:
	r12 = 0;
	if( r21 == NULL ) hl_null_access();
	r49 = hl_types_ArrayObj_concat(r21,r25);
	label$6629fd1_16_519:
	if( r49 == NULL ) hl_null_access();
	r24 = r49->length;
	if( r12 >= r24 ) goto label$6629fd1_16_560;
	r24 = r49->length;
	if( ((unsigned)r12) < ((unsigned)r24) ) goto label$6629fd1_16_527;
	r55 = NULL;
	goto label$6629fd1_16_530;
	label$6629fd1_16_527:
	r7 = r49->array;
	r15 = ((vdynamic**)(r7 + 1))[r12];
	r55 = (hxsl___Linker__ShaderInfos)r15;
	label$6629fd1_16_530:
	++r12;
	if( r55 == NULL ) hl_null_access();
	r18 = r55->deps;
	if( r18 == NULL ) hl_null_access();
	...
	if( !r17 ) goto label$6629fd1_16_555;
	...
	r42 = r56->marked;
	if( r42 ) goto label$6629fd1_16_554;
	r22 = r56->name;
	...
	label$6629fd1_16_554:
	goto label$6629fd1_16_536;
	label$6629fd1_16_555:
	if( r55 == NULL ) hl_null_access();
	r17 = true;
	r42 = hl_alloc_dynbool(r17);
	r55->marked = r42;
	goto label$6629fd1_16_519;
	label$6629fd1_16_560:
	r8 = &t$vrt_09f4a29;
	r12 = 0;
	r7 = hl_alloc_array(r8,r12);
	...
	r20 = r60->length;
	if( ((unsigned)r12) < ((unsigned)r20) ) goto label$6629fd1_16_583;
	hl_types_ArrayObj___expand(r60,r12);
	label$6629fd1_16_583:
	r7 = r60->array;
	((vclosure**)(r7 + 1))[r12] = r62;
	r12 = 0;
	if( r21 == NULL ) hl_null_access();
	r63 = hl_types_ArrayObj_concat(r21,r25);
	label$6629fd1_16_588:
	if( r63 == NULL ) hl_null_access();
	r24 = r63->length;
	if( r12 >= r24 ) goto label$6629fd1_16_645;
	r24 = r63->length;
	if( ((unsigned)r12) < ((unsigned)r24) ) goto label$6629fd1_16_596;
	r55 = NULL;
	goto label$6629fd1_16_599;
	label$6629fd1_16_596:
	r7 = r63->array;
	r15 = ((vdynamic**)(r7 + 1))[r12];
	r55 = (hxsl___Linker__ShaderInfos)r15;
	label$6629fd1_16_599:
	++r12;
	if( r55 == NULL ) hl_null_access();
	r66 = r55->read;
	...
	if( !r17 ) goto label$6629fd1_16_622;
	if( hl_vfields(r58)[1] ) r27 = ((hxsl___Linker__AllocatedVar (*)(vdynamic*))hl_vfields(r58)[1])(r58->value); else {
		r27 = (hxsl___Linker__AllocatedVar)hl_dyn_call_obj(r58->value,&t$fun_3445947,151160317/*next*/,NULL,NULL);
	}
	if( r60 == NULL ) hl_null_access();
	r20 = 0;
	r24 = r60->length;
	if( ((unsigned)r20) < ((unsigned)r24) ) goto label$6629fd1_16_616;
	r62 = NULL;
	goto label$6629fd1_16_619;
	label$6629fd1_16_616:
	r7 = r60->array;
	r15 = ((vdynamic**)(r7 + 1))[r20];
	r62 = (vclosure*)r15;
	label$6629fd1_16_619:
	...
	goto label$6629fd1_16_605;
	label$6629fd1_16_622:
	if( r55 == NULL ) hl_null_access();
	r66 = r55->write;
	if( r66 == NULL ) hl_null_access();
	r57 = haxe_ds_IntMap_iterator(r66);
	r58 = hl_to_virtual(&t$vrt_6b0798b,(vdynamic*)r57);
	label$6629fd1_16_627:
	if( r58 == NULL ) hl_null_access();
	if( hl_vfields(r58)[0] ) r17 = ((bool (*)(vdynamic*))hl_vfields(r58)[0])(r58->value); else {
		vdynamic ret;
		hl_dyn_call_obj(r58->value,&t$fun_bf7849e,407283053/*hasNext*/,NULL,&ret);
	...
	if( !r17 ) goto label$6629fd1_16_644;
	if( hl_vfields(r58)[1] ) r27 = ((hxsl___Linker__AllocatedVar (*)(vdynamic*))hl_vfields(r58)[1])(r58->value); else {
		r27 = (hxsl___Linker__AllocatedVar)hl_dyn_call_obj(r58->value,&t$fun_3445947,151160317/*next*/,NULL,NULL);
	}
	if( r60 == NULL ) hl_null_access();
	r20 = 0;
	r24 = r60->length;
	if( ((unsigned)r20) < ((unsigned)r24) ) goto label$6629fd1_16_638;
	r62 = NULL;
	goto label$6629fd1_16_641;
	label$6629fd1_16_638:
	r7 = r60->array;
	r15 = ((vdynamic**)(r7 + 1))[r20];
	r62 = (vclosure*)r15;
	label$6629fd1_16_641:
	if( r62 == NULL ) hl_null_access();
	r62->hasValue ? ((void (*)(vdynamic*,hxsl___Linker__AllocatedVar))r62->fun)((vdynamic*)r62->value,r27) : ((void (*)(hxsl___Linker__AllocatedVar))r62->fun)(r27);
	goto label$6629fd1_16_627;
	label$6629fd1_16_644:
	goto label$6629fd1_16_588;
	label$6629fd1_16_645:
	r8 = &t$fun_cd51779;
	r12 = 1;
	r7 = hl_alloc_array(r8,r12);
	r67 = NULL;
	...
	r20 = r63->length;
	if( ((unsigned)r12) < ((unsigned)r20) ) goto label$6629fd1_16_661;
	hl_types_ArrayObj___expand(r63,r12);
	label$6629fd1_16_661:
	r7 = r63->array;
	((vclosure**)(r7 + 1))[r12] = r67;
	r12 = 0;
	label$6629fd1_16_664:
	if( r49 == NULL ) hl_null_access();
	r24 = r49->length;
	if( r12 >= r24 ) goto label$6629fd1_16_688;
	r24 = r49->length;
	if( ((unsigned)r12) < ((unsigned)r24) ) goto label$6629fd1_16_672;
	r26 = NULL;
	goto label$6629fd1_16_675;
	label$6629fd1_16_672:
	r7 = r49->array;
	r15 = ((vdynamic**)(r7 + 1))[r12];
	r26 = hl_to_virtual(&t$vrt_09f4a29,(vdynamic*)r15);
	label$6629fd1_16_675:
	++r12;
	if( r63 == NULL ) hl_null_access();
	r20 = 0;
	r24 = r63->length;
	if( ((unsigned)r20) < ((unsigned)r24) ) goto label$6629fd1_16_682;
	r67 = NULL;
	goto label$6629fd1_16_685;
	label$6629fd1_16_682:
	r7 = r63->array;
	r15 = ((vdynamic**)(r7 + 1))[r20];
	r67 = (vclosure*)r15;
	label$6629fd1_16_685:
	if( r67 == NULL ) hl_null_access();
	r67->hasValue ? ((void (*)(vdynamic*,vvirtual*))r67->fun)((vdynamic*)r67->value,r26) : ((void (*)(vvirtual*))r67->fun)(r26);
	goto label$6629fd1_16_664;
	label$6629fd1_16_688:
	...
	if( !r17 ) goto label$6629fd1_16_760;
	...
	if( r14 != r16 && (!r14 || !r16 || !r14->value || !r16->value || r14->value != r16->value) ) goto label$6629fd1_16_720;
	goto label$6629fd1_16_710;
	label$6629fd1_16_720:
	r12 = 0;
	if( r14 == NULL ) hl_null_access();
	...
	r20 = r72->length;
	label$6629fd1_16_725:
	if( r12 >= r20 ) goto label$6629fd1_16_759;
	r24 = r12;
	++r12;
	if( r14 == NULL ) hl_null_access();
	r72 = hl_vfields(r14)[2] ? (*(hl__types__ArrayObj*)(hl_vfields(r14)[2])) : (hl__types__ArrayObj)hl_dyn_getp(r14->value,239676598/*vars*/,&t$hl_types_ArrayObj);
	if( r72 == NULL ) hl_null_access();
	r47 = r72->length;
	if( ((unsigned)r24) < ((unsigned)r47) ) goto label$6629fd1_16_736;
	r26 = NULL;
	goto label$6629fd1_16_739;
	label$6629fd1_16_736:
	r7 = r72->array;
	r15 = ((vdynamic**)(r7 + 1))[r24];
	r26 = hl_to_virtual(&t$vrt_09f4a29,(vdynamic*)r15);
	label$6629fd1_16_739:
	r29 = NULL;
	r22 = NULL;
	r23 = NULL;
	r27 = NULL;
	...
	r47 = r73->length;
	if( ((unsigned)r24) < ((unsigned)r47) ) goto label$6629fd1_16_754;
	r26 = NULL;
	goto label$6629fd1_16_757;
	label$6629fd1_16_754:
	r7 = r73->array;
	r15 = ((vdynamic**)(r7 + 1))[r24];
	r26 = hl_to_virtual(&t$vrt_09f4a29,(vdynamic*)r15);
	label$6629fd1_16_757:
	hl_types_ArrayObj_unshift(r72,((vdynamic*)r26));
	goto label$6629fd1_16_725;
	label$6629fd1_16_759:
	goto label$6629fd1_16_710;
	label$6629fd1_16_760:
...
void hxsl_Linker_new(hxsl__Linker r0,bool* r1) {
	bool r2;
	int r3;
	if( r1 ) goto label$6629fd1_17_3;
	r2 = false;
	goto label$6629fd1_17_4;
	label$6629fd1_17_3:
	r2 = *r1;
	label$6629fd1_17_4:
	r3 = 0;

...
bool sdl_Window_testGL(sdl__Window r0) {
	...
	int r6, r11, r16;
	hl_trap_ctx trap$0;
	hl_trap(trap$0,r1,label$9a2f713_1_160);
	...
	if( !r5 ) goto label$9a2f713_1_20;
	if( r5 == NULL ) hl_null_access();
	r9 = (String)s$ES;
	r10 = NULL;
	r6 = String_indexOf(r5,r9,r10);
	r11 = 0;
	if( r6 < r11 ) goto label$9a2f713_1_20;
	r7 = true;
	goto label$9a2f713_1_21;
	label$9a2f713_1_20:
	r7 = false;
	label$9a2f713_1_21:
	r6 = 120;
	if( !r7 ) goto label$9a2f713_1_37;
	r12 = EReg_match(r3,r4);
	if( !r12 ) goto label$9a2f713_1_36;
	r13 = 100.;
	r11 = 0;
	...
	r6 = r11;
	label$9a2f713_1_36:
	goto label$9a2f713_1_51;
	label$9a2f713_1_37:
	r11 = 130;
	r6 = r11;
	r12 = EReg_match(r3,r4);
	if( !r12 ) goto label$9a2f713_1_51;
	r11 = 150;
	r16 = 0;
	...
	r6 = r16;
	if( r16 >= r11 ) goto label$9a2f713_1_51;
	r6 = r11;
	label$9a2f713_1_51:
	r11 = 35633;
	...
	r14 = 1.;
	if( r13 == r14 ) goto label$9a2f713_1_85;
	...
	if( !r7 ) goto label$9a2f713_1_108;
	r20 = &t$String;
	r11 = 2;
	r19 = hl_alloc_array(r20,r11);
	r8 = (String)s$_version_;
	...
	r13 = (double)hl_dyn_castd(&r1,&t$_dyn);
	r14 = 1.;
	if( r13 == r14 ) goto label$9a2f713_1_140;
	...
	r13 = (double)hl_dyn_castd(&r1,&t$_dyn);
	r14 = 1.;
	if( r13 == r14 ) goto label$9a2f713_1_156;
...
int sdl_Window_set_displayMode(sdl__Window r0,int r1) {
	...
	int r2, r3;
	r3 = r0->displayMode;
	if( r1 != r3 ) goto label$9a2f713_3_3;
	return r1;
	label$9a2f713_3_3:
	r5 = r0->win;
	r4 = sdl_win_set_fullscreen(r5,r1);
	if( !r4 ) goto label$9a2f713_3_7;
	r0->displayMode = r1;
	label$9a2f713_3_7:
	r2 = r0->displayMode;
	return r2;
...
bool sdl_Window_set_visible(sdl__Window r0,bool r1) {
	sdl_window *r4;
	bool r3;
	int r5;
	r3 = r0->visible;
	if( r3 != r1 ) goto label$9a2f713_4_3;
	return r1;
	label$9a2f713_4_3:
	r4 = r0->win;
	if( !r1 ) goto label$9a2f713_4_7;
	r5 = 3;
	goto label$9a2f713_4_8;
	label$9a2f713_4_7:
	r5 = 4;
	label$9a2f713_4_8:
	sdl_win_resize(r4,r5);
	r0->visible = r1;
	return r1;
}
...
void sdl_Window_setMinSize(sdl__Window r0,int r1,int r2) {
	sdl_window *r4;
	r4 = r0->win;
	sdl_win_set_min_size(r4,r1,r2);
	return;
}

void sdl_Window_setMaxSize(sdl__Window r0,int r1,int r2) {
	sdl_window *r4;
	r4 = r0->win;
	sdl_win_set_max_size(r4,r1,r2);
	return;
}
...
void sdl_Window_center(sdl__Window r0) {
	int r2, r3;
	r2 = 805240832;
	r3 = 805240832;
	sdl_Window_setPosition(r0,r2,r3);
	return;
}
...
int sdl_Window_get_minWidth(sdl__Window r0) {
	sdl_window *r3;
	int *r4, *r5;
	int r1;
	r1 = 0;
	...
	r4 = &r1;
	r5 = NULL;
	sdl_win_get_min_size(r3,r4,r5);
	return r1;
}

int sdl_Window_get_minHeight(sdl__Window r0) {
	sdl_window *r3;
	int *r4, *r5;
	int r1;
	r1 = 0;
	...
	r4 = &r1;
	r5 = NULL;
	sdl_win_get_min_size(r3,r5,r4);
	return r1;
}

int sdl_Window_get_maxWidth(sdl__Window r0) {
	sdl_window *r3;
	int *r4, *r5;
	int r1;
	r1 = 0;
	...
	r4 = &r1;
	r5 = NULL;
	sdl_win_get_max_size(r3,r4,r5);
	return r1;
}

int sdl_Window_get_maxHeight(sdl__Window r0) {
	sdl_window *r3;
	int *r4, *r5;
	int r1;
	r1 = 0;
...
double sdl_Window_get_opacity(sdl__Window r0) {
	sdl_window *r2;
	double r1;
	r2 = r0->win;
	r1 = sdl_win_get_opacity(r2);
	return r1;
}

double sdl_Window_set_opacity(sdl__Window r0,double r1) {
	sdl_window *r3;
	bool r2;
	r3 = r0->win;
	r2 = sdl_win_set_opacity(r3,r1);
	return r1;
}

void sdl_Window_renderTo(sdl__Window r0) {
	sdl_gl *r3;
	sdl_window *r2;
	r2 = r0->win;
	r3 = r0->glctx;
	sdl_win_render_to(r2,r3);
	return;
}
...
void sdl_Window_present(sdl__Window r0) {
	...
	double r4, r5, r6;
	r2 = r0->vsync;
	if( !r2 ) goto label$9a2f713_22_13;
	...
	if( !(r4 < r6) ) goto label$9a2f713_22_13;
...
void sdl_Window_destroy(sdl__Window r0) {
	...
	vdynamic *r1, *r5;
	hl_trap_ctx trap$0;
	hl_trap(trap$0,r1,label$9a2f713_23_6);
	r3 = r0->win;
	r4 = r0->glctx;
	sdl_win_destroy(r3,r4);
	hl_endtrap(trap$0);
	goto label$9a2f713_23_7;
	label$9a2f713_23_6:
	r5 = NULL;
	label$9a2f713_23_7:
	r3 = NULL;
...
void sdl_Window_maximize(sdl__Window r0) {
	sdl_window *r2;
	int r3;
	r2 = r0->win;
	r3 = 0;
	sdl_win_resize(r2,r3);
	return;
}

void sdl_Window_minimize(sdl__Window r0) {
	sdl_window *r2;
	int r3;
	r2 = r0->win;
	r3 = 1;
...
void sdl_Window_restore(sdl__Window r0) {
	sdl_window *r2;
	int r3;
	r2 = r0->win;
	r3 = 2;
...
void sdl_Window_new(sdl__Window r0,String r1,int r2,int r3,int* r4,int* r5,int* r6) {
	...
	vdynamic *r14;
	int r7, r8, r9, r12;
	if( r4 ) goto label$9a2f713_27_3;
	r7 = 805240832;
	goto label$9a2f713_27_4;
	label$9a2f713_27_3:
	r7 = *r4;
	label$9a2f713_27_4:
	if( r5 ) goto label$9a2f713_27_7;
	r8 = 805240832;
	goto label$9a2f713_27_8;
	label$9a2f713_27_7:
	r8 = *r5;
	label$9a2f713_27_8:
	if( r6 ) goto label$9a2f713_27_11;
	r9 = 36;
	goto label$9a2f713_27_12;
	label$9a2f713_27_11:
	r9 = *r6;
	label$9a2f713_27_12:
	r10 = true;
	...
	label$9a2f713_27_14:
	r10 = true;
	if( !r10 ) goto label$9a2f713_27_44;
	r11 = sdl_win_create_ex(r7,r8,r2,r3,r9);
	r0->win = r11;
	r11 = r0->win;
	if( r11 ) goto label$9a2f713_27_24;
	...
	r0->glctx = r16;
	r16 = r0->glctx;
	if( !r16 ) goto label$9a2f713_27_33;
	r10 = sdl_gl_init();
	if( !r10 ) goto label$9a2f713_27_33;
	...
	if( !r10 ) goto label$9a2f713_27_40;
	goto label$9a2f713_27_14;
	label$9a2f713_27_40:
	r18 = (sdl__$Sdl)g$_sdl_Sdl;

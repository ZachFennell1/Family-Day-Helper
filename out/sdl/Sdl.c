...
void sdl_Sdl_setGLOptions(int* r0,int* r1,int* r2,int* r3,int* r4,int* r5) {
	sdl__$Sdl r12;
	int r6, r7, r8, r9, r10, r11;
	if( r0 ) goto label$3370605_2_3;
	r6 = 3;
	goto label$3370605_2_4;
	label$3370605_2_3:
	r6 = *r0;
	label$3370605_2_4:
	if( r1 ) goto label$3370605_2_7;
	r7 = 2;
	goto label$3370605_2_8;
	label$3370605_2_7:
	r7 = *r1;
	label$3370605_2_8:
	if( r2 ) goto label$3370605_2_11;
	r8 = 24;
	goto label$3370605_2_12;
	label$3370605_2_11:
	r8 = *r2;
	label$3370605_2_12:
	if( r3 ) goto label$3370605_2_15;
	r9 = 8;
	goto label$3370605_2_16;
	label$3370605_2_15:
	r9 = *r3;
	label$3370605_2_16:
	if( r4 ) goto label$3370605_2_19;
	r10 = 1;
	goto label$3370605_2_20;
	label$3370605_2_19:
	r10 = *r4;
	label$3370605_2_20:
	if( r5 ) goto label$3370605_2_23;
	r11 = 1;
	goto label$3370605_2_24;
	label$3370605_2_23:
	r11 = *r5;
	label$3370605_2_24:
	r12 = (sdl__$Sdl)g$_sdl_Sdl;
	r12->requiredGLMajor = r6;
	r12 = (sdl__$Sdl)g$_sdl_Sdl;
	r12->requiredGLMinor = r7;
	sdl_gl_options(r6,r7,r8,r9,r10,r11);
	return;
}

bool sdl_Sdl_setHint(String r0,String r1) {
	bool r2;
	vbyte *r3, *r4;
...
void sdl_Sdl_onGlContextError() {
	...
	r2 = 0;
	r3 = r0->length;
	if( ((unsigned)r2) < ((unsigned)r3) ) goto label$3370605_5_7;
	r4 = NULL;
	goto label$3370605_5_10;
	label$3370605_5_7:
	r6 = r0->array;
	r5 = ((vdynamic**)(r6 + 1))[r2];
	r4 = (String)r5;
	label$3370605_5_10:
	if( r4 ) goto label$3370605_5_13;
	r7 = (String)s$Unknown;
	r4 = r7;
	label$3370605_5_13:
	r2 = 0;
...
bool sdl_Sdl_processEvents(vclosure* r0) {
	...
	r4 = r2->type;
	r5 = 0;
	if( r4 != r5 ) goto label$3370605_6_18;
	if( !r1 ) goto label$3370605_6_18;
	r6 = false;
	return r6;
	label$3370605_6_18:
	goto label$3370605_6_0;
	label$3370605_6_19:
	r1 = true;
	return r1;
}

void sdl_Sdl_message(String r0,String r1,bool* r2) {
	bool r3;
	vbyte *r5, *r6;
	if( r2 ) goto label$3370605_7_3;
	r3 = false;
	goto label$3370605_7_4;
	label$3370605_7_3:
	r3 = *r2;
	label$3370605_7_4:
	if( r0 == NULL ) hl_null_access();
...
String sdl_Sdl_detectKeyboardLayout() {
	String r0;
	vbyte *r1;
	r1 = sdl_detect_keyboard_layout();

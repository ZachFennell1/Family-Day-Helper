...
#ifndef INC_h2d__SpriteBatch
#define INC_h2d__SpriteBatch
typedef struct _h2d__$SpriteBatch *h2d__$SpriteBatch;
typedef struct _h2d__SpriteBatch *h2d__SpriteBatch;
#include <hl/Class.h>
...
struct _h2d__SpriteBatch {
	...
	bool hasUpdate;
	h2d__BatchElement first;
	h2d__BatchElement last;

...
double h2d_Text_set_letterSpacing(h2d__Text r0,double r1) {
	double r3;
	r3 = r0->letterSpacing;
	if( r3 != r1 ) goto label$7164f24_3_3;
	return r1;
	label$7164f24_3_3:
	r0->letterSpacing = r1;
	h2d_Text_rebuild(r0);
...
double h2d_Text_set_lineSpacing(h2d__Text r0,double r1) {
	double r3;
	r3 = r0->lineSpacing;
	if( r3 != r1 ) goto label$7164f24_4_3;
	return r1;
	label$7164f24_4_3:
	r0->lineSpacing = r1;
	h2d_Text_rebuild(r0);
...
void h2d_Text_checkText(h2d__Text r0) {
	String r3, r4;
	bool r2;
	r2 = r0->textChanged;
	if( !r2 ) goto label$7164f24_7_13;
	r3 = r0->text;
	r4 = r0->currentText;
	if( r3 == r4 || (r3 && r4 && String___compare(r3,(vdynamic*)r4) == 0) ) goto label$7164f24_7_13;
	r2 = false;
	r0->textChanged = r2;
	r3 = r0->text;
	r0->currentText = r3;
...
void h2d_Text_sync(h2d__Text r0,h2d__RenderContext r1) {
	...
	r3 = r0->textChanged;
	if( !r3 ) goto label$7164f24_8_14;
	r4 = r0->text;
	r5 = r0->currentText;
	if( r4 == r5 || (r4 && r5 && String___compare(r4,(vdynamic*)r5) == 0) ) goto label$7164f24_8_14;
	r3 = false;
	r0->textChanged = r3;
	r4 = r0->text;
	r0->currentText = r4;
...
void h2d_Text_draw(h2d__Text r0,h2d__RenderContext r1) {
	...
	label$7164f24_9_11:
	r10 = r0->textChanged;
	if( !r10 ) goto label$7164f24_9_24;
	r11 = r0->text;
	r12 = r0->currentText;
	if( r11 == r12 || (r11 && r12 && String___compare(r11,(vdynamic*)r12) == 0) ) goto label$7164f24_9_24;
	r10 = false;
	r0->textChanged = r10;
	r11 = r0->text;
	r0->currentText = r11;
	...
	label$7164f24_9_24:
	r10 = r0->needsRebuild;
	if( !r10 ) goto label$7164f24_9_29;
	r11 = r0->currentText;
	r13 = NULL;
	h2d_Text_initGlyphs(r0,r11,r13);
	label$7164f24_9_29:
	r14 = r0->dropShadow;
	if( !r14 ) goto label$7164f24_9_124;
	r15 = r0->absX;
	r16 = r0->absY;
	r17 = r0->absX;
	r14 = r0->dropShadow;
...
String h2d_Text_set_text(h2d__Text r0,String r1) {
	...
	label$7164f24_10_4:
	r4 = r0->text;
	if( r2 != r4 && (!r2 || !r4 || String___compare(r2,(vdynamic*)r4) != 0) ) goto label$7164f24_10_7;
	return r2;
	label$7164f24_10_7:
	r0->text = r2;
	r5 = true;
	...
	if( !r6 ) goto label$7164f24_10_16;
	r6 = r0->parentContainer;
	if( r6 == NULL ) hl_null_access();
...
double h2d_Text_calcTextWidth(h2d__Text r0,String r1) {
	...
	r3 = r0->calcDone;
	if( !r3 ) goto label$7164f24_13_17;
	r4 = r0->calcWidth;
	r5 = r0->calcHeight;
...
String h2d_Text_splitText(h2d__Text r0,String r1) {
	String r2;
	h2d__Font r8;
	...
	r9 = NULL;
	r10 = NULL;
	r2 = h2d_Text_splitRawText(r0,r1,r5,r7,r8,r9,r10);
	return r2;
}
...
String h2d_Text_splitRawText(h2d__Text r0,String r1,double* r2,double* r3,h2d__Font r4,hl__types__ArrayBytes_Float r5,vdynamic* r6) {
	...
	if( r2 ) goto label$7164f24_15_3;
	r7 = 0.;
	goto label$7164f24_15_4;
	label$7164f24_15_3:
	r7 = *r2;
	label$7164f24_15_4:
	if( r3 ) goto label$7164f24_15_7;
	r8 = 0.;
	goto label$7164f24_15_8;
	label$7164f24_15_7:
	r8 = *r3;
	label$7164f24_15_8:
	if( r6 ) goto label$7164f24_15_11;
	r9 = -1;
	...
	r10 = r0->realMaxWidth;
	r12 = 0.;
	if( !(r10 < r12) ) goto label$7164f24_15_19;
	if( r5 ) goto label$7164f24_15_16;
	return r1;
	label$7164f24_15_16:
	r15 = ($Math)g$_Math;
	...
	r10 = r11;
	label$7164f24_15_19:
	if( r4 ) goto label$7164f24_15_22;
	r16 = r0->font;
	r4 = r16;
	label$7164f24_15_22:
	r19 = &t$String;
	...
	r21 = r1->length;
	label$7164f24_15_31:
	if( r20 >= r21 ) goto label$7164f24_15_225;
	r22 = r20;
	++r20;
	if( r1 == NULL ) hl_null_access();
	...
	if( r28 ) goto label$7164f24_15_59;
	r30 = r4->charset;
	...
	r28 = r29;
	if( r29 ) goto label$7164f24_15_59;
	r31 = 13;
	if( r23 == r31 ) goto label$7164f24_15_55;
	r31 = 10;
	if( r23 != r31 ) goto label$7164f24_15_57;
	label$7164f24_15_55:
	r29 = r4->nullChar;
	goto label$7164f24_15_58;
	label$7164f24_15_57:
	r29 = r4->defaultChar;
	label$7164f24_15_58:
	r28 = r29;
	...
	r33->v.i = r27;
	if( r24 == r33 || (r24 && r33 && (r24->v.i == r33->v.i)) ) goto label$7164f24_15_65;
	r32 = false;
	goto label$7164f24_15_66;
	label$7164f24_15_65:
	r32 = true;
	label$7164f24_15_66:
	...
	if( !r36 ) goto label$7164f24_15_205;
	if( !r25 ) goto label$7164f24_15_85;
	r30 = r4->charset;
	if( r30 == NULL ) hl_null_access();
	r27 = r25 ? r25->v.i : 0;
	...
	r27 = r17->length;
	r31 = 0;
	if( r27 != r31 ) goto label$7164f24_15_99;
	r37 = 0.;
	if( !(r37 < r7) ) goto label$7164f24_15_99;
	if( !(r10 < r11) ) goto label$7164f24_15_99;
	r13 = (String)s$;
	r27 = hl_types_ArrayObj_push(r17,((vdynamic*)r13));
	if( !r5 ) goto label$7164f24_15_97;
	...
	r33 = r6;
	r36 = false;
	label$7164f24_15_107:
	if( !(r10 >= r35) ) goto label$7164f24_15_173;
	if( r27 >= r31 ) goto label$7164f24_15_173;
	if( r1 == NULL ) hl_null_access();
	r39 = r27;
	++r27;
	...
	if( r42 ) goto label$7164f24_15_123;
	r39 = 10;
	r44 = hl_alloc_dynamic(&t$_i32);
	r44->v.i = r39;
	if( r41 != r44 && (!r41 || !r44 || (r41->v.i != r44->v.i)) ) goto label$7164f24_15_126;
	label$7164f24_15_123:
	r42 = true;
	r36 = r42;
	goto label$7164f24_15_173;
	label$7164f24_15_126:
	r39 = r41 ? r41->v.i : 0;
	r26 = r4->glyphs;
	if( r26 == NULL ) hl_null_access();
	r14 = haxe_ds_IntMap_get(r26,r39);
	r34 = (h2d__FontChar)r14;
	if( r34 ) goto label$7164f24_15_147;
	r30 = r4->charset;
	if( r30 == NULL ) hl_null_access();
	r26 = r4->glyphs;
	...
	r34 = r45;
	if( r45 ) goto label$7164f24_15_147;
	r46 = 13;
	if( r39 == r46 ) goto label$7164f24_15_143;
	r46 = 10;
	if( r39 != r46 ) goto label$7164f24_15_145;
	label$7164f24_15_143:
	r45 = r4->nullChar;
	goto label$7164f24_15_146;
	label$7164f24_15_145:
	r45 = r4->defaultChar;
	label$7164f24_15_146:
	r34 = r45;
	label$7164f24_15_147:
	...
	if( !r42 ) goto label$7164f24_15_172;
	if( !r43 ) goto label$7164f24_15_171;
	r30 = r4->charset;
	if( r30 == NULL ) hl_null_access();
	r40 = r43 ? r43->v.i : 0;
	r42 = hxd_Charset_isComplementChar(r30,r40);
	if( r42 ) goto label$7164f24_15_172;
	label$7164f24_15_171:
	goto label$7164f24_15_173;
	label$7164f24_15_172:
	goto label$7164f24_15_107;
	label$7164f24_15_173:
	if( r10 < r35 ) goto label$7164f24_15_177;
	if( r36 ) goto label$7164f24_15_205;
	r37 = r35 + r8;
	if( !(r10 < r37) ) goto label$7164f24_15_205;
	label$7164f24_15_177:
	r42 = true;
	r32 = r42;
	if( r4 == NULL ) hl_null_access();
	r30 = r4->charset;
	...
	r39 = r24 ? r24->v.i : 0;
	r42 = hxd_Charset_isSpace(r30,r39);
	if( !r42 ) goto label$7164f24_15_194;
	if( r17 == NULL ) hl_null_access();
	if( r1 == NULL ) hl_null_access();
	r40 = r22 - r9;
	...
	r34 = NULL;
	r29 = r34;
	goto label$7164f24_15_202;
	label$7164f24_15_194:
	if( r17 == NULL ) hl_null_access();
	if( r1 == NULL ) hl_null_access();
	r46 = 1;
	r40 = r22 + r46;
	...
	r13 = String_substr(r1,r9,r41);
	r39 = hl_types_ArrayObj_push(r17,((vdynamic*)r13));
	label$7164f24_15_202:
	r40 = 1;
	r39 = r22 + r40;
	r9 = r39;
	label$7164f24_15_205:
	if( !r29 ) goto label$7164f24_15_213;
	r27 = 10;
	r41 = hl_alloc_dynamic(&t$_i32);
	r41->v.i = r27;
	if( r24 == r41 || (r24 && r41 && (r24->v.i == r41->v.i)) ) goto label$7164f24_15_213;
	r38 = r0->letterSpacing;
	r37 = r12 + r38;
	r35 = r11 + r37;
	r11 = r35;
	label$7164f24_15_213:
	if( !r32 ) goto label$7164f24_15_223;
	if( !r5 ) goto label$7164f24_15_217;
	if( r5 == NULL ) hl_null_access();
	r27 = hl_types_ArrayBytes_Float_push(r5,r11);
	label$7164f24_15_217:
	r35 = 0.;
	r11 = r35;
	r27 = -1;
	r33 = hl_alloc_dynamic(&t$_i32);
	r33->v.i = r27;
	r6 = r33;
	goto label$7164f24_15_224;
	label$7164f24_15_223:
	r6 = r24;
	label$7164f24_15_224:
	goto label$7164f24_15_31;
	label$7164f24_15_225:
	if( r1 == NULL ) hl_null_access();
	r21 = r1->length;
	if( r9 >= r21 ) goto label$7164f24_15_253;
	if( r17 == NULL ) hl_null_access();
	r20 = r17->length;
	r21 = 0;
	if( r20 != r21 ) goto label$7164f24_15_245;
	r35 = 0.;
	if( !(r35 < r7) ) goto label$7164f24_15_245;
	r12 = r11 + r8;
	r35 = r0->letterSpacing;
	r12 = r12 - r35;
	if( !(r10 < r12) ) goto label$7164f24_15_245;
	r13 = (String)s$;
	r20 = hl_types_ArrayObj_push(r17,((vdynamic*)r13));
	if( !r5 ) goto label$7164f24_15_243;
	if( r5 == NULL ) hl_null_access();
	r20 = hl_types_ArrayBytes_Float_push(r5,r7);
	label$7164f24_15_243:
	r12 = r11 - r7;
	r11 = r12;
	label$7164f24_15_245:
	r21 = r1->length;
	r21 = r21 - r9;
	...
	r20 = hl_types_ArrayObj_push(r17,((vdynamic*)r13));
	if( !r5 ) goto label$7164f24_15_253;
	if( r5 == NULL ) hl_null_access();
	r20 = hl_types_ArrayBytes_Float_push(r5,r11);
	label$7164f24_15_253:
	if( r17 == NULL ) hl_null_access();
...
String h2d_Text_getTextProgress(h2d__Text r0,String r1,double r2) {
	String r4;
	double r5;
	vdynamic *r7;
	int r3, r6;
	...
	r3 = r1->length;
	r5 = (double)r3;
	if( !(r2 >= r5) ) goto label$7164f24_16_5;
	return r1;
	label$7164f24_16_5:
	r3 = 0;
	r6 = (int)r2;
...
void h2d_Text_initGlyphs(h2d__Text r0,String r1,bool* r2) {
	...
	if( r2 ) goto label$7164f24_17_3;
	r3 = true;
	goto label$7164f24_17_4;
	label$7164f24_17_3:
	r3 = *r2;
	label$7164f24_17_4:
	if( !r3 ) goto label$7164f24_17_8;
	r6 = r0->glyphs;
	if( r6 == NULL ) hl_null_access();
	...
	r26 = r15->length;
	if( r20 >= r26 ) goto label$7164f24_17_49;
	r26 = r15->length;
	if( ((unsigned)r20) < ((unsigned)r26) ) goto label$7164f24_17_41;
	r27 = 0.;
	goto label$7164f24_17_45;
	label$7164f24_17_41:
	r28 = r15->bytes;
	r26 = 3;
	r26 = r20 << r26;
	...
	label$7164f24_17_45:
	++r20;
	if( !(r7 < r27) ) goto label$7164f24_17_48;
	r7 = r27;
	label$7164f24_17_48:
	goto label$7164f24_17_33;
	label$7164f24_17_49:
	r0->calcWidth = r7;
	if( r14 == NULL ) hl_null_access();
	...
	switch(r20) {
		...
		case 4:
			...
			if( r14 == r31 ) goto label$7164f24_17_61;
			r31 = (venum*)g$h2d_Align_MultilineRight;
			if( r14 != r31 ) goto label$7164f24_17_64;
			label$7164f24_17_61:
			r27 = r0->calcWidth;
			r20 = hl_math_ceil(r27);
			goto label$7164f24_17_71;
			label$7164f24_17_64:
			r27 = r0->realMaxWidth;
			r29 = 0.;
			if( !(r27 < r29) ) goto label$7164f24_17_69;
			r20 = 0;
			goto label$7164f24_17_71;
			label$7164f24_17_69:
			r27 = r0->realMaxWidth;
			...
			if( r14 == r31 ) goto label$7164f24_17_75;
			r31 = (venum*)g$h2d_Align_MultilineCenter;
			if( r14 != r31 ) goto label$7164f24_17_77;
			label$7164f24_17_75:
			r27 = 0.5;
			goto label$7164f24_17_78;
			label$7164f24_17_77:
			r27 = 1.;
			label$7164f24_17_78:
			r25 = 0;
			r26 = r15->length;
			label$7164f24_17_80:
			if( r25 >= r26 ) goto label$7164f24_17_105;
			r32 = r25;
			++r25;
			if( r15 == NULL ) hl_null_access();
			r29 = (double)r20;
			r35 = r15->length;
			if( ((unsigned)r32) < ((unsigned)r35) ) goto label$7164f24_17_90;
			r30 = 0.;
			goto label$7164f24_17_94;
			label$7164f24_17_90:
			r28 = r15->bytes;
			r35 = 3;
			r35 = r32 << r35;
			...
			r34 = r15->length;
			if( ((unsigned)r32) < ((unsigned)r34) ) goto label$7164f24_17_100;
			hl_types_ArrayBytes_Float___expand(r15,r32);
			label$7164f24_17_100:
			r28 = r15->bytes;
			r34 = 3;
			r34 = r32 << r34;
			*(double*)(r28 + r34) = r29;
			goto label$7164f24_17_80;
			label$7164f24_17_105:
			if( r15 == NULL ) hl_null_access();
			r25 = 0;
			r26 = r15->length;
			if( ((unsigned)r25) < ((unsigned)r26) ) goto label$7164f24_17_111;
			r29 = 0.;
			goto label$7164f24_17_115;
			label$7164f24_17_111:
			r28 = r15->bytes;
			r26 = 3;
			r26 = r25 << r26;
			r29 = *(double*)(r28 + r26);
			label$7164f24_17_115:
			r7 = r29;
			r10 = r29;
	}
	label$7164f24_17_117:
	r20 = 0;
	if( r19 == NULL ) hl_null_access();
	r25 = r19->length;
	label$7164f24_17_120:
	if( r20 >= r25 ) goto label$7164f24_17_221;
	r26 = r20;
	++r20;
	if( r19 == NULL ) hl_null_access();
	...
	if( r38 ) goto label$7164f24_17_149;
	r40 = r17->charset;
	...
	r38 = r39;
	if( r39 ) goto label$7164f24_17_149;
	r34 = 13;
	if( r32 == r34 ) goto label$7164f24_17_145;
	r34 = 10;
	if( r32 != r34 ) goto label$7164f24_17_147;
	label$7164f24_17_145:
	r39 = r17->nullChar;
	goto label$7164f24_17_148;
	label$7164f24_17_147:
	r39 = r17->defaultChar;
	label$7164f24_17_148:
	r38 = r39;
	label$7164f24_17_149:
	...
	r41 = hl_alloc_dynamic(&t$_i32);
	r41->v.i = r33;
	if( r24 != r41 && (!r24 || !r41 || (r24->v.i != r41->v.i)) ) goto label$7164f24_17_183;
	if( !(r9 < r7) ) goto label$7164f24_17_158;
	r9 = r7;
	label$7164f24_17_158:
	if( r14 == NULL ) hl_null_access();
	r33 = HL__ENUM_INDEX__(r14);
	switch(r33) {
		default:
			goto label$7164f24_17_178;
		case 0:
			r30 = 0.;
			r7 = r30;
			goto label$7164f24_17_178;
		...
		case 4:
			...
			++r13;
			r33 = r15->length;
			if( ((unsigned)r13) < ((unsigned)r33) ) goto label$7164f24_17_171;
			r30 = 0.;
			goto label$7164f24_17_175;
			label$7164f24_17_171:
			r28 = r15->bytes;
			r33 = 3;
			r33 = r13 << r33;
			r30 = *(double*)(r28 + r33);
			label$7164f24_17_175:
			r7 = r30;
			if( !(r30 < r10) ) goto label$7164f24_17_178;
			r10 = r30;
	}
	label$7164f24_17_178:
	r30 = r8 + r16;
	r8 = r30;
	r33 = -1;
	r12 = r33;
	goto label$7164f24_17_220;
	label$7164f24_17_183:
	if( !r38 ) goto label$7164f24_17_218;
	if( !r3 ) goto label$7164f24_17_204;
	r6 = r0->glyphs;
	if( r6 == NULL ) hl_null_access();
	r43 = r6->content;
	...
	label$7164f24_17_204:
	r42 = 0.;
	if( r8 != r42 ) goto label$7164f24_17_214;
	r49 = r38->_t;
	if( r49 == NULL ) hl_null_access();
	r30 = r49->dy;
	if( !(r30 < r11) ) goto label$7164f24_17_214;
	r49 = r38->_t;
	if( r49 == NULL ) hl_null_access();
	r30 = r49->dy;
	r11 = r30;
	label$7164f24_17_214:
	r44 = r0->letterSpacing;
	r42 = r29 + r44;
	r30 = r7 + r42;
	r7 = r30;
	label$7164f24_17_218:
	r33 = r24 ? r24->v.i : 0;
	r12 = r33;
	label$7164f24_17_220:
	goto label$7164f24_17_120;
	label$7164f24_17_221:
	if( !(r9 < r7) ) goto label$7164f24_17_223;
	r9 = r7;
	label$7164f24_17_223:
	r0->calcXMin = r10;
	r0->calcYMin = r11;
	r27 = r9 - r10;
	r0->calcWidth = r27;
	...
	r29 = r17->baseLine;
	r30 = 0.;
	if( !(r30 < r29) ) goto label$7164f24_17_241;
	r17 = r0->font;
	if( r17 == NULL ) hl_null_access();
	r29 = r17->baseLine;
	goto label$7164f24_17_244;
	label$7164f24_17_241:
	r17 = r0->font;
	if( r17 == NULL ) hl_null_access();
	r29 = r17->lineHeight;
	label$7164f24_17_244:
	r27 = r8 + r29;
	r0->calcSizeHeight = r27;
	r5 = true;
	r0->calcDone = r5;
	if( !r3 ) goto label$7164f24_17_251;
	r5 = false;
	r0->needsRebuild = r5;
	label$7164f24_17_251:
	return;
}
...
void h2d_Text_updateSize(h2d__Text r0) {
	...
	bool r2;
	r2 = r0->textChanged;
	if( !r2 ) goto label$7164f24_18_13;
	r3 = r0->text;
	r4 = r0->currentText;
	if( r3 == r4 || (r3 && r4 && String___compare(r3,(vdynamic*)r4) == 0) ) goto label$7164f24_18_13;
	r2 = false;
	r0->textChanged = r2;
	r3 = r0->text;
	r0->currentText = r3;
	...
	label$7164f24_18_13:
	r2 = r0->calcDone;
	if( r2 ) goto label$7164f24_18_19;
	r3 = r0->text;
	r2 = r0->needsRebuild;
	r5 = &r2;
	h2d_Text_initGlyphs(r0,r3,r5);
	label$7164f24_18_19:
	return;
}
...
double h2d_Text_get_textHeight(h2d__Text r0) {
	...
	double r6;
	r2 = r0->textChanged;
	if( !r2 ) goto label$7164f24_19_13;
	r3 = r0->text;
	r4 = r0->currentText;
	if( r3 == r4 || (r3 && r4 && String___compare(r3,(vdynamic*)r4) == 0) ) goto label$7164f24_19_13;
	r2 = false;
	r0->textChanged = r2;
	r3 = r0->text;
	r0->currentText = r3;
	...
	label$7164f24_19_13:
	r2 = r0->calcDone;
	if( r2 ) goto label$7164f24_19_19;
	r3 = r0->text;
	r2 = r0->needsRebuild;
	r5 = &r2;
	h2d_Text_initGlyphs(r0,r3,r5);
...
double h2d_Text_get_textWidth(h2d__Text r0) {
	...
	double r6;
	r2 = r0->textChanged;
	if( !r2 ) goto label$7164f24_20_13;
	r3 = r0->text;
	r4 = r0->currentText;
	if( r3 == r4 || (r3 && r4 && String___compare(r3,(vdynamic*)r4) == 0) ) goto label$7164f24_20_13;
	r2 = false;
	r0->textChanged = r2;
	r3 = r0->text;
	r0->currentText = r3;
	...
	label$7164f24_20_13:
	r2 = r0->calcDone;
	if( r2 ) goto label$7164f24_20_19;
	r3 = r0->text;
	r2 = r0->needsRebuild;
	r5 = &r2;
	h2d_Text_initGlyphs(r0,r3,r5);
...
vdynamic* h2d_Text_set_maxWidth(h2d__Text r0,vdynamic* r1) {
	vdynamic *r3;
	r3 = r0->maxWidth;
	if( r3 != r1 && (!r3 || !r1 || (r3->v.d != r1->v.d)) ) goto label$7164f24_21_3;
	return r1;
	label$7164f24_21_3:
	r0->maxWidth = r1;
	h2d_Text_updateConstraint(r0);
...
void h2d_Text_updateConstraint(h2d__Text r0) {
	...
	r1 = r0->realMaxWidth;
	r3 = r0->maxWidth;
	if( r3 ) goto label$7164f24_22_6;
	r4 = r0->constraintWidth;
	r0->realMaxWidth = r4;
	goto label$7164f24_22_21;
	label$7164f24_22_6:
	r4 = r0->constraintWidth;
	r5 = 0.;
	if( !(r4 < r5) ) goto label$7164f24_22_13;
	r3 = r0->maxWidth;
	r4 = r3 ? r3->v.d : 0;
	r0->realMaxWidth = r4;
	goto label$7164f24_22_21;
	...
	if( !(r5 < r4) ) goto label$7164f24_22_19;
	r6 = r5;
	goto label$7164f24_22_20;
	label$7164f24_22_19:
	r6 = r4;
	label$7164f24_22_20:
	r0->realMaxWidth = r6;
	label$7164f24_22_21:
	r4 = r0->realMaxWidth;
	if( r4 == r1 ) goto label$7164f24_22_24;
	h2d_Text_rebuild(r0);
	label$7164f24_22_24:
	return;
}
...
int h2d_Text_set_textColor(h2d__Text r0,int r1) {
	...
	int r2, r3;
	r2 = r0->textColor;
	if( r2 != r1 ) goto label$7164f24_23_3;
	return r1;
	label$7164f24_23_3:
	r0->textColor = r1;
	r5 = r0->color;
...
void h2d_Text_getBoundsRec(h2d__Text r0,h2d__Object r1,h2d__col__Bounds r2,bool r3) {
	...
	r5 = r0->textChanged;
	if( !r5 ) goto label$7164f24_24_14;
	r6 = r0->text;
	r7 = r0->currentText;
	if( r6 == r7 || (r6 && r7 && String___compare(r6,(vdynamic*)r7) == 0) ) goto label$7164f24_24_14;
	r5 = false;
	r0->textChanged = r5;
	r6 = r0->text;
	r0->currentText = r6;
	...
	label$7164f24_24_14:
	r5 = r0->calcDone;
	if( r5 ) goto label$7164f24_24_20;
	r6 = r0->text;
	r5 = r0->needsRebuild;
	r8 = &r5;
	h2d_Text_initGlyphs(r0,r6,r8);
	label$7164f24_24_20:
	if( !r3 ) goto label$7164f24_24_30;
	r10 = r0->calcXMin;
	r9 = r10;
	r11 = 0.;
	r10 = r11;
...
void h2d_Text_new(h2d__Text r0,h2d__Font r1,h2d__Object r2) {
	...
	r7 = (String)s$;
	r7 = h2d_Text_set_text(r0,r7);
	r7 = (String)s$;
	r0->currentText = r7;
	r8 = 16777215;
	r8 = h2d_Text_set_textColor(r0,r8);
	return;
}

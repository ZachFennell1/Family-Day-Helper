...
vvirtual* h2d_Interactive_getInteractiveScene(h2d__Interactive r0) {
	...
	h2d__Scene r1;
	r1 = r0->scene;
	if( r1 ) goto label$1781ebc_9_4;
	r2 = NULL;
	goto label$1781ebc_9_8;
	label$1781ebc_9_4:
	r2 = r1->f$45;
	if( r2 ) goto label$1781ebc_9_8;
...
void h2d_Interactive_handleEvent(h2d__Interactive r0,hxd__Event r1) {
	...
	int r16, r21;
	r3 = r0->parentMask;
	if( !r3 ) goto label$1781ebc_10_44;
	r4 = h2d_Interactive_checkBounds(r0,r1);
	if( !r4 ) goto label$1781ebc_10_44;
	r3 = r0->parentMask;
	...
	r14 = r10->x;
	r15 = 0.;
	if( r14 < r15 ) goto label$1781ebc_10_37;
	r14 = r10->y;
	r15 = 0.;
	if( r14 < r15 ) goto label$1781ebc_10_37;
	r14 = r10->x;
	r16 = r3->width;
	r15 = (double)r16;
	if( r15 < r14 ) goto label$1781ebc_10_37;
	r14 = r10->y;
	r16 = r3->height;
	r15 = (double)r16;
	if( !(r15 < r14) ) goto label$1781ebc_10_41;
	label$1781ebc_10_37:
	if( r1 == NULL ) hl_null_access();
	r4 = true;
	r1->cancel = r4;
	...
	r13 = r3->parentMask;
	r3 = r13;
	goto label$1781ebc_10_15;
	label$1781ebc_10_44:
	r17 = r0->shape;
	if( r17 ) goto label$1781ebc_10_71;
	r4 = r0->isEllipse;
	if( !r4 ) goto label$1781ebc_10_71;
	r4 = h2d_Interactive_checkBounds(r0,r1);
	if( !r4 ) goto label$1781ebc_10_71;
	r11 = r0->width;
	r12 = 0.5;
	...
	r18 = r18 + r19;
	r19 = 1.;
	if( !(r19 < r18) ) goto label$1781ebc_10_71;
	r4 = true;
	r1->cancel = r4;
	return;
	label$1781ebc_10_71:
	r4 = r0->propagateEvents;
	if( !r4 ) goto label$1781ebc_10_76;
	if( r1 == NULL ) hl_null_access();
	r4 = true;
	r1->propagate = r4;
	label$1781ebc_10_76:
	r4 = r0->cancelEvents;
	if( !r4 ) goto label$1781ebc_10_81;
	if( r1 == NULL ) hl_null_access();
	r4 = true;
	r1->cancel = r4;
	label$1781ebc_10_81:
	...
	switch(r16) {
		default:
			goto label$1781ebc_10_175;
		case 0:
			r4 = r0->enableRightButton;
			if( r4 ) goto label$1781ebc_10_92;
			r16 = r1->button;
			r21 = 0;
			if( r16 != r21 ) goto label$1781ebc_10_101;
			label$1781ebc_10_92:
			r16 = r1->button;
			...
			r4 = r1->cancel;
			if( !r4 ) goto label$1781ebc_10_101;
			r16 = -1;
			r0->mouseDownButton = r16;
			label$1781ebc_10_101:
			goto label$1781ebc_10_175;
		case 1:
			r4 = r0->enableRightButton;
			if( r4 ) goto label$1781ebc_10_107;
			r16 = r1->button;
			r21 = 0;
			if( r16 != r21 ) goto label$1781ebc_10_116;
			label$1781ebc_10_107:
			r22 = r0->onRelease;
			if( r22 == NULL ) hl_null_access();
			r22->hasValue ? ((void (*)(vdynamic*,hxd__Event))r22->fun)((vdynamic*)r22->value,r1) : ((void (*)(hxd__Event))r22->fun)(r1);
		...
		case 10:
			r4 = r0->enableRightButton;
			if( r4 ) goto label$1781ebc_10_156;
			r16 = r1->button;
			r21 = 0;
			if( r16 != r21 ) goto label$1781ebc_10_165;
			label$1781ebc_10_156:
			r22 = r0->onRelease;
			if( r22 == NULL ) hl_null_access();
			r22->hasValue ? ((void (*)(vdynamic*,hxd__Event))r22->fun)((vdynamic*)r22->value,r1) : ((void (*)(hxd__Event))r22->fun)(r1);
			r16 = r0->mouseDownButton;
...
venum* h2d_Interactive_set_cursor(h2d__Interactive r0,venum* r1) {
	...
	r0->cursor = r1;
	r3 = r0->scene;
	if( !r3 ) goto label$1781ebc_12_16;
	r3 = r0->scene;
	if( r3 == NULL ) hl_null_access();
	r4 = r3->events;
	if( !r4 ) goto label$1781ebc_12_16;
	r3 = r0->scene;
	if( r3 == NULL ) hl_null_access();
	r4 = r3->events;
	if( r4 == NULL ) hl_null_access();
	r5 = r0->f$56;
	if( r5 ) goto label$1781ebc_12_15;
...
void h2d_Interactive_startCapture__$1(venum* r0,hxd__Event r1) {
	vclosure *r6;
	double r2, r4;
	h2d__Interactive r5;
	if( r1 == NULL ) hl_null_access();
	r2 = r1->relX;
	r4 = r1->relY;
	r5 = ((Enumt$ctx_9c72618*)r0)->p1;
	if( r5 == NULL ) hl_null_access();
	h2d_Interactive_eventToLocal(r5,r1);
	r6 = ((Enumt$ctx_9c72618*)r0)->p0;
...
void h2d_Interactive_startCapture(h2d__Interactive r0,vclosure* r1,vclosure* r2,vdynamic* r3) {
	venum *r7;
	vclosure *r6;
	h2d__Scene r5;
	r5 = r0->scene;
	if( r5 == NULL ) hl_null_access();
	r7 = hl_alloc_enum(&t$ctx_9c72618,0);
	((Enumt$ctx_9c72618*)r7)->p0 = (vclosure*)r1;
	((Enumt$ctx_9c72618*)r7)->p1 = (h2d__Interactive)r0;
	r6 = hl_alloc_closure_ptr(&t$fun_98108d7,h2d_Interactive_startCapture__$1,r7);
	h2d_Scene_startCapture(r5,r6,r2,r3);
	return;
}

void h2d_Interactive_stopCapture(h2d__Interactive r0) {
	h2d__Scene r2;
	r2 = r0->scene;
	if( r2 == NULL ) hl_null_access();
	h2d_Scene_stopCapture(r2);
	return;
}
...
void h2d_Interactive_startDrag(h2d__Interactive r0,vclosure* r1,vclosure* r2) {
	vdynamic *r4;
	r4 = NULL;
	h2d_Interactive_startCapture(r0,r1,r2,r4);
	return;
}

void h2d_Interactive_stopDrag(h2d__Interactive r0) {
	h2d_Interactive_stopCapture(r0);
	return;
}
...
void h2d_Interactive_focus(h2d__Interactive r0) {
	...
	h2d__Scene r2;
	r2 = r0->scene;
	if( !r2 ) goto label$1781ebc_19_6;
	r2 = r0->scene;
	if( r2 == NULL ) hl_null_access();
	r3 = r2->events;
	if( r3 ) goto label$1781ebc_19_7;
	label$1781ebc_19_6:
	return;
	label$1781ebc_19_7:
	r2 = r0->scene;
	...
	if( r3 == NULL ) hl_null_access();
	r4 = r0->f$56;
	if( r4 ) goto label$1781ebc_19_15;
...
bool h2d_Interactive_isOver(h2d__Interactive r0) {
	...
	int r4, r7;
	r1 = r0->scene;
	if( !r1 ) goto label$1781ebc_21_20;
	r1 = r0->scene;
	if( r1 == NULL ) hl_null_access();
	r2 = r1->events;
	if( !r2 ) goto label$1781ebc_21_20;
	r1 = r0->scene;
	if( r1 == NULL ) hl_null_access();
	r2 = r1->events;
	if( r2 == NULL ) hl_null_access();
	...
	r7 = -1;
	if( r4 != r7 ) goto label$1781ebc_21_18;
	r3 = false;
	goto label$1781ebc_21_19;
	label$1781ebc_21_18:
	r3 = true;
	label$1781ebc_21_19:
	return r3;
...
bool h2d_Interactive_hasFocus(h2d__Interactive r0) {
	...
	h2d__Scene r1;
	r1 = r0->scene;
	if( !r1 ) goto label$1781ebc_22_16;
	r1 = r0->scene;
	if( r1 == NULL ) hl_null_access();
	r2 = r1->events;
	if( !r2 ) goto label$1781ebc_22_16;
	r1 = r0->scene;
	if( r1 == NULL ) hl_null_access();
	r2 = r1->events;
	if( r2 == NULL ) hl_null_access();
	r4 = r2->currentFocus;
	if( r4 ? (r0 && r4->value == (vdynamic*)r0) : (r0 == NULL) ) goto label$1781ebc_22_14;
	r3 = false;
	goto label$1781ebc_22_15;
	label$1781ebc_22_14:
	r3 = true;
	label$1781ebc_22_15:
	return r3;

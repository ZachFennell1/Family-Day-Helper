...
void h2d_Mask_scrollTo(h2d__Mask r0,double r1,double r2) {
	double r3;
	r3 = h2d_Mask_set_scrollX(r0,r1);
	r3 = h2d_Mask_set_scrollY(r0,r2);
	return;
}

void h2d_Mask_scrollBy(h2d__Mask r0,double r1,double r2) {
	double r3;
	r3 = r0->scrollX;
	r3 = r3 + r1;
	r3 = h2d_Mask_set_scrollX(r0,r3);
	r3 = r0->scrollY;
	r3 = r3 + r2;
	r3 = h2d_Mask_set_scrollY(r0,r3);
	return;
}

void h2d_Mask_onHierarchyMoved(h2d__Mask r0,bool r1) {
	h2d_Object_onHierarchyMoved(((h2d__Object)r0),r1);
	if( !r1 ) goto label$3dbbe5f_5_3;
...
void h2d_Mask_updateMask(h2d__Mask r0) {
	...
	r2 = r0->parent;
	label$3dbbe5f_7_3:
	if( !r2 ) goto label$3dbbe5f_7_18;
	r5 = (h2d__$Mask)g$_h2d_Mask;
	r6 = hl_BaseType_check(((hl__BaseType)r5),((vdynamic*)r2));
	if( !r6 ) goto label$3dbbe5f_7_10;
	r1 = (h2d__Mask)r2;
	goto label$3dbbe5f_7_11;
	label$3dbbe5f_7_10:
	r1 = NULL;
	label$3dbbe5f_7_11:
	if( !r1 ) goto label$3dbbe5f_7_14;
	r0->parentMask = r1;
	...
	r4 = r2->parent;
	r2 = r4;
	goto label$3dbbe5f_7_3;
	label$3dbbe5f_7_18:
	return;
}

double h2d_Mask_set_scrollX(h2d__Mask r0,double r1) {
	h2d__col__Bounds r2;
	bool r7;
	double r3, r4, r6;
	int r5;
	r2 = r0->scrollBounds;
	if( !r2 ) goto label$3dbbe5f_8_16;
	r2 = r0->scrollBounds;
	if( r2 == NULL ) hl_null_access();
	r3 = r2->xMin;
	r2 = r0->scrollBounds;
	...
	r6 = (double)r5;
	r4 = r4 - r6;
	if( !(r1 < r3) ) goto label$3dbbe5f_8_14;
	r1 = r3;
	goto label$3dbbe5f_8_16;
	label$3dbbe5f_8_14:
	if( !(r4 < r1) ) goto label$3dbbe5f_8_16;
	r1 = r4;
	label$3dbbe5f_8_16:
	r7 = true;
	r0->posChanged = r7;
...
double h2d_Mask_set_scrollY(h2d__Mask r0,double r1) {
	h2d__col__Bounds r2;
	bool r7;
	double r3, r4, r6;
	int r5;
	r2 = r0->scrollBounds;
	if( !r2 ) goto label$3dbbe5f_9_16;
	r2 = r0->scrollBounds;
	if( r2 == NULL ) hl_null_access();
	r3 = r2->yMin;
	r2 = r0->scrollBounds;
	...
	r6 = (double)r5;
	r4 = r4 - r6;
	if( !(r1 < r3) ) goto label$3dbbe5f_9_14;
	r1 = r3;
	goto label$3dbbe5f_9_16;
	label$3dbbe5f_9_14:
	if( !(r4 < r1) ) goto label$3dbbe5f_9_16;
	r1 = r4;
	label$3dbbe5f_9_16:
	r7 = true;
	r0->posChanged = r7;
...
void h2d_Mask_getBoundsRec(h2d__Mask r0,h2d__Object r1,h2d__col__Bounds r2,bool r3) {
	...
	r2->yMax = r9;
	r10 = r0->posChanged;
	if( !r10 ) goto label$3dbbe5f_11_36;
	...
	r13 = r12->length;
	if( r11 >= r13 ) goto label$3dbbe5f_11_34;
	r13 = r12->length;
	if( ((unsigned)r11) < ((unsigned)r13) ) goto label$3dbbe5f_11_26;
	r14 = NULL;
	goto label$3dbbe5f_11_29;
	label$3dbbe5f_11_26:
	r16 = r12->array;
	...
	r20 = r2->xMin;
	if( !(r20 < r9) ) goto label$3dbbe5f_11_60;
	if( !(r9 < r4) ) goto label$3dbbe5f_11_58;
	r20 = r9;
	goto label$3dbbe5f_11_59;
	label$3dbbe5f_11_58:
	r20 = r4;
	label$3dbbe5f_11_59:
	r2->xMin = r20;
	label$3dbbe5f_11_60:
	r20 = r2->yMin;
	if( !(r20 < r17) ) goto label$3dbbe5f_11_67;
	if( !(r17 < r6) ) goto label$3dbbe5f_11_65;
	r20 = r17;
	goto label$3dbbe5f_11_66;
	label$3dbbe5f_11_65:
	r20 = r6;
	label$3dbbe5f_11_66:
	r2->yMin = r20;
	label$3dbbe5f_11_67:
	r20 = r2->xMax;
	if( !(r18 < r20) ) goto label$3dbbe5f_11_74;
	if( !(r7 < r18) ) goto label$3dbbe5f_11_72;
	r20 = r18;
	goto label$3dbbe5f_11_73;
	label$3dbbe5f_11_72:
	r20 = r7;
	label$3dbbe5f_11_73:
	r2->xMax = r20;
	label$3dbbe5f_11_74:
	r20 = r2->yMax;
	if( !(r19 < r20) ) goto label$3dbbe5f_11_81;
	if( !(r8 < r19) ) goto label$3dbbe5f_11_79;
	r20 = r19;
	goto label$3dbbe5f_11_80;
	label$3dbbe5f_11_79:
	r20 = r8;
	label$3dbbe5f_11_80:
	r2->yMax = r20;

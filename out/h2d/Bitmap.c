...
vdynamic* h2d_Bitmap_set_width(h2d__Bitmap r0,vdynamic* r1) {
	h2d__Object r4;
	vdynamic *r3;
	r3 = r0->width;
	if( r3 != r1 && (!r3 || !r1 || (r3->v.d != r1->v.d)) ) goto label$de6668e_3_3;
	return r1;
	label$de6668e_3_3:
	r0->width = r1;
...
vdynamic* h2d_Bitmap_set_height(h2d__Bitmap r0,vdynamic* r1) {
	h2d__Object r4;
	vdynamic *r3;
	r3 = r0->height;
	if( r3 != r1 && (!r3 || !r1 || (r3->v.d != r1->v.d)) ) goto label$de6668e_4_3;
	return r1;
	label$de6668e_4_3:
	r0->height = r1;
	r4 = r0->parentContainer;
	if( !r4 ) goto label$de6668e_4_9;
	r4 = r0->parentContainer;
	if( r4 == NULL ) hl_null_access();
	h2d_Object_contentChanged(r4,((h2d__Object)r0));
	label$de6668e_4_9:
...
h2d__Tile h2d_Bitmap_set_tile(h2d__Bitmap r0,h2d__Tile r1) {
	...
	h2d__Tile r3;
	r3 = r0->tile;
	if( r3 != r1 ) goto label$de6668e_5_3;
	return r1;
	label$de6668e_5_3:
	r0->tile = r1;
	r4 = r0->parentContainer;
	if( !r4 ) goto label$de6668e_5_9;
	r4 = r0->parentContainer;
	if( r4 == NULL ) hl_null_access();
	h2d_Object_contentChanged(r4,((h2d__Object)r0));
	label$de6668e_5_9:
...
void h2d_Bitmap_draw(h2d__Bitmap r0,h2d__RenderContext r1) {
	...
	if( r4 == NULL ) hl_null_access();
	r3 = r0->width;
	if( !r3 ) goto label$de6668e_6_28;
	r3 = r0->width;
	r10 = r3 ? r3->v.d : 0;
	goto label$de6668e_6_32;
	label$de6668e_6_28:
	r3 = r0->height;
	r11 = r3 ? r3->v.d : 0;
	r10 = r8 * r11;
	...
	if( r4 == NULL ) hl_null_access();
	r3 = r0->height;
	if( !r3 ) goto label$de6668e_6_40;
	r3 = r0->height;
	r10 = r3 ? r3->v.d : 0;
	goto label$de6668e_6_44;
	label$de6668e_6_40:
	r3 = r0->width;
	r11 = r3 ? r3->v.d : 0;
	r10 = r9 * r11;

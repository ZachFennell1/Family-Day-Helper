...
String hl_UI_chooseFile(bool r0,vvirtual* r1) {
	...
	if( !r5 ) goto label$ed69b4d_4_44;
	r5 = hl_vfields(r1)[0] ? (*(String*)(hl_vfields(r1)[0])) : (String)hl_dyn_getp(r1->value,37969014/*fileName*/,&t$String);
	r5 = sys_FileSystem_absolutePath(r5);
	r6 = Sys_systemName();
	r7 = (String)s$Windows;
	if( r6 != r7 && (!r6 || !r7 || String___compare(r6,(vdynamic*)r7) != 0) ) goto label$ed69b4d_4_17;
	...
	if( !r9 ) goto label$ed69b4d_4_23;
	r6 = r5;
	r7 = NULL;
	goto label$ed69b4d_4_36;
	label$ed69b4d_4_23:
	...
	r7 = r10->file;
	r11 = r10->ext;
	if( r11 ) goto label$ed69b4d_4_32;
	r11 = (String)s$;
	goto label$ed69b4d_4_35;
	label$ed69b4d_4_32:
	...
	if( !r8 ) goto label$ed69b4d_4_119;
	r8 = hl_vfields(r1)[2] ? (*(hl__types__ArrayObj*)(hl_vfields(r1)[2])) : (hl__types__ArrayObj)hl_dyn_getp(r1->value,155623867/*filters*/,&t$hl_types_ArrayObj);
	if( r8 == NULL ) hl_null_access();
	r15 = r8->length;
	r16 = 2;
	...
	if( r8 == NULL ) hl_null_access();
	r22 = r8->length;
	if( r20 >= r22 ) goto label$ed69b4d_4_114;
	r22 = r8->length;
	if( ((unsigned)r20) < ((unsigned)r22) ) goto label$ed69b4d_4_71;
	r24 = NULL;
	goto label$ed69b4d_4_74;
	label$ed69b4d_4_71:
	r25 = r8->array;
	...
	r28 = r26->length;
	if( r22 >= r28 ) goto label$ed69b4d_4_107;
	r28 = r26->length;
	if( ((unsigned)r22) < ((unsigned)r28) ) goto label$ed69b4d_4_98;
	r5 = NULL;
	goto label$ed69b4d_4_101;
	label$ed69b4d_4_98:
	r25 = r26->array;
	...
	if( !r30 ) goto label$ed69b4d_4_125;
	r30 = hl_vfields(r1)[4] ? (*(hl__Window*)(hl_vfields(r1)[4])) : (hl__Window)hl_dyn_getp(r1->value,311203066/*window*/,&t$hl_Window);
	...
	if( r14 ) goto label$ed69b4d_4_129;
	r5 = NULL;
	return r5;
	label$ed69b4d_4_129:

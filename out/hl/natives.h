...
HL_API void fmt_img_scale(vbyte*,int,int,int,int,vbyte*,int,int,int,int,int);
...
HL_API vbyte* sdl_gctrl_get_name(sdl_gamecontroller*);
...
HL_API sdl_haptic* sdl_haptic_open(sdl_gamecontroller*);
HL_API int sdl_haptic_rumble_init(sdl_haptic*);
HL_API int sdl_haptic_rumble_play(sdl_haptic*,double,int);
HL_API bool sdl_hint_value(vbyte*,vbyte*);
HL_API bool sdl_init_once(void);
HL_API bool sdl_is_cursor_visible(void);
